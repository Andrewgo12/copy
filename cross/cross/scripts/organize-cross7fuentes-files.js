...
// File renaming mappings for CROSS7Fuentes
...
function organizeFiles() {
  const basePath = 'C:\\Users\\Soporte\\Desktop\\cross\\cross\\resources\\legacy\\CROSS7Fuentes';
  
  console.log('🔄 Starting CROSS7Fuentes file organization...');
  ...
  console.log('✅ CROSS7Fuentes file organization completed!');
}
...
function normalizeExtensions() {
  ...
  console.log('🔄 Normalizing extensions in CROSS7Fuentes...');
