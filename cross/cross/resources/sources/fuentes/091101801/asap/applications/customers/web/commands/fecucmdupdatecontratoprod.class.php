...
*
* Comando de actualizar datos a la tabla contratoprod
...
Class FeCuCmdUpdateContratoprod {
    ...
    function execute(){
        ...
        if(($contratoprod__contnics != NULL) && ($contratoprod__contnics != "") && ($contratoprod__prodcodigos != NULL) && ($contratoprod__prodcodigos != "")){
            ...
            $message = $contratoprod_manager->updateContratoprod($contratoprod__contnics,$contratoprod__prodcodigos,$contratoprod__coprcantidan,$contratoprod__coprvalunidn,$contratoprod__coprserials,$contratoprod__copovigencn,$contratoprod_copodefinis,$contratoprod_copoclausus,$contratoprod_coporestris); 
