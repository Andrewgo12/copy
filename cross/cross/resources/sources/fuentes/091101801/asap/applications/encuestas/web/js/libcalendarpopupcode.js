...
{
	var sbRet = '';
	sbRet = '<td class=\'piedefoto\'>'+(this.obj_caller && this.obj_caller.year_scroll?'<a href="javascript:set_datetime('+this.dt_prev_year.valueOf()+')"><img src="'+STR_ICONPATH+'izquierdaini.gif" border="0" title="'+ARR_ALT[0]+'"></a>&nbsp;':'')+'<a href="javascript:set_datetime('+this.dt_prev_month.valueOf()+')"><img src="'+STR_ICONPATH+'izquierda.gif" border="0" title="'+ARR_ALT[1]+'"></a></td>'+
	'<th align="center" width="100%">'+ARR_MONTHS[this.dt_current.getMonth()]+' '+this.dt_current.getFullYear() + '</th>'+
	'<td class=\'piedefoto\'><a href="javascript:set_datetime('+this.dt_next_month.valueOf()+')"><img src="'+STR_ICONPATH+'derecha.gif" border="0" title="'+ARR_ALT[2]+'"></a>'+(this.obj_caller && this.obj_caller.year_scroll?'&nbsp;<a href="javascript:set_datetime('+this.dt_next_year.valueOf()+')"><img src="'+STR_ICONPATH+'derechafin.gif" border="0" title="'+ARR_ALT[3]+'"></a>':'')+'</td>';
	return sbRet;
}
