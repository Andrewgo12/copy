...
function smarty_function_register_attachment_atencion($params, & $smarty) {
	...
	$sbhtml .= "<tr>";
	$sbhtml .= "<td width='25%'><input type=file name=anexo size=50 maxlength=100></td>";
	$sbhtml .= "<td align=\"left\"><a href='#' onClick=\"$form.action.value='FeCrCmdAddAnexosAT';$form.submit();\" >";
