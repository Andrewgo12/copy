  ...
  <tr>
    <td background="web/images/inicio.barrasuperior_01.png" width="716" height="70">
    	<div id="tools" class="toolsStart">
    		&nbsp;&nbsp;&nbsp;
    		<a href="javascript:controlLeftFrame()"><img src="web/images/IconosCross.arbol.png" width="25" height="25" border="0" title="<?php echo "arbol " ?>"></a>&nbsp;
...
"><img src="web/images/IconosCross.manual.png" width="25" height="25" border="0" title="<?php echo "ayuda " ?>"></a>&nbsp;
    		<a href="#" onClick="jsShowAbout();"><img src="web/images/IconosCross.preguntas.png" width="25" height="25" border="0" title="<?php echo "acerca " ?>"></a>&nbsp;
