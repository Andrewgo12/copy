...
class FeCuCmdAddContrato {
    function execute()
    {
        ...
        if(($contrato__contnics != NULL) && ($contrato__contnics != "") && 
            ...
            $message = $contrato_manager->addContrato($contrato__contnics,$contrato__clieidentifs,$contrato__ticocodigos,$contrato_contobjetos,
            										  $contrato__timocodigos,$contrato__contmonton,$contrato__fopacodigos,$contrato__contfchainin,
            										  $contrato__contfchafinn,$contrato__contfchfirmn,$contrato__contestados,$contrato_contdescrips);
