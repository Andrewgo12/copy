<?php /* Smarty version 2.6.0, created on 2014-07-24 15:40:23
...
<table border="0" align="center" width="80%">
   ...
   <tr>
      <td width='25%'><?php echo "<B>esaccodigos</B> " ?></td>
      <td width='60%'><?php echo smarty_function_select_estadotarea(array(), $this);?>
<b>*</b></td>
  	<td  width='15%'class="piedefoto"><?php echo "esaccodigos"; ?></td>
   </tr>
   <!--<tr>
      <td><?php echo "acemfeccren " ?></td>
      <td><?php echo smarty_function_textfield(array('id' => 'acemfeccren','name' => 'actaempresa__acemfeccren','maxlength' => '4','typeData' => 'int'), $this);?>
</td>
  	<td class="piedefoto"><?php echo "acemfeccren"; ?></td>
   </tr>-->
   <tr>
      <td><?php echo "<B>acemfecaten</B> " ?></td>
...
<b>*</b></td>
  	<td class="piedefoto"><?php echo "acemfecaten"; ?></td>
   </tr>
   <!--<tr>
      <td><?php echo "<B>acemhorainn</B> " ?></td>
      <td><?php echo smarty_function_textfield_hour(array('id' => 'acemhorainn','name' => 'actaempresa__acemhorainn'), $this);?>
<b>*</b></td>
  	<td class="piedefoto"><?php echo "acemhorainn"; ?></td>
   </tr>-->
   <tr>
      <td><?php echo "acemhorafin " ?></td>
      <td><?php echo smarty_function_textfield_hour(array('id' => 'acemhorafin','name' => 'actaempresa__acemhorafin'), $this);?>
</td>
  	<td class="piedefoto"><?php echo "acemhorafin"; ?></td>
   </tr>
   <tr>
      <td><?php echo "<B>acemobservas</B> " ?></td>
  	...
  	<td class="piedefoto"><?php echo "acemobservas"; ?></td>
   </tr>
   <tr>
