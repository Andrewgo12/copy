...
function smarty_function_select_entes($params, & $smarty) {
	...
	if ($sbFlag) {
	    ...
	    $sbHtml .="<a href='#' onClick=\"javascript:fncopenwindows('FeGeCmdTreeHelp','table=organizacion&sqlid=organizacion&return_obj=".$name."&return_key=orgacodigos&father=orgacgpads&son=orgacodigos&label=organombres&valor='+document.".$form."."
.$name.".value);\"><img src='web/images/menu.gif' border='0' align='middle'></img></a>";
        $sbHtml .="<input name='".$sbNamedesc."' id='".$sbNamedesc."' type='text' size='35' value=\"".$_REQUEST[$sbNamedesc]."\">";
	} else {
