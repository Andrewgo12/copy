...
class FeWFCmdUpdateTarea {
    function execute()
    {
        ...
        if(($tarea__tarecodigos != NULL) && ($tarea__tarecodigos != "")&& 
            ...
            $message = $tarea_manager->updateTarea($tarea__tarecodigos,$tarea__tarenombres,$tarea__orgacodigos,$tarea__taredescris,$tarea__tareactivas); 
