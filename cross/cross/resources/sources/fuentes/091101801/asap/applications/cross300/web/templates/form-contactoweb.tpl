<html>
{loadlabels table_name=Contacto&controls[]=CmdAdd&controls[]=CmdClean}
{head}
...
<table border="0" align="center" width="80%">
   ...
   <tr>
      ...
      <td>{textfield id="contemail" name="contacto__contemail" maxlength="100"}</td>
   ...
   <tr>
      ...
      <td>{textfield id="contdirecios" name="contacto__contdirecios" maxlength="100"}</td>
   ...
   <tr>
      <td>{printlabel name=contnumcels&blBold=true}</td>
      <td>{textfield id="contnumcels" name="contacto__contnumcels" maxlength="100"}<b>*</b></td>
  	<td class="piedefoto">{printcoment name=contnumcels}</td>
   </tr>
   <tr>
	...
	<tr>
		<td colspan="2">
			<div align="center">
		    	{btn_command type="button" value="Adicionar" id="CmdAdd" name="FeCrCmdAddContactoWeb" form_name="frmContacto"}
				{btn_clean table_name="ContactoWeb" form_name="frmContacto"}
			</div>
		</td>
		<td class="piedefoto"></td>
	</tr>
