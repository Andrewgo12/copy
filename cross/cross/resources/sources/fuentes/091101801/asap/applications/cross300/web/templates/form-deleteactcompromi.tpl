<html>
{loadlabels table_name=RevertPerformanceCompromi&controls[]=CmdShow&controls[]=CmdClean}
{head}
...
<table border="0" align="center" width="80%">
   ...
   <tr>
	...
	<tr>
		<td colspan="2">
			<div align="center">
				{btn_command type="button" value="Consultar" onClick="signal.value=1;" id="CmdShow" name="FeCrCmdDefaultActuacionCompromiso" form_name="frmRevertPerformance"}
...
<table border="0" align="center" width="80%">
    <tr>
        <td class='piedefoto'>{viewDeleteActCompromisos form="frmRevertPerformance"}</td>
    </tr>
</table>
{hidden name="action"}
{hidden name="signal"}
