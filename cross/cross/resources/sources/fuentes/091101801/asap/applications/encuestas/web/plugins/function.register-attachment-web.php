...
function smarty_function_register_attachment_web($params, & $smarty) {
	...
	$sbhtml .= "<td><a href='#' onClick=\"$form.action.value='FeCrCmdAddAnexosWeb';$form.submit();\" >";
	...
	if ($rctmpa) {
		...
		foreach ($rctmpa as $nucont => $sbvalue) {
			...
			$sbhtml .="<td class='$sbestilo'>"."<a href='#' onClick=\"$form.action.value='FeCrCmdDeleteAnexosWeb';$form.deleteattachment.value='$nucont';$form.submit();\">";
