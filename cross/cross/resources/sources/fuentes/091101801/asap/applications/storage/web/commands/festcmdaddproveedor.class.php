...
class FeStCmdAddProveedor {
    function execute()
    {
		...
		$proveedor__ciudcodigos = $objServ->formatString($proveedor__ciudcodigos);
            ...
            $message = $proveedor_manager->addProveedor($proveedor__provcodigos,$proveedor__provnombres,$proveedor__provnnomreprs,$proveedor__provdireccis,$proveedor__protelefons,$proveedor__provemails,$proveedor__provwebs,$proveedor__paiscodigos,$proveedor__depacodigos,$proveedor__ciudcodigos); 
