...
class FeStCmdUpdateUnidadmedida {
	function execute() {
		...
		if (($unidadmedida__unmecodigos != NULL) && ($unidadmedida__unmecodigos != "") && ($unidadmedida__unmenombres != NULL) && ($unidadmedida__unmenombres != "") && ($unidadmedida__unmesiglas != NULL) && ($unidadmedida__unmesiglas != "")) {
			...
			$message = $unidadmedida_manager->updateUnidadmedida($unidadmedida__unmecodigos, $unidadmedida__unmenombres, $unidadmedida__unmesiglas, $unidadmedida__unmedescrips, $unidadmedida__unmeactivas);
