...
Class FeCuCmdShowListContacto {
	...
	function execute() {
		...
		if ($contacto__grincodigos)
			$_REQUEST["contacto__grincodigos"] = $objService->formatString($contacto__grincodigos);
		...
		if (!WebSession :: issetProperty("contacto__grincodigos"))
			WebSession :: setProperty("contacto__grincodigos", $contacto__grincodigos);
