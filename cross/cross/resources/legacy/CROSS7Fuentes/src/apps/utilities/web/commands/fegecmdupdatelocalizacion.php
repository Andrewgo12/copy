...
Class FeGeCmdUpdateLocalizacion {
    ...
    function execute()
    {
        ...
        && ($localizacion__tilocodigos != NULL) && ($localizacion__tilocodigos != "")){
            ...
            $sbmessage = $localizacion_manager->updateLocalizacion($localizacion__locacodigos,$localizacion__locanombres,$localizacion__locadescrips,$localizacion__tilocodigos,$localizacion__locacodpadrs,$localizacion__locaordenn,$localizacion__locazonas,$localizacion__locaestados); 
