...
* @param string params nombres de las variables parámetro, valores(opcional) y operadores(opcional) separadas por pipe("|"), 
...
function moveEnte() {
	...
	var url = 'index.php?action=FeHrCmdMoveDependency';
	url += '&orgacodigos='+document.frmOrganizacion.organizacion__orgacodigos.value+'&orgacgpads='+document.frmOrganizacion.organizacion__orgacgpads.value;
