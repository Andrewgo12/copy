...
*/
$rclabels = array("title"=>"Estado de los Casos",
				  "consulttitle"=>"Casos",
				  "context_help"=>"El estado de Casos toma los datos digitados para hacer la consulta.
...
"contnombre"=>array("label"=>"Solicitante/Denunciante","accesskey"=>true,"commentary"=>""),
