...
class FeCrPgsqlDetaconfform {
	var $consult;
	var $objdb;

	function FeCrPgsqlDetaconfform() {
	...
	function addDetaconfform($cofocodigon, $cacocodigon, $decooperados, $decovalors) {
		$sql = 'INSERT INTO "detaconfform" ("cofocodigon","cacocodigon","decooperados","decovalors") VALUES('.$cofocodigon.','.$cacocodigon.' ,\''.$decooperados.'\',\''.$decovalors.'\')';
		$this->objdb->fncadoexecute($sql);
