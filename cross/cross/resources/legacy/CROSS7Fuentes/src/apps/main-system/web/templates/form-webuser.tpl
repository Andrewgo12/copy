	...
	<tr>
		<td class="piedefoto">
			<table border="0" align="center" width="100%">
				...
				<tr><th colspan="3"><div align="center"><u>{printtitle_pub}</u></div></th></tr>
				<tr><th colspan="3">&nbsp;</th></tr>
   				<tr>
      				<td width='25%' class="tdlabels">{printlabel_pub name="tiorcodigos"}</td>
      				<td width='60%'>
      					{select_row_table_lang id="tiorcodigos" name="ordenempresa__tiorcodigos" sqlid="tipoorden_web" table_name="tipoorden" value="tiorcodigos" label="tiornombres" is_null="true" param="pto" 
   				...
   				<tr>
   	  				<td class="tdlabels">{printlabel_pub name="evencodigos"}</td>
   	  				<td>
   				...
   				<tr>
      				<td class="tdlabels">{printlabel_pub name="causcodigos"}</td>
      				<td>
   				...
   				<tr>
      				<td class="tdlabels">{printlabel_pub name="ordeobservs"}</td>
      				<td>{textarea_ext id="ordeobservs" name="orden__ordeobservs" cols="90" rows="10" }{/textarea_ext}<b>*</b></td>
  					<td class="piedefoto">{printcoment_pub name="ordeobservs"}</td>
   				</tr>
<!--			<tr>
					<td class="tdlabels">{printlabel_pub name="locacodigos"}</td>
					<td> 
						{textfield id="locacodigos" name="ordenempresa__locacodigos" value="" onBlur="if(this.value!='')autoReference('localizacion','locacodigos',Array(this),document.frmOrden.ordenempresa_locacodigos_desc);else document.frmOrden.ordenempresa_locacodigos_desc.value='';"}
						{href 
							label="<img src='web/images/menu.gif' border='0' align='absmiddle'></img>"
							onclick="javascript:fncopenwindows('FeCrCmdTreeHelp','table=localizacion&sqlid=localizacion&return_obj=ordenempresa__locacodigos&return_key=locacodigos&father=locacodpadrs&son=locacodigos&label=locanombres&param=geografia&value='+document.frmOrden.ordenempresa__locacodigos.value+'&locacodigos_desc='+document.frmOrden.ordenempresa_locacodigos_desc.value);"
						}
						{textfield name="ordenempresa_locacodigos_desc" value=""}<B>*</B>
					</td>
					<td class="piedefoto">{printcoment name=locacodigos}</td>
   				</tr>				
   				<tr>
      				<td class="tdlabels">{printlabel_pub name="ordesitiejes"}</td>
      				<td>{textfield id="ordesitiejes" name="orden__ordesitiejes" size="50" maxlength="100"}</td>
...
-->
				...
				<!-- Denunciante -->
				<tr>
					<th colspan="3"><strong>{printlabel_pub name="denunciante_info"}</strong></th>
				</tr>
				<tr>
	      			<td class="tdlabels" align="left">{printlabel_pub name="contidentis"}</td>
	      			<td>
		    			...
		    			{href label="<img src='web/images/crear.gif' border='0' align='absmiddle'></img>"
		      				onclick="javascript:OpenWindowsSol('../customers/index.php?action=FeCuCmdDefaultSolicitantePub','');"  }
	     			</td>
	...
	<tr>
		<td class="piedefoto">
			<table border="0" style="border-spacing: 10px;" align="center" width="100%">
				...
				<tr><td colspan="3" class="piedefoto">{register_attachment_web form="frmOrden"}</td> <!--tabla de Anexos-->
				</tr>
			</table>
		</td>
	</tr>
...
{hidden name="pto"}
{hidden name="ordenempresa__locacodigos" value="76001"}
{hidden name="orden__ordesitiejes"}
