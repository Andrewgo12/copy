...
class FeHrCmdUpdatePersonal {
    function execute()
    {
        ...
        if(($personal__perscodigos != NULL) && ($personal__perscodigos != "") && 
            ...
            $message = $personal_manager->updatePersonal($personal__perscodigos,
            $personal__persidentifs,$personal__persnombres,
            $personal__persapell1s,$personal__persapell2s,
            $personal__persusrnams,$personal__cargcodigos,
            $personal__persprofecs,$personal__perstelefo1,
            $personal__perstelefo2,$personal__locacodigos, 
            $personal__persdireccis, $personal__persemails, 
