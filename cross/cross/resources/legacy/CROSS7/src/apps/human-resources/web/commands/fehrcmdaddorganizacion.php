...
class FeHrCmdAddOrganizacion {
	function execute() {
		...
		&& ($organizacion__grupcodigos != NULL) && ($organizacion__grupcodigos != "")) {
			...
			$sbmessage = $organizacion_manager->addOrganizacion($organizacion__orgacodigos, $organizacion__organombres, $organizacion__tiorcodigos, 
