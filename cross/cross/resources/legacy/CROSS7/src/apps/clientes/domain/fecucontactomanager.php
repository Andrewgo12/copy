...
class FeCuContactoManager {
	...
	$locacodigos, $contdirecios, $conttelefons, $contobservs,$contnumcels, $grincodigos) {
		...
		if ($this->gateway->existContactoByIdentis($contindentis) == 0) {
			...
			$contdirecios, $conttelefons, $contobservs,$contnumcels, $grincodigos);
	...
	$contemail, $locacodigos, $contdirecios, $conttelefons, $contobservs, $contactivas,$contnumcels, $grincodigos) {
		...
		if ($this->gateway->existContacto($contcodigon) == 1) {
			...
			$conttelefons, $contobservs, $contactivas,$contnumcels, $grincodigos);
			if ($this->gateway->consult == false)
			return 2;
			$this->UnsetRequest();
			return 3;
	...
	function UnsetRequest() {
		...
		unset ($_REQUEST["contacto__grincodigos"]);
	}
