...
*
* Comando de adicionar datos a la tabla estadotarea
* @author Ingravity 0.0.9
* @location Cali - Colombia
*/
Class FeWFCmdAddEstadotarea {
    ...
    function execute(){
		...
		if(($estadotarea__tarecodigos != NULL) && ($estadotarea__tarecodigos != "") && ($estadotarea__esaccodigos != NULL) && ($estadotarea__esaccodigos != ""))
		{
			...
			$estadotarea__tarecodigos = $objServ->formatString($estadotarea__tarecodigos);
			$estadotarea__esaccodigos = $objServ->formatString($estadotarea__esaccodigos);

			$estadotarea_manager = Application::getDomainController('EstadotareaManager'); 
			$message = $estadotarea_manager->addEstadotarea($estadotarea__tarecodigos,$estadotarea__esaccodigos); 
