...
class FeWFCmdAddActivitarea {
    function execute()
    {
		...
		$activitarea__actaobligats = $objServ->formatString($activitarea__actaobligats);
            ...
            $message = $activitarea_manager->addActivitarea($activitarea__tarecodigos,$activitarea__acticodigos,$activitarea__actavalorn,$activitarea__actaobligats,$activitarea__actaordenn,$activitarea__actaporcetan,$activitarea__actaactivas); 
