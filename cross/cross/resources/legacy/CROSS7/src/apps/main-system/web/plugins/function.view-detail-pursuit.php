...
@date 16-Aug-2006 11:20
@location Cali - Colombia 1104555600  1123736399
*/
function smarty_function_view_detail_pursuit($params, &$smarty){
    ...
    include ($rcUser["lang"]."/".$rcUser["lang"].".detailpursuit.php");
    ...
    $detalleClass = new detallado($reporte,$ordefecingdini,$ordefecingdfin,$rclabels,$periodo,$tipoorden,$dependencia);
...
class detallado {
	...
	function detallado($reporte,$date1,$date2,$rcLabels,$periodo,$tipo,$orgacodigos){
        ...
        $this->tipo = $tipo;
        $this->orgacodigos = $orgacodigos;
        $this->gateway = Application::getDataGateway('detailPursuit');
	}
    ...
    */
    function makeByDependenciaDesagregado(){
        ...
        $titulo = str_replace("[1]",$this->periodo,$this->rcLabels['desagregado']['label']);
    ...
    */
    function makeByTipo()
    {
        ...
        //pinta el titulo del reporte
        $rcHtml[] = '<table align="center" width="100%">';
        $titulo = str_replace("[1]",$this->periodo,$this->rcLabels['titulo2']['label']);
    ...
    */
    function makeByEstado(){
        ...
        //pinta el titulo del reporte
        $rcHtml[] = '<table align="center" width="100%">';
        $titulo = str_replace("[1]",$this->periodo,$this->rcLabels['titulo1']['label']);
