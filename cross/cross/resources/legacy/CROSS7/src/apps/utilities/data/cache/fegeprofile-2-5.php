...
class FeGeProfile_2_5 {
	...
	*/
	...
	$rcnode[]=array("son"=>"FeCrCmdDefaultEstadoTickets", "father"=>"reportes_cross");
	...
	$FeCrCmdDefaultEstadoTickets = new HTML_TreeNode($rclabels["FeCrCmdDefaultEstadoTickets"],"javascript:fncLoadCmd(\'FeCrCmdDefaultEstadoTickets\',\'cross300\')");
