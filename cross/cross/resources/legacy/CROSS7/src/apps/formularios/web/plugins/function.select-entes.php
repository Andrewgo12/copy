...
function smarty_function_select_entes($params, & $smarty) {
	...
	if ($sbFlag) {
		...
		//VAMOS A COMENTAR ESTA PARTE DEL VALOR NULO, A PETICIÓN DE CVC, PARA EVITAR INCONSISTENCIAS EN EL INGRESO
		//O SEA, PARA QUE NO VAYA EL CASO A LA DEPENDENCIA POR DEFECTO Y SE CONVIERTA EN UNA OLLA DE CASOS
//		if ($is_null == "true") {
