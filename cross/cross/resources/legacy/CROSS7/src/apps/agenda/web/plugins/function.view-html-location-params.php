...
function smarty_function_view_html_location_params($params, & $smarty) {
	...
	if ($report && $dimension) {
		...
		$sbHtml .="'&sbSqlId=localizacion&sbFunction=autoReference&rcParams[locacodigos]='+this.value,'tilocodigos','&sbSqlId=tipolocaliza&sbFunction=selectValues&rcParams[locacodigos]='+this.value);else this.form.locanombres.value='';\">";
