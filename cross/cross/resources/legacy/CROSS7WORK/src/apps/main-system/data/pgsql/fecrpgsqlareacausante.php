...
class FeCrPgsqlAreacausante {
	var $consult;
	var $objdb;
	var $blAgrupar;
	var $rcEstadosCompromiso;

	function FeCrPgsqlAreacausante() {
    ...
    * 
    * arma la consulta que obtiene el utlmo acta activa de un caso
    ...
    */
    function getReqByDepByTipo($fechini,$fechfin){
        ...
        $sql = "SELECT DISTINCT orden.ordesitiejes as orgacodigos,organizacion.organombres," .
        		...
        		$sbTmp .
        		" AND orden.ordesitiejes=organizacion.orgacodigos " .
    ...
    */
    function getReqByDepByTipoDesagregadoPorDep($fechini,$fechfin,$orgacodigos){
    	...
    	if($this->blAgrupar==true) {
    		...
    		if($orgacodigos){
    			$sbTmp .= ' AND "orden"."ordesitiejes" = \''.$orgacodigos.'\' ';
    		}
    	}
        if(!is_array($rcEqui)){
        	$rcEqui = array();	
        ...
        $sbSql = "SELECT DISTINCT orden.ordesitiejes as orgacodigos,organizacion.organombres," .
        		"tipoorden.tiorcodigos,tipoorden.tiornombres,count(orden.ordenumeros) AS cantidad" .
        		" FROM orden, ordenempresa, organizacion, tipoorden " .
        		" WHERE orden.ordefecregd BETWEEN $fechini AND $fechfin " .
        		" AND orden.ordenumeros = ordenempresa.ordenumeros " .  
    ...
    */
    function getReqByCausa($tiorcodigos,$fechini,$fechfin){
        ...
        $sbSql = "SELECT DISTINCT 
                    ...
                    "WHERE 
                        ...
                        orden.ordenumeros = ordenempresa.ordenumeros AND  
                        ordenempresa.tiorcodigos = '$tiorcodigos' AND 
                        orden.ordesitiejes = organizacion.orgacodigos AND 
	...
	function getReqByEnd($fechini, $fechfin){
		...
		$sbSql = 'SELECT "organizacion"."orgacgpads","organizacion"."orgacodigos", '.
                    ...
                    '"orden"."ordefecvend", '.
                    '"orden"."ordefecfinad" '.
                'FROM "orden","ordenempresa","organizacion"'.
                ' WHERE '.
                '"orden"."ordefecregd" BETWEEN '.$fechini.' AND '.$fechfin.' ' .
                ' AND "orden"."ordenumeros"="ordenempresa"."ordenumeros" '.
		$sbTmp.
