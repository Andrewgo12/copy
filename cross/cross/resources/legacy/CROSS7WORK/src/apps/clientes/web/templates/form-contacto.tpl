...
<table border="0" align="center" width="70%">
   ...
   <tr>
      <td>{printlabel_pub name="grincodigos" blBold="true"}</td>
      <td>{select_row_table_lang id="grincodigos" name="contacto__grincodigos" table_name="gruposinteres" value="grincodigos" label="grinnombres" is_null="true" sqlid="gruposinteres"}<b>*</b></td>
  	<td class="piedefoto">{printcoment_pub name=grincodigos}</td>
   </tr>
   <tr>
