...
$rcField1["contindentis"] = array(0=>array(0=>array(0=>"textfield",1=>array("id"=>"contindentis", "name"=>"contacto__contindentis", "maxlength"=>"100", "onChange"=>"jsLoadSolicitantePub('1');"))),1=>true);
...
$rcField1["grincodigos"] = array(0=>array(0=>array(0=>"select_row_table_lang",1=>array("id"=>"grincodigos", "name"=>"contacto__grincodigos", "table_name"=>"gruposinteres", "value"=>"grincodigos", "label"=>"grinnombres", "is_null"=>"true", "sqlid"=>"gruposinteres"))),1=>true) ;

$rcField2["clieidentifs"] = array(0=>array(0=>array(0=>"textfield",1=>array("id"=>"clieidentifs", "name"=>"cliente__clieidentifs", "maxlength"=>"30", "onChange"=>"jsLoadSolicitantePub('2');"))),1=>true);
