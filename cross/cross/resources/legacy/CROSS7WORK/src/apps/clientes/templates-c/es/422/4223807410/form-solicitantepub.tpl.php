<?php /* Smarty version 2.6.0, created on 2021-08-19 16:34:24
         compiled from Form_SolicitantePub.tpl */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'loadlabels_pub', 'Form_SolicitantePub.tpl', 2, false),array('function', 'printtitle_pub', 'Form_SolicitantePub.tpl', 4, false),array('function', 'putstylepub', 'Form_SolicitantePub.tpl', 5, false),array('function', 'help_context_pub', 'Form_SolicitantePub.tpl', 14, false),array('function', 'printlabel_pub', 'Form_SolicitantePub.tpl', 23, false),array('function', 'radio', 'Form_SolicitantePub.tpl', 24, false),array('function', 'btn_button', 'Form_SolicitantePub.tpl', 52, false),array('function', 'btn_clean', 'Form_SolicitantePub.tpl', 53, false),array('function', 'hidden', 'Form_SolicitantePub.tpl', 59, false),array('function', 'putjsacceskey_pub', 'Form_SolicitantePub.tpl', 64, false),array('function', 'message', 'Form_SolicitantePub.tpl', 66, false),array('block', 'head', 'Form_SolicitantePub.tpl', 3, false),array('block', 'body', 'Form_SolicitantePub.tpl', 9, false),array('block', 'form', 'Form_SolicitantePub.tpl', 11, false),array('block', 'fieldset', 'Form_SolicitantePub.tpl', 65, false),)), $this); ?>
<html>
...
<?php echo smarty_function_putstylepub(array('style' => "estilospub.css"), $this);?>
...
<script language="javascript" src="web/js/jsSolicitantePub.js" type="text/javascript"></script>' ?>
...
<?php $_params = $this->_tag_stack[] = array('body', array('onkeydown' => "return doKeyDown(event)",'onload' => "putFocus();jsDrawTypeSolPub('1');",'onunload' => "")); smarty_block_body($_params[1], null, $this, $_block_repeat=true); unset($_params);while ($_block_repeat) { ob_start(); ?>
<br>
...
<table border="0" align="center" width="1000px">
	...
	<tr>
      <td colspan="2"><?php echo smarty_function_printlabel_pub(array('name' => 'typepn','blBold' => 'true'), $this);?>
      	  ...
      	  <?php echo smarty_function_radio(array('id' => 'typesol1','name' => 'typesol','checked' => 'true','onClick' => "jsDrawTypeSolPub('1');"), $this);?>

      	  <?php echo smarty_function_printlabel_pub(array('name' => 'typepj','blBold' => 'true'), $this);?>

      	  <?php echo smarty_function_radio(array('id' => 'typesol2','name' => 'typesol','onClick' => "jsDrawTypeSolPub('2');"), $this);?>
   ...
   <tr>
	...
	<tr>
		<td colspan="2">
			<div align="center">
				<?php echo smarty_function_btn_button(array('value' => 'Adicionar','id' => 'CmdAdd','name' => 'CmdAdd','onClick' => "jsAddSolicitantePub();"), $this);?>

				<?php echo smarty_function_btn_clean(array('table_name' => 'SolicitantePub','form_name' => 'frmSolicitante'), $this);?>
