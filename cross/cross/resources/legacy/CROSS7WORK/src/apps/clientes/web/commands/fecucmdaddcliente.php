...
class FeCuCmdAddCliente {
	function execute(){
		...
		($cliente__clietelefons != NULL) && ($cliente__clietelefons != "")){
			...
			$cliente__cliecodigos = $cliente__clieidentifs;
			...
			$message = $cliente_manager->addCliente($cliente__cliecodigos,$cliente__clieidentifs,$cliente__ticlcodigos,$cliente__clienombres,
