...
<table border="0" align="center" width="80%">
   ...
   <tr>
      <td>{printlabel name=contcodigon&blBold=true}</td>
      <td>{textfield id="contcodigon" name="contacto__contcodigon" maxlength="100"}<b>*</b></td>
  	<td class="piedefoto">{printcoment name=contcodigon}</td>
   </tr>
   <tr>
