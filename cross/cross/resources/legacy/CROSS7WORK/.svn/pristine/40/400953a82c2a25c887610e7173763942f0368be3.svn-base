...
class FeCuCmdLoadSolicitantepub {
	...
	function drawListPub(){

		settype($sbPath,"string");
		settype($sbHtml,"string");
			
		$sbPath = Application::getPluginsDirectory()."/function.drawSolicitante_pub.php";
		include($sbPath);
		$sbHtml = smarty_function_drawSolicitantePub(array(),$this,false);
		return $sbHtml;
	}
}
?>