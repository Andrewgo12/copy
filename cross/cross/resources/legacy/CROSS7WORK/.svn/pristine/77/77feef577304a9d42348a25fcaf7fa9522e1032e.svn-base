...
class FeCrPgsqlSqlExtended {
	...
	function getSqlConsult($id,$ircParam=null){
		...
		switch($id){
			...
			case "orden":
				...
				//POR SOLICITUD DE CAROLINA, YA NO HACEMOS ESTA EXCEPCIÓN
	 ...
	 * @modified
	 * Se añade el parametro que permite definir que tipos de caso deben ser excluidos
	 * @author freina<freina@parquesoft.com>
