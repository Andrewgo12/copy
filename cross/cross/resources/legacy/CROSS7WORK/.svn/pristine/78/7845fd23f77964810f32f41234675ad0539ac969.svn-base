...
<table border="0" align="center" width="60%">
   ...
   <tr>
      ...
      <td>{textfield id="activalorn" name="actividad__activalorn" maxlength="NaN" typeData="double"}</td>
   ...
   <tr>
	...
	<tr>
		<td colspan="2">
			<div align="center">
		    	{btn_command type="button" value="Adicionar" id="CmdAdd" name="FeCrCmdAddActividad" form_name="frmActividad"}
				{btn_command type="button" value="Modificar" id="CmdUpdate" name="FeCrCmdUpdateActividad" form_name="frmActividad"}
				{btn_delete type="button" value="Eliminar" id="CmdDelete" name="FeCrCmdDeleteActividad" form_name="frmActividad" table="actividad"}
				{btn_command type="button" value="Consultar" id="CmdShow" name="FeCrCmdShowListActividad" form_name="frmActividad"}
