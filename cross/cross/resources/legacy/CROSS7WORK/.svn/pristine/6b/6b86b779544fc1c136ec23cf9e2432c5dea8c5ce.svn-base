...
// Cambio para manejo de directorio de imagenes en multiesquema
...
function GenImgName() 
{
    ...
    $fname = "imagen_".rand(0,10000).".".$img_format;
    return $fname;
}
...
// PUBLIC METHODS	
    ...
    function PutAndStream(&$aImage,$aCacheFileName,$aInline,$aStrokeFileName) 
    {
		...
		if( $aStrokeFileName!="" ) 
		{
		    ...
		    $this->sbFileNameImage = $aStrokeFileName;
		    return $aStrokeFileName;
		}
    }
