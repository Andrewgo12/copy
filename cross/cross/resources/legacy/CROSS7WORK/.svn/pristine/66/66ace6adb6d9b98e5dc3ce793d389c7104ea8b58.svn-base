...
function smarty_function_register_activ($params, & $smarty) {
	...
	$rcHtml[] = "<table border='0' align='left' width='70%'>";
	...
	$rcHtml[] = "<tr>" .
			"		<td width='85%'>$sbCombo</td>" .
			"		<td width='15%'><a href='#' onClick=\"$form.action.value='FeCrCmdAddactiviacta';$form.submit();\" ><img src='web/images/positivo_002.gif' border='0' align='middle' title=\"".$rclabels["add"]["label"]."\"></a></td>" .
			" 	</tr>";
