		...
		<td class="piedefoto">
			<table border="0" align="center" width="100%">
				...
				<tr><th colspan="3"><div align="left">{printtitle_pub}</div></th></tr>
   				<tr>
      				<td width='25%' class="tdlabels">{printlabel_pub name="tiorcodigos" blBold="true"}</td>
      				<td width='60%'>
   				...
   				<tr>
   	  				<td class="tdlabels">{printlabel_pub name="evencodigos" blBold="true"}</td>
   	  				<td>
   				...
   				<tr>
      				<td class="tdlabels">{printlabel_pub name="ordeobservs" blBold="true"}</td>
				...
				<tr>
					<td class="tdlabels">{printlabel_pub name="locacodigos" blBold="true"}</td>
					<td> 
    			...
    			<tr>
    				<td colspan="2">
						...
						<table border="0" align="center" width="100%">
							<tr>
								<th colspan="2"><strong>{printlabel_pub name="denunciante_info"}</strong></th>
							</tr>
							<tr>
	      						<td class="tdlabels" align="left">{printlabel_pub name="contidentis" blBold="true"}</td>
	      						<td>
	...
	<tr>
		<td class="piedefoto">
			<table border="0" align="center" width="100%">
				...
				<tr><td colspan="2" class="piedefoto">{register_attachment_web form="frmOrden"}</td>
					<td class="piedefoto"></td>
				</tr>
			</table>
		</td>
