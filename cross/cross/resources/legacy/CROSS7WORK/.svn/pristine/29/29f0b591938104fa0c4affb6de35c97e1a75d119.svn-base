...
class FeCuPgsqlContacto {
	...
	$contdirecios, $conttelefons, $contobservs, $contnumcels, $grincodigos) {
		$sql = 'INSERT INTO "contacto" ("contcodigon","contindentis","tiidcodigos",' .
				...
				'"contemail","locacodigos","contdirecios","conttelefons","contobservs","contnumcels","grincodigos")'.
	...
	$contdirecios, $conttelefons, $contobservs, $contactivas, $contnumcels, $grincodigos) {
		...
		$contobservs.'\',"contactivas"=\''.$contactivas.'\',"contnumcels"=\''.
		$contnumcels.'\',"grincodigos"=\''.$grincodigos.'\' 
