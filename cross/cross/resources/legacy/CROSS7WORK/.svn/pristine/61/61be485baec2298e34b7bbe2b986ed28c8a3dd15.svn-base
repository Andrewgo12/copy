...
Class FeCuCmdAddContacto {
	...
	function execute() {
		...
		&& ($contacto__tiidcodigos != NULL) && ($contacto__tiidcodigos != "")) {
			...
			$contacto__contsegapes, $contacto__contfecnacis, $contacto__contedadn, $contacto__contsexos, $contacto__contemail, $contacto__locacodigos,
			$contacto__contdirecios, $contacto__conttelefons, $contacto__contobservs,$contacto__contnumcels);
