...
Class FeCuCmdAddInfractor {
	...
	function execute()
	{
        ...
        && ($infractor__infrnombres != NULL) && ($infractor__infrnombres != ""))
        {
			...
			$message = $infractor_manager->addInfractor($infractor__tiidcodigos,$infractor__infrcodigos,$infractor__ticlcodigos,$infractor__infrnombres,$infractor__infrrepreses,$infractor__infrlocalizs,$infractor__infrtelefons,$infractor__locacodigos,$infractor__infrnumfaxs,$infractor__infractivas);
