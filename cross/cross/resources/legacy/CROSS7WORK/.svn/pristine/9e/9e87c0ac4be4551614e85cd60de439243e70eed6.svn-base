<?php
 /**
	...
	* hour="true"}
*/
function smarty_function_calendar_repet($params, & $smarty) {
	...
	if(strstr($action,"ShowById"))
		$sbhtml_result .= " disabled";
	$sbhtml_result .= $disabled;
	...
	$sbhtml_result .= "<a href=\"#\"";
	if(!strstr($action,"ShowById"))
		$sbhtml_result .= " onclick=\"javascript:var Tentativa = new Date(document.forms['$form_name'].elements['$name'].value); 
