...
Class FeWFCmdAddEstadoproces {
    ...
    function execute()
    {
		...
		$estadoproces__esprdescrips = $objServ->formatString($estadoproces__esprdescrips);
            ...
            $message = $estadoproces_manager->addEstadoproces($estadoproces__esprcodigos,$estadoproces__esprnombres,$estadoproces__esprdescrips,$estadoproces__espractivas); 
