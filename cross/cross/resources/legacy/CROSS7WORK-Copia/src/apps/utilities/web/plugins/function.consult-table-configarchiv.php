...
function smarty_function_consult_table_configarchiv($params, & $smarty) {
	extract($params);
	settype($objgateway,"object");
	
	if($_REQUEST["configarchiv__tiarcodigos"] =="" || $_REQUEST["configarchiv__tiarcodigos"]==NULL){
		return;
	}
	$objgateway = Application :: getDataGateway("ConfigarchivExtended");
	$rcreq["sql"] = $objgateway->getByConfigarchiv_fkeySql($_REQUEST["configarchiv__tiarcodigos"]);
