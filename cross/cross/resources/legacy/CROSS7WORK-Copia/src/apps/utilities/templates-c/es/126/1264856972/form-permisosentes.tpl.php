<?php /* Smarty version 2.6.0, created on 2020-10-15 12:22:30
...
<?php $_params = $this->_tag_stack[] = array('head', array()); smarty_block_head($_params[1], null, $this, $_block_repeat=true); unset($_params);while ($_block_repeat) { ob_start(); ?>
      <title><?php echo "Configuraci&oacute;n de permisos por Dependencia"; ?></title>
...
<table border="0" align="center" width="60%">
  	<tr><td class="piedefoto" colspan="3"><div align="center">
		<?php echo "<fieldset class=context_help>&nbsp;&nbsp;Indica los permisos de usuario para acceder a los casos de las dependencias.<br>Seleccione el contexto, luego seleccione el usuario, seleccione las dependencias sobre los cuales desea darle permisos al usuario y presione MODIFICAR. <br>Tambi&eacute;n puede seleccionar un usuario y presionar ELIMINAR para borrar sus permisos.<br><B>Nota: </B>Recuerde que los campos marcados con asterisco ( * ) son obligatorios.</fieldset>" ?>
  	</div></td></tr>
	&nbsp;
	<tr><th colspan="3"><div align="left"><?php echo "Configuraci&oacute;n de permisos por Dependencia"; ?></div></th></tr>
...
<B>*</B></td>
  ...
  <tr>
      <td><?php echo "<B><u>D</u>ependencias</B> " ?></td>
