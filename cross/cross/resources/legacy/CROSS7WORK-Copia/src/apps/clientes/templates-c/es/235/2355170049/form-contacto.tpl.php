...
<b>*</b></td>
   ...
   <tr>
      <td><?php echo smarty_function_printlabel_pub(array('name' => 'grincodigos','blBold' => 'true'), $this);?>
</td>
      <td><?php echo smarty_function_select_row_table_lang(array('id' => 'grincodigos','name' => 'contacto__grincodigos','table_name' => 'gruposinteres','value' => 'grincodigos','label' => 'grinnombres','is_null' => 'true','sqlid' => 'gruposinteres'), $this);?>
<b>*</b></td>
  	<td class="piedefoto"><?php echo smarty_function_printcoment_pub(array('name' => 'grincodigos'), $this);?>
</td>
   </tr>
   <tr>
