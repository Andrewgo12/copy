...
<table border="0" align="center" width="60%">
   ...
   <tr>
	...
	<tr>
		<td colspan="2">
			<div align="center">
		    	{btn_command type="button" value="Adicionar" id="CmdAdd" name="FeCuCmdAddGruposinteres" form_name="frmGruposinteres"}
				{btn_command type="button" value="Modificar" id="CmdUpdate" name="FeCuCmdUpdateGruposinteres" form_name="frmGruposinteres" loadFields="gruposinteres__grincodigos,gruposinteres__grinnombres" confirm="8"}
				{btn_command type="button" value="Eliminar" id="CmdDelete" name="FeCuCmdDeleteGruposinteres" form_name="frmGruposinteres" loadFields="gruposinteres__grincodigos,gruposinteres__grinnombres" confirm="9"}
				{btn_command type="button" value="Consultar" id="CmdShow" name="FeCuCmdShowListGruposinteres" form_name="frmGruposinteres"}
