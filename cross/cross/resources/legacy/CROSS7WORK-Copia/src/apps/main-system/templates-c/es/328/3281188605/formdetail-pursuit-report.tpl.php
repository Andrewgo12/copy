<?php /* Smarty version 2.6.0, created on 2020-10-24 14:28:11
         compiled from FormDetail_Pursuit_Report.tpl */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'head', 'FormDetail_Pursuit_Report.tpl', 3, false),array('block', 'body', 'FormDetail_Pursuit_Report.tpl', 9, false),array('block', 'form', 'FormDetail_Pursuit_Report.tpl', 11, false),array('block', 'fieldset', 'FormDetail_Pursuit_Report.tpl', 82, false),array('function', 'putstyle', 'FormDetail_Pursuit_Report.tpl', 5, false),array('function', 'calendar', 'FormDetail_Pursuit_Report.tpl', 22, false),array('function', 'btn_button', 'FormDetail_Pursuit_Report.tpl', 69, false),array('function', 'hidden', 'FormDetail_Pursuit_Report.tpl', 77, false),array('function', 'selecttipos', 'FormDetail_Pursuit_Report.tpl', 80, false),array('function', 'message', 'FormDetail_Pursuit_Report.tpl', 83, false),)), $this); ?>
<html>
<?php $_params = $this->_tag_stack[] = array('head', array()); smarty_block_head($_params[1], null, $this, $_block_repeat=true); unset($_params);while ($_block_repeat) { ob_start(); ?> 
      <title><?php echo "Detallado de compromisos"; ?></title>
...
<table border="0" align="center" width="80%">
  	<tr><td class="piedefoto" colspan="3"><div align="center">
		<?php echo "<fieldset class=context_help>&nbsp;&nbsp;El detallado informa de la gesti&oacute;n que a la fecha se le ha realizado a los casos.<br><B>Nota: </B>Recuerde que los campos marcados con asterisco ( * ) son obligatorios.</fieldset>" ?>
  	</div></td></tr>
	<tr><th colspan="3"><div align="left"><?php echo "Detallado de compromisos"; ?></div></th></tr>
	<tr><th colspan="3"><div align="left">&nbsp;</div></th></tr>
	
   <tr>
      <td><?php echo "<B><u>F</u>echa inicial</B> " ?></td>
      <td>
   ...
   <tr>
      <td><?php echo "<B>F<u>e</u>cha final</B> " ?></td>
      <td>
   ...
   <tr>
	...
	<tr>
		<td colspan="2">
			<div align="center">
				<?php echo smarty_function_btn_button(array('value' => 'Consultar','id' => 'CmdShow','name' => 'consultar','onClick' => "if(valDatos())fncopenwindows('FeCrCmdDefaultDetail_Pursuits','ordefecingdini='+this.form.orden__ordefecingdini.value+'&ordefecingdfin='+this.form.orden__ordefecingdfin.value+'&reporte='+this.form.reporte.value+'&tipoorden='+this.form.tipoorden.value+'&dependencia='+this.form.dependencia.value);"), $this);?>
...
<?php echo smarty_function_selecttipos(array('opcion' => '2'), $this);?>
