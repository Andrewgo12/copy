<?php /* Smarty version 2.6.0, created on 2020-10-10 09:08:24
         compiled from Form_Detallado.tpl */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'head', 'Form_Detallado.tpl', 3, false),array('block', 'body', 'Form_Detallado.tpl', 9, false),array('block', 'form', 'Form_Detallado.tpl', 11, false),array('block', 'fieldset', 'Form_Detallado.tpl', 100, false),array('function', 'putstyle', 'Form_Detallado.tpl', 5, false),array('function', 'calendar', 'Form_Detallado.tpl', 22, false),array('function', 'btn_button', 'Form_Detallado.tpl', 88, false),array('function', 'hidden', 'Form_Detallado.tpl', 95, false),array('function', 'selecttipos', 'Form_Detallado.tpl', 98, false),array('function', 'message', 'Form_Detallado.tpl', 101, false),)), $this); ?>
<html>
<?php $_params = $this->_tag_stack[] = array('head', array()); smarty_block_head($_params[1], null, $this, $_block_repeat=true); unset($_params);while ($_block_repeat) { ob_start(); ?> 
      <title><?php echo "Detallado"; ?></title>
...
<table border="0" align="center" width="80%">
	...
	<tr><th colspan="3"><div align="left"><?php echo "Detallado"; ?></div></th></tr>
...
<?php $this->_block_content = ob_get_contents(); ob_end_clean(); echo smarty_block_form($this->_tag_stack[count($this->_tag_stack)-1][1], $this->_block_content, $this, $_block_repeat=false); }  array_pop($this->_tag_stack);  echo smarty_function_selecttipos(array('opcion' => '1'), $this);?>
