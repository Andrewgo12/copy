	...
	<tr>
		<td class="piedefoto">
			<table border="0" align="center" width="100%">
				<tr>
					<th colspan="3"><div align="left">{printtitle}</div></th>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>{select_row_table id="tiorcodigos" 
							name="ordenempresa__tiorcodigos" sqlid="tipoorden" table_name="tipoorden" value="tiorcodigos" label="tiornombres" is_null="true" 
				...
				<tr>
					<td colspan="2">{printlabel name=ubicacion}</td>
					<td class="piedefoto">{printcoment name=ubicacion}</td>
				</tr>
				<tr>
	...
	<tr>
		<td class="piedefoto">
			<table border="0" align="center" width="100%">
				...
				<tr>
					<td colspan="2" class="piedefoto">{register_attachment form="frmOrden"}</td>
					<td valign="bottom" class="piedefoto">{printcoment name=add}</td>
				</tr>
			</table>
		</td>
	</tr>
