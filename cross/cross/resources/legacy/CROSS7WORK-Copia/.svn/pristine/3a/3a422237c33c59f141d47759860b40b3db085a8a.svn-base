...
class FeGeCmdAddEquivalencias {
	function execute() {
		...
		if (($equitablcros != NULL) && ($equitablcros != "") && ($equicampcros != NULL) && ($equicampcros != "")
		&& ($equivalcros != NULL) && ($equivalcros != "") && ($equinomcros != NULL) && ($equinomcros != "")
		&& ($equiareacros !=NULL) && ($equiareacros !="") && ($equitabldocs != NULL) && ($equitabldocs != "")
		&& ($equicampdocs != NULL) && ($equicampdocs != "") && ($equivaldocs != NULL) && ($equivaldocs != "")
		&& ($equinomdocs != NULL) && ($equinomdocs != "") && ($equiareadocs != NULL) && ($equiareadocs != "")
		&& ($equiseridocs !=NULL) && ($equiseridocs !="") && ($equiestados != NULL) && ($equiestados != "")) {
