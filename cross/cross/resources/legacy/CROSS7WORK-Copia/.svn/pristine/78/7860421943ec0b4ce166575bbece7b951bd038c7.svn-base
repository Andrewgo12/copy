...
class FeGeProfile_2_1 {
	...
	*/
	...
	$rcnode[]=array("son"=>"FeGeCmdDefaultEquivalencias", "father"=>"configuracion_del_sistema");
	...
	$rcnode[]=array("son"=>"FeGeCmdDefaultIntegralog", "father"=>"utilidades");
	...
	$rcnode[]=array("son"=>"FeCuCmdDefaultSegurisocial", "father"=>"configuracion_customers");
	$rcnode[]=array("son"=>"FeCuCmdDefaultCondiusuario", "father"=>"configuracion_customers");
	$rcnode[]=array("son"=>"FeCuCmdDefaultTipoexamen", "father"=>"configuracion_customers");
	$rcnode[]=array("son"=>"FeCuCmdDefaultIpsservicio", "father"=>"configuracion_customers");
	$rcnode[]=array("son"=>"registro_customers", "father"=>"customers");
	$rcnode[]=array("son"=>"FeCuCmdDefaultCliente", "father"=>"registro_customers");
	$rcnode[]=array("son"=>"FeCuCmdDefaultPaciente", "father"=>"registro_customers");
	...
	$rcnode[]=array("son"=>"FeCrCmdDefaultAreaCausante", "father"=>"reportes_cross");
	...
	$FeGeCmdDefaultEquivalencias = new HTML_TreeNode($rclabels["FeGeCmdDefaultEquivalencias"],"javascript:fncLoadCmd(\'FeGeCmdDefaultEquivalencias\',\'general\')");
	...
	$FeGeCmdDefaultIntegralog = new HTML_TreeNode($rclabels["FeGeCmdDefaultIntegralog"],"javascript:fncLoadCmd(\'FeGeCmdDefaultIntegralog\',\'general\')");
	...
	$FeCuCmdDefaultSegurisocial = new HTML_TreeNode($rclabels["FeCuCmdDefaultSegurisocial"],"javascript:fncLoadCmd(\'FeCuCmdDefaultSegurisocial\',\'customers\')");
	$FeCuCmdDefaultCondiusuario = new HTML_TreeNode($rclabels["FeCuCmdDefaultCondiusuario"],"javascript:fncLoadCmd(\'FeCuCmdDefaultCondiusuario\',\'customers\')");
	$FeCuCmdDefaultTipoexamen = new HTML_TreeNode($rclabels["FeCuCmdDefaultTipoexamen"],"javascript:fncLoadCmd(\'FeCuCmdDefaultTipoexamen\',\'customers\')");
	$FeCuCmdDefaultIpsservicio = new HTML_TreeNode($rclabels["FeCuCmdDefaultIpsservicio"],"javascript:fncLoadCmd(\'FeCuCmdDefaultIpsservicio\',\'customers\')");
	...
	$FeCuCmdDefaultPaciente = new HTML_TreeNode($rclabels["FeCuCmdDefaultPaciente"],"javascript:fncLoadCmd(\'FeCuCmdDefaultPaciente\',\'customers\')");
	...
	$FeCrCmdDefaultAreaCausante = new HTML_TreeNode($rclabels["FeCrCmdDefaultAreaCausante"],"javascript:fncLoadCmd(\'FeCrCmdDefaultAreaCausante\',\'cross300\')");
