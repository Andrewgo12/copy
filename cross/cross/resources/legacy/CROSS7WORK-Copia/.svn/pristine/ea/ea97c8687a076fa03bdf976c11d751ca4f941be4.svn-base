...
class FeCuCmdUpdateFormapago {
    function execute()
    {
        ...
        if(($formapago__fopacodigos != NULL) && ($formapago__fopacodigos != "") && ($formapago__fopanombres != NULL) && ($formapago__fopanombres != "")){
            ...
            $message = $formapago_manager->updateFormapago($formapago__fopacodigos,$formapago__fopanombres,$formapago__fopatiempon,$formapago__fopacancuotn,$formapago__fopadescrips,$formapago__fopaactivos); 
