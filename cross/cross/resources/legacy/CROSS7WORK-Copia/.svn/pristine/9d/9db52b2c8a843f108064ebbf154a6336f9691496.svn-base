...
class FeCrPgsqlOrdenempresaExtended {
	...
	$oremsolucios,$infrcodigos,$paciindentis) {
		...
		$sbsql = 'INSERT INTO "ordenempresa" ("ordenumeros","contidentis","priocodigos",' .
				...
				'"locacodigos","oremradicas","infrcodigos","oremsolucios","paciindentis")'
	...
	$oremradicas,$infrcodigos,$oremsolucios,$paciindentis) {
	...
	function getByIdOrdenempresajoin($ordenumeros) {
		...
		$sbSql = 'SELECT 
							...
							"orden"."ordeobservs" 
                        FROM "orden","ordenempresa","localizacion","proceso","tipoorden","evento","mediorecepcion"
						WHERE
							...
							"ordenempresa"."locacodigos"="localizacion"."locacodigos"';
    ...
    function getByOrdenOrdenempresa($ordenumeros){
        ...
        $sbSql='SELECT  
          ...
          FROM ' .
          		...
          		'LEFT JOIN "contacto" ON ("ordenempresa"."contidentis"="contacto"."contindentis") '.$sbTable.
        		' WHERE ' .
