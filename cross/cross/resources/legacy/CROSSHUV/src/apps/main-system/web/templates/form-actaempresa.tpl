...
<table border="0" align="center" width="80%">
   ...
   <tr>
      <td>{printlabel name=compromisos}</td>
      <td>{checkbox id="checkcomp" name="checkcomp" onClick='showCompromisos(this);'}</td>
  	   <td class="piedefoto">{printcoment name=acemradics}</td>
   </tr>

   <tr>
	   <td colspan="2" class="piedefoto">
	      <div id="compromisos" align="justify" style="visibility:none;diplay:0;">
		      {showCompromisos form="frmActaempresa"}
	      </div>
	   </td>
	   <td class="piedefoto"></td>
	</tr>
...
<SCRIPT>showCompromisos(document.frmActaempresa.checkcomp);</Script>
