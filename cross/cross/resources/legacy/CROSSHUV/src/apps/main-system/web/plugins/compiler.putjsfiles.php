...
function smarty_compiler_putjsfiles($params, &$smarty) 
{
	settype($rctmp,"array");
	...
	$nucont = 0;
	//Inactivar bloqueo del maouse cazapata
        //$rcfiles = array("jsrsClient.js","jsAccessKey.js","putFocus.js","noMouse.js","optionKey.js","disableButtons.js");
