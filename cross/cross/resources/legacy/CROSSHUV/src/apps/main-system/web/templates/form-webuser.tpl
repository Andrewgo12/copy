			...
			<table border="0" align="center" width="100%">
				<tr>
					<td class="piedefoto" colspan="3">
						<div align="justify">{help_context_pub}</div>
					</td>
				</tr>
				&nbsp;
				<tr>
					<th colspan="3">
						<div align="left">{printtitle_pub}</div>
					</th>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>{textfield id="ordesitiejes" name="orden__ordesitiejes" onBlur="if(this.value)autoReference('dep_fisica','orgacodigos',Array(this),this.form.orden_ordesitiejes_desc)"}
						{href label="<img src='web/images/menu.gif' border='0' align='middle'></img>"
						...
						<div id="paciente" style="visibility:hidden; display:none ">
							<table border="0" align="center" width="100%">
								...
								<tr>
									...
									<td>{select_row_table name="ordenempresa__sesocodigos" id="sesocodigos" label="sesonombres" sqlid="segurisocial" is_null="true" value="sesocodigos"}<B>*</B>
									</td>
								</tr>
								<tr>
									<td>{printlabel_pub name="couscodigos" blBold="true"}</td>
									<td>{select_row_table name="ordenempresa__couscodigos" id="couscodigos" label="cousnombres" sqlid="condiusuario" is_null="true" value="couscodigos"}<B>*</B>
									</td>
								</tr>
								<tr>
									<td>{printlabel_pub name="ipscodigos" blBold="true"}</td>
									<td>{select_row_table name="ordenempresa__ipsecodigos" id="ipsecodigos" label="ipsenombres" sqlid="ips" is_null="true" value="ipsecodigos"}<B>*</B>
									</td>
								</tr>
								<tr>
									<td>{printlabel_pub name="contidentis_p"}</td>
									<td>{dataselectdojo htmlid="contidentis_p" name="ordenempresa__contidentis_p" sqlid="contacto_ident" value="contcodigon" label="contindentis" forceautoreference="true"} 
										{href label="<img src='web/images/crear.gif' border='0' align='absmiddle'></img>"
						...
						<div id="denunciante"  style="visibility:hidden; display:none ">
							<table border="0" align="center" width="100%">
								...
								<tr>
									...
									<td>{dataselectdojo htmlid="contidentis" name="ordenempresa__contidentis" sqlid="contacto_ident" value="contcodigon" label="contindentis" forceautoreference="true"} 
										{href label="<img src='web/images/crear.gif' border='0' align='absmiddle'></img>"
											onclick="javascript:OpenWindowsSol('../customers/index.php?action=FeCuCmdDefaultSolicitante','');"
										}
									</td>
				...
				<tr>
					<td colspan="2">
						<div align="center">
							...
							<input type="button" value="Consultar mi PQRSF" onclick="consultarPorCedula();" style="background:#28a745;color:white;padding:8px 15px;border:none;border-radius:5px;cursor:pointer;margin-left:10px;">
						</div>
					</td>
					<td width='15%' class="piedefoto"></td>
				</tr>
				<tr>
					<td colspan="2" class="piedefoto">{register_attachment_web form="frmOrden"}</td>
					<td class="piedefoto"></td>
				</tr>
			</table>
		</td>
...
<script language="javascript">
	...
	function consultarPorCedula() {
		var numeroCaso = prompt('Ingrese el número de su caso PQRSF:', '');
		if (numeroCaso && numeroCaso.trim() !== '') {
			...
			url += '&ordenumerosFO=' + encodeURIComponent(numeroCaso.trim());
			url += '&vars=ordenumerosFO';
			window.open(url, '_blank', 'width=1200,height=800,scrollbars=yes,resizable=yes');
		} else {
			alert('Debe ingresar el número de caso para consultar su PQRSF');
		}
	}
</script>
{/form}
