...
class FeCuCmdUpdateEstadoclient {
	function execute() {
		...
		&& ($estadoclient__esclnombres != NULL) && ($estadoclient__esclnombres != "")) {
			...
			$message = $estadoclient_manager->updateEstadoclient($estadoclient__esclcodigos, $estadoclient__esclnombres, $estadoclient__escldescrips, $estadoclient__esclactivos);
