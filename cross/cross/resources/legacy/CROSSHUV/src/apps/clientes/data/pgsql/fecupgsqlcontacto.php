...
class FeCuPgsqlContacto {
	...
	function updateContacto($contcodigon, $contindentis, $tiidcodigos, $cliecodigon, $contprinoms, $contsegnoms, $contpriapes, 
	                        $contsegapes, $contfecnacis, $contedadn, $contsexos, $contemail, $locacodigos, $contdirecios, 
							$conttelefons, $contobservs, $contactivas, $contnumcels) {
		$sql = 'UPDATE "contacto" SET "contindentis"=\''.$contindentis.'\',"tiidcodigos"=\''.$tiidcodigos.'\',"cliecodigon"=\''.
		                   $cliecodigon.'\',"contprinoms"=\''.$contprinoms.'\',"contsegnoms"=\''.$contsegnoms.
		                   '\',"contpriapes"=\''.$contpriapes.'\',"contsegapes"=\''.$contsegapes.'\',"contfecnacis"='.$contfecnacis.
		                   ', "contedadn"='.$contedadn.', "contsexos"=\''.$contsexos.'\',"contemail"=\''.$contemail.'\',"locacodigos"=\''.
				           $locacodigos.'\',"contdirecios"=\''.$contdirecios.'\',"conttelefons"=\''.$conttelefons.'\',"contobservs"=\''.
	...
	function getByIdContacto($contcodigon) {
		$sql = 'SELECT "contacto".*, (COALESCE("contacto"."contprinoms", \'\') || \' \' || COALESCE("contacto"."contsegnoms", \'\') || \' \' || COALESCE("contacto"."contpriapes", \'\') || \' \' || COALESCE("contacto"."contsegapes", \'\'))  AS "contnombre" 
		        FROM "contacto" 
				WHERE "contcodigon"='.$contcodigon.' ';
