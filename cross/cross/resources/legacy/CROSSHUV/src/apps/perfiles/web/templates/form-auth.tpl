...
<table border="0" align="center" width="60%">
   ...
   <tr>
      ...
      <td>{textfield id="authusernams" name="auth__authusernams" maxlength="100"}<B>*</B></td>
   ...
   <tr>
	...
	<tr>
		<td colspan="2">
			<div align="center">
		    	{btn_command type="button" value="Adicionar" id="CmdAdd" name="FePrCmdAddAuth" form_name="frmAuth"}
				...
				{btn_command type="button" value="Eliminar" id="CmdDelete" name="FePrCmdDeleteAuth" form_name="frmAuth" loadFields="auth__authusernams,auth__authuserpasss,auth__authrealname,auth__stylcodigos,auth__langcodigos,auth__profcodigos" confirm="12"}
