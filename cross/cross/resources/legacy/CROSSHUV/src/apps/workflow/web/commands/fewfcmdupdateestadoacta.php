...
class FeWFCmdUpdateEstadoacta {
    function execute()
    {
        ...
        if(($estadoacta__esaccodigos != NULL) && ($estadoacta__esaccodigos != "") && ($estadoacta__esacnombres != NULL) && ($estadoacta__esacnombres != "")){
            ...
            $message = $estadoacta_manager->updateEstadoacta($estadoacta__esaccodigos,$estadoacta__esacnombres,$estadoacta__esacdescrips,$estadoacta__esacactivas); 
