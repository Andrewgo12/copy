...
$Application_params = array (
	0 => array( //parametros para la empresa (esquema 2)
        "general" =>array(
                    ...
                    "email_server"=>"mail.dominio.com", //Servidor de correo
                    "empresa"=>array("emprnits"=>"#########-#","emprnombres"=>"Nombre empresa","emprdireccs"=>"Direcci&oacute;n",
                                     "emprtelefos"=>"","emprfaxs"=>"",
                                     "emprnombreps"=>"Representante Legal","emprlogos"=>"logo_empresa.png","empremail"=>"correo","email_pass"=>"PASS USUARIO SERVIDOR DE CORREO"),//datos de la empresa                    
        ...
        'dimension' => array
        				...
        				'TIPOGRAPH_REPORT' => array(
            				...
            				array('line2','L&iacute;neas Sin Marcas de Clase'),
            				array('line3','Pir&aacute;mides'),
            									),
        					...
        					'month'=>array(array('1','Enero'),
                             ...
                             'frequency'=>array(array('timetable','Horaria'),
                                                  array('daily','Diaria'),
                                                  array('dayweek','Por d&iacute;a de la semana'),                                                  
                             ...
                             'idioma' => array(
                               			array("01","ESPA&Ntilde;OL"),
										array("02","INGLES"),
                             ),	
                             'estcivil' => array(
                               			array("01","CASADO(A) "),
										array("02","SOLTERO(A)"),
										array("03","UNI&Oacute;N LIBRE"),
										array("04","VIUDO(A)"),
										array("05","SEPARADO(A)"),
                             ),
                             'formapago' => array(
                               			array("01","TARJETA DE CR&Eacute;DITO"),
										array("02","TARJETA D&Eacute;BITO"),
										array("03","EFECTIVO"),
                             ), 
