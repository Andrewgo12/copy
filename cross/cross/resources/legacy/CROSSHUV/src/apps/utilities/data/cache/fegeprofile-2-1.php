...
class FeGeProfile_2_1 {
	...
	*/
	...
	$rcnode[]=array("son"=>"FeCrCmdDefaultGruposinteres", "father"=>"configuracion_cross");
	...
	$rcnode[]=array("son"=>"FeCrCmdDefaultSeguimiento", "father"=>"reportes_cross");
	...
	$FeCrCmdDefaultGruposinteres = new HTML_TreeNode($rclabels["FeCrCmdDefaultGruposinteres"],"javascript:fncLoadCmd(\'FeCrCmdDefaultGruposinteres\',\'cross300\')");
