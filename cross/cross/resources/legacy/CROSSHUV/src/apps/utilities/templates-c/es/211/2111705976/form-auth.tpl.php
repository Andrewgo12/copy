<?php /* Smarty version 2.6.0, created on 2020-09-25 14:32:07
...
<table border="0" align="center" width="60%">
  	<tr><td class="piedefoto" colspan="3"><div align="center">
		<?php echo "<fieldset class=context_help>&nbsp;&nbsp;La clave de usuario no debe ser menor a cuatro caracteres y s&oacute;lo permite los siguientes caracteres [A-Z][a-z][0-9] punto (.) y gui&oacute;n (-).<br><b>NOTA: </b>Recuerde que los campos con asterisco (*) son obligatorios.</fieldset>" ?>
  	</div></td></tr>
	&nbsp;
	...
	<tr>
		<td colspan="2"><?php echo "Datos b&aacute;sicos del usuario"; ?></td>
		<td class="piedefoto"></td>
	</tr>
   <tr>
      <td><?php echo "Nombre de Usuario " ?></td>
   ...
   <tr>
      <td><?php echo "<B><u>E</u>stilo</B> " ?></td>
...
<B>*</B></td>
	...
	<tr>
		<td colspan="2"><?php echo "Actualizar clave"; ?></td>
		<td class="piedefoto"></td>
	</tr>
	<tr>
      <td><?php echo "<B>In<u>g</u>rese la clave actual</B> " ?></td>
