...
dojo.widget.defineWidget("dojo.widget.Clock", dojo.widget.HtmlWidget, function () {
	...
	this.domNode.style.width = "58px";
	this.domNode.style.height = "58px";
	this.surface = dojo.gfx.createSurface(this.domNode, 58, 58);
	this.surface.createRect({width:58, height:58});
	this.surface.createImage({width:58, height:58, src:this.image + ""});
	var hP = [{x:-1, y:-2}, {x:1, y:-2}, {x:1, y:-15}, {x:-1, y:-15}, {x:-1, y:-2}];
	var mP = [{x:-1, y:-2}, {x:1, y:-2}, {x:1, y:-20}, {x:-1, y:-20}, {x:-1, y:-2}];
	var sP = [{x:-1, y:-2}, {x:1, y:-2}, {x:1, y:-20}, {x:-1, y:-20}, {x:-1, y:-2}];
