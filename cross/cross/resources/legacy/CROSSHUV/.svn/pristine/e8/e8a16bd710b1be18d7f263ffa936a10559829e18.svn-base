...
Class FeCuCmdUpdatePaciente {
	...
	function execute() {
		...
		&& ($paciente__tiidcodigos != NULL) && ($paciente__tiidcodigos != "")) {
			...
			$nuMessage = $objManager->updatePaciente($paciente__paciindentis, $paciente__tiidcodigos, 
			$paciente__paciprinoms, $paciente__pacisegnoms, $paciente__pacipriapes, 
			$paciente__pacisegapes, $paciente__pacifecnacis, $paciente__sexocodigos, 
			$paciente__paciemail, $paciente__locacodigos, $paciente__pacidirecios, 
			$paciente__pacitelefons, $paciente__pacihisclis, $paciente__paciobservs, $paciente__paciactivos,$paciente__pacinumcels);
