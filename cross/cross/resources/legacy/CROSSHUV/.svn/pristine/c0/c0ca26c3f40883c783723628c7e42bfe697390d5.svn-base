...
class FeCrPgsqlCampconfform {
	var $consult;
	var $objdb;

	function FeCrPgsqlCampconfform() {
	...
	function addCampconfform($cacocodigon, $caconombres, $cacoprocedes) {
		$sql = 'INSERT INTO "campconfform" ("cacocodigon","caconombres","cacoprocedes") VALUES('.$cacocodigon.',\''.$caconombres.'\',\''.$cacoprocedes.'\')';
		$this->objdb->fncadoexecute($sql);
