...
class FeCrPgsqlConfigformat {
	var $consult;
	var $objdb;

	function FeCrPgsqlConfigformat() {
	...
	function addConfigformat($cofocodigon, $cofonombres, $focacodigos) {
		$sql = 'INSERT INTO "configformat" ("cofocodigon","cofonombres","focacodigos") VALUES('.$cofocodigon.',\''.$cofonombres.'\',\''.$focacodigos.'\')';
		$this->objdb->fncadoexecute($sql);
