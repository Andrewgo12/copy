...
class FeCrCmdShowListOrden {
	function execute() {
		...
		if (!WebSession :: issetProperty("paciindentis_desc"))
			WebSession :: setProperty("paciindentis_desc", $paciindentis_desc);
		if (!WebSession :: issetProperty("ordenempresa__sesocodigos"))
			WebSession :: setProperty("ordenempresa__sesocodigos", $ordenempresa__sesocodigos);
		if (!WebSession :: issetProperty("ordenempresa__couscodigos"))
			WebSession :: setProperty("ordenempresa__couscodigos", $ordenempresa__couscodigos);
		if (!WebSession :: issetProperty("ordenempresa__ipsecodigos"))
			WebSession :: setProperty("ordenempresa__ipsecodigos", $ordenempresa__ipsecodigos);
