...
function smarty_function_register_attachment($params, & $smarty) {
	...
	$sbhtml .= "<td colspan=\"2\" width='60%'><input type=file name=anexos___anexnombarch size=50 maxlength=100>&nbsp;<a href='#' onClick=\"$form.action.value='FeCrCmdAddAnexos';$form.submit();\" >";
	...
	if ($rcFileName) {
		...
		foreach ($rcFileName as $nuCont => $rcTmp) {
			...
			$sbhtml .="<td align='center' class='$sbEstilo'>"."<a href='#' onClick=\"$form.action.value='FeCrCmdDeleteAnexos';$form.deleteattachment.value='".$rcTmp["index"]."';$form.submit();\">";
