...
class FeHrCmdUpdateEstadoorgani {
    function execute()
    {
        extract($_REQUEST);
        if(($estadoorgani__esorcodigos != NULL) && ($estadoorgani__esorcodigos != "")
         && ($estadoorgani__esornombres != NULL) && ($estadoorgani__esornombres != "")){
            ...
            $message = $estadoorgani_manager->updateEstadoorgani($estadoorgani__esorcodigos,$estadoorgani__esornombres,$estadoorgani__esordescrips,$estadoorgani__esoractivas); 
