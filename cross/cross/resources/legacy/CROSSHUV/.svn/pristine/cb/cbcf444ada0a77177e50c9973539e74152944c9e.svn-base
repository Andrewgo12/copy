...
class General {
	...
	function General() {
		...
		//Cambia la configuracion de la aplicaciï¿½n
	...
	/**
		...
		Muestra toda la informaciï¿½n del servicio
		@author creyes <cesar.reyes@parquesoft.com>
	...
	function serviceInfo() {
		$rcinfo = array ("getAllLocations" => "Copyright 2004 ï¿½ FullEngine<br>
							...
							"getSqlEmail" => '*Copyright 2004 ï¿½ FullEngine
											...
											@location Cali-Colombia',
						"getSqlCommunication"=>'Copyright 2004 ï¿½ FullEngine
																...
																@location Cali-Colombia',
						 "getAllActiveLocations"=>'Copyright 2004 ï¿½ FullEngine
						...
						"getDateEnd"=>'@copyright Copyright 2004 &copy; FullEngine
										...
										@location Cali-Colombia',
						"getByIdLocalizacion" =>'Copyright 2004 ï¿½ FullEngine
						...
						"getLocation"=>'@copyright Copyright 2004 &copy; FullEngine" .
								...
								"getTextfield"=>'@copyright Copyright 2004 &copy; FullEngine<br>
														 ...
														 @param array \$rcParams Parametros de visualizaciï¿½n<br>
																										[border] => Borde de la tabla<br>
																									    [cols] => columnas de la ficha<br>
																									    [size_label] => Tamaï¿½o en % del td de la etiqueta<br>
																									    [size_table] => Tamaï¿½o en % de la tabla<br>
		...
		* @location Cali-Colombia',
		"sendGenericEmail"=>'Obtiene el asunto de un email de acuerdo a el formato especificado
		@param	array	$rcData
		@return boolean true proceso exitoso false error
		@author freina <freina@fullengine.com>
		@date 07-Apr-2015 15:08
		@location Cali-Colombia');
	...
	* @copyright Copyright 2004 &copy; FullEngine
	*
	* Determina la cantidad de dï¿½as habiles entre 2 fechas, 
	...
	* @return int days cantidad de dï¿½as 
	* @author creyes <cesar.reyes@parquesoft.com>
	* @date 04-nov-2004 16:12:44
	* @location Cali-Colombia
	*/
	...
	*/
	function SendSMS ($rcData) {
		...
		//COMO NO ES OBLIGATORIO EL MOVIL, SOLO ENVIAMOS EL SMS SI VIENE UN MOVIL VÁLIDO
...
/**
	...
	*	@location Cali-Colombia		
	*/
	function sendGenericEmail($rcData){
	 	...
	 	if($rcData){
	 		...
	 		$sbFoemcodigos = $rcData["formato"];
	 		$objManager = Application :: getDomainController("CentroEmailManager");
	 		$nuResult = $objManager->sendGenericEmail($sbEmaidesdes, $sbEmaiparas, $sbEmaiasuntos, 
	 		$sbEmaitextos, $sbFoemcodigos, $rcData);
	 		if($nuResult!=3){
	 			$sbResult = false;
	 		} 
	 	}
