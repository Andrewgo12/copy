...
class FeCuCmdUpdateTipomoneda {
    function execute()
    {
        ...
        if(($tipomoneda__timocodigos != NULL) && ($tipomoneda__timocodigos != "") && ($tipomoneda__timonombres != NULL) && ($tipomoneda__timonombres != "")){
            ...
            $message = $tipomoneda_manager->updateTipomoneda($tipomoneda__timocodigos,$tipomoneda__timonombres,$tipomoneda__timoequivaln,$tipomoneda__timodescrips,$tipomoneda__timoactivas); 
