...
$Application_config = array (
    'name' => 'cross300',
    'description' => 'Control Work Manager',
    'version' => '3',
...
// library path
    'include_path' => array (
        ...
        dirname(__FILE__).'/../../../lib/pdf',
        dirname(__FILE__).'/../../../lib/menu',
        dirname(__FILE__).'/../../../lib/smtp-mail',
        dirname(__FILE__).'/../../../lib/download',
        dirname(__FILE__).'/../../../lib/pear',
        dirname(__FILE__).'/../../../lib/html2pdf',
        dirname(__FILE__).'/../../../lib/word',
        dirname(__FILE__).'/../../../lib/nusoap',
...
if($fd){
    ...
    die("[GENERAL] configuration file ERROR\n");
}
die("[GENERAL] configuration file OK\n");
?>