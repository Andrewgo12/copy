...
class FeStCmdAddBodega {
    function execute()
    {
		...
		$bodega__bodefechfind = $objServ->formatString($bodega__bodefechfind);
            ...
            $message = $bodega_manager->addBodega($bodega__bodecodigos,$bodega__tibocodigos,$bodega__bodenombres,$bodega__bodedescrips,$bodega__orgacodigos,$bodega__bodefechcred,$bodega__bodefechfind,$bodega__bodeestados); 
