...
class FeCrCmdAddGruposinteres {
    function execute()
    {
		...
		&& ($gruposinteres__grinnombres != NULL) && ($gruposinteres__grinnombres != "")){
            ...
            $message = $gruposinteres_manager->addgruposinteres($gruposinteres__grincodigos,$gruposinteres__grinnombres,$gruposinteres__grindescrips,$gruposinteres__grinactivos); 
