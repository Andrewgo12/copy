...
class FeCuCmdUpdateTipocontrato {
    function execute()
    {
        ...
        if(($tipocontrato__ticocodigos != NULL) && ($tipocontrato__ticocodigos != "") && ($tipocontrato__ticonombres != NULL) && ($tipocontrato__ticonombres != "")){
            ...
            $message = $tipocontrato_manager->updateTipocontrato($tipocontrato__ticocodigos,$tipocontrato__ticonombres,$tipocontrato__ticodescrips,$tipocontrato__ticoactivos); 
