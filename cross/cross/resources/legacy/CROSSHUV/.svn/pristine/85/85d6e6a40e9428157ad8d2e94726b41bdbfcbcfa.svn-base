...
Class FeEnCmdAddPregunta {
	...
	function execute(){
		...
		if(($pregunta__pregdescris != NULL) && ($pregunta__pregdescris != "")
		...
		&&($pregunta__temacodigon != NULL) && ($pregunta__temacodigon != "")){
			...
			$nuMessage = $objManager->addPregunta($pregunta__pregdescris,$pregunta__temacodigon,$pregunta__morecodigon,$pregunta__pregtipopres,$pregunta__pregactivas);
