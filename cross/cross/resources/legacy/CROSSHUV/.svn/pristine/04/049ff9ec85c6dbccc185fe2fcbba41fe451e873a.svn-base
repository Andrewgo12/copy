...
class FeGeSendMailManager {
	function FeGeSendMailManager() {
		...
		$this->smtp->user= $this->rchdrs["from"];                     /* Set to the user name if the server requires authetication */
		$this->smtp->realm="";                    /* Set to the authetication realm, usually the authentication user e-mail domain */
		$this->smtp->password= $rcEmpresa["email_pass"];                 /* Set to the authetication password */
