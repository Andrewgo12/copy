...
<?php
   ...
   $Ord_Cmp = new grid_metodosauths_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_metodosauths_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["meaucodigon"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_metodosauths']['labels']["meaucodigon"])) ? $_SESSION['sc_session'][$sc_init]['grid_metodosauths']['labels']["meaucodigon"] : "" . $this->Nm_lang['lang_metodosauths_fld_meaucodigon'] . "";
   $tab_ger_campos['meaunombres'] = "on";
   $tab_def_campos['meaunombres'] = "meaunombres";
   $tab_converte["meaunombres"]   = "meaunombres";
   $tab_labels["meaunombres"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_metodosauths']['labels']["meaunombres"])) ? $_SESSION['sc_session'][$sc_init]['grid_metodosauths']['labels']["meaunombres"] : "" . $this->Nm_lang['lang_metodosauths_fld_meaunombres'] . "";
   $tab_ger_campos['meaudescrips'] = "on";
   $tab_def_campos['meaudescrips'] = "meaudescrips";
   $tab_converte["meaudescrips"]   = "meaudescrips";
   $tab_labels["meaudescrips"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_metodosauths']['labels']["meaudescrips"])) ? $_SESSION['sc_session'][$sc_init]['grid_metodosauths']['labels']["meaudescrips"] : "" . $this->Nm_lang['lang_metodosauths_fld_meaudescrips'] . "";
   $tab_ger_campos['usuacodigos'] = "on";
   $tab_def_campos['usuacodigos'] = "usuacodigos";
   $tab_converte["usuacodigos"]   = "usuacodigos";
   $tab_labels["usuacodigos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_metodosauths']['labels']["usuacodigos"])) ? $_SESSION['sc_session'][$sc_init]['grid_metodosauths']['labels']["usuacodigos"] : "" . $this->Nm_lang['lang_metodosauths_fld_usuacodigos'] . "";
   $tab_ger_campos['meaufecregd'] = "on";
   $tab_def_campos['meaufecregd'] = "meaufecregd";
   $tab_converte["meaufecregd"]   = "meaufecregd";
   $tab_labels["meaufecregd"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_metodosauths']['labels']["meaufecregd"])) ? $_SESSION['sc_session'][$sc_init]['grid_metodosauths']['labels']["meaufecregd"] : "" . $this->Nm_lang['lang_metodosauths_fld_meaufecregd'] . "";
   $tab_ger_campos['meauestados'] = "on";
   $tab_def_campos['meauestados'] = "meauestados";
   $tab_converte["meauestados"]   = "meauestados";
   $tab_labels["meauestados"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_metodosauths']['labels']["meauestados"])) ? $_SESSION['sc_session'][$sc_init]['grid_metodosauths']['labels']["meauestados"] : "" . $this->Nm_lang['lang_metodosauths_fld_meauestados'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_metodosauths']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_metodosauths']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_metodosauths']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_metodosauths']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_metodosauths']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_metodosauths']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_metodosauths']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_metodosauths']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_metodosauths']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> <?php echo $this->Nm_lang['lang_tbl_metodosauths'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_metodosauths_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_metodosauths']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_metodosauths']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
