...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Portal_ID_____grid_metodosauths"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Portal_ID_____grid_metodosauths"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_metodosauths'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_metodosauths']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_metodosauths']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_metodosauths']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_metodosauths']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_metodosauths']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_metodosauths']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_metodosauths']['embutida_filho'] as $ind => $sc_init)
          {
