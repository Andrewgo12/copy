  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_aplicaciones" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_aplicaciones_validate_aplicodigon()
  {
    var nomeCampo_aplicodigon = "aplicodigon";
    var var_aplicodigon = scAjaxGetFieldText(nomeCampo_aplicodigon);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aplicaciones_validate_aplicodigon(var_aplicodigon, var_script_case_init, do_ajax_form_aplicaciones_validate_aplicodigon_cb);
  } // do_ajax_form_aplicaciones_validate_aplicodigon

  function do_ajax_form_aplicaciones_validate_aplicodigon_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aplicaciones_validate_aplicodigon_cb

  // ---------- Validate aplinombres
  function do_ajax_form_aplicaciones_validate_aplinombres()
  {
    var nomeCampo_aplinombres = "aplinombres";
    var var_aplinombres = scAjaxGetFieldText(nomeCampo_aplinombres);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aplicaciones_validate_aplinombres(var_aplinombres, var_script_case_init, do_ajax_form_aplicaciones_validate_aplinombres_cb);
  } // do_ajax_form_aplicaciones_validate_aplinombres

  function do_ajax_form_aplicaciones_validate_aplinombres_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aplicaciones_validate_aplinombres_cb

  // ---------- Validate aplidescrips
  function do_ajax_form_aplicaciones_validate_aplidescrips()
  {
    var nomeCampo_aplidescrips = "aplidescrips";
    var var_aplidescrips = scAjaxGetFieldText(nomeCampo_aplidescrips);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aplicaciones_validate_aplidescrips(var_aplidescrips, var_script_case_init, do_ajax_form_aplicaciones_validate_aplidescrips_cb);
  } // do_ajax_form_aplicaciones_validate_aplidescrips

  function do_ajax_form_aplicaciones_validate_aplidescrips_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aplicaciones_validate_aplidescrips_cb

  // ---------- Validate usuacodigos
  function do_ajax_form_aplicaciones_validate_usuacodigos()
  {
    var nomeCampo_usuacodigos = "usuacodigos";
    var var_usuacodigos = scAjaxGetFieldText(nomeCampo_usuacodigos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aplicaciones_validate_usuacodigos(var_usuacodigos, var_script_case_init, do_ajax_form_aplicaciones_validate_usuacodigos_cb);
  } // do_ajax_form_aplicaciones_validate_usuacodigos

  function do_ajax_form_aplicaciones_validate_usuacodigos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aplicaciones_validate_usuacodigos_cb

  // ---------- Validate aplifecregd
  function do_ajax_form_aplicaciones_validate_aplifecregd()
  {
    var nomeCampo_aplifecregd = "aplifecregd";
    var var_aplifecregd = scAjaxGetFieldText(nomeCampo_aplifecregd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aplicaciones_validate_aplifecregd(var_aplifecregd, var_script_case_init, do_ajax_form_aplicaciones_validate_aplifecregd_cb);
  } // do_ajax_form_aplicaciones_validate_aplifecregd

  function do_ajax_form_aplicaciones_validate_aplifecregd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aplicaciones_validate_aplifecregd_cb

  // ---------- Validate apliestados
  function do_ajax_form_aplicaciones_validate_apliestados()
  {
    var nomeCampo_apliestados = "apliestados";
    var var_apliestados = scAjaxGetFieldSelect(nomeCampo_apliestados);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aplicaciones_validate_apliestados(var_apliestados, var_script_case_init, do_ajax_form_aplicaciones_validate_apliestados_cb);
  } // do_ajax_form_aplicaciones_validate_apliestados

  function do_ajax_form_aplicaciones_validate_apliestados_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aplicaciones_validate_apliestados_cb
  // ---------- Form
  function do_ajax_form_aplicaciones_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_aplicaciones_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_aplicaciones_submit_form(var_aplicodigon, var_aplinombres, var_aplidescrips, var_usuacodigos, var_aplifecregd, var_apliestados, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_aplicaciones_submit_form_cb);
  } // do_ajax_form_aplicaciones_submit_form

  function do_ajax_form_aplicaciones_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_aplicaciones_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_aplicaciones_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_aplicaciones_navigate_form(var_aplicodigon, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_aplicaciones_navigate_form_cb);
  } // do_ajax_form_aplicaciones_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_aplicaciones']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_aplicaciones_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_aplicaciones_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
...
{
?>
    do_ajax_form_aplicaciones_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_aplicaciones_navigate_form_cb
  function sc_hide_form_aplicaciones_form()
  {
