  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_aplicaciones_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_aplicaciones_mob_validate_aplicodigon()
  {
    var nomeCampo_aplicodigon = "aplicodigon";
    var var_aplicodigon = scAjaxGetFieldText(nomeCampo_aplicodigon);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aplicaciones_mob_validate_aplicodigon(var_aplicodigon, var_script_case_init, do_ajax_form_aplicaciones_mob_validate_aplicodigon_cb);
  } // do_ajax_form_aplicaciones_mob_validate_aplicodigon

  function do_ajax_form_aplicaciones_mob_validate_aplicodigon_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aplicaciones_mob_validate_aplicodigon_cb

  // ---------- Validate aplinombres
  function do_ajax_form_aplicaciones_mob_validate_aplinombres()
  {
    var nomeCampo_aplinombres = "aplinombres";
    var var_aplinombres = scAjaxGetFieldText(nomeCampo_aplinombres);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aplicaciones_mob_validate_aplinombres(var_aplinombres, var_script_case_init, do_ajax_form_aplicaciones_mob_validate_aplinombres_cb);
  } // do_ajax_form_aplicaciones_mob_validate_aplinombres

  function do_ajax_form_aplicaciones_mob_validate_aplinombres_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "aplinombres";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aplicaciones_mob_validate_aplinombres_cb

  // ---------- Validate aplidescrips
  function do_ajax_form_aplicaciones_mob_validate_aplidescrips()
  {
    var nomeCampo_aplidescrips = "aplidescrips";
    var var_aplidescrips = scAjaxGetFieldText(nomeCampo_aplidescrips);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aplicaciones_mob_validate_aplidescrips(var_aplidescrips, var_script_case_init, do_ajax_form_aplicaciones_mob_validate_aplidescrips_cb);
  } // do_ajax_form_aplicaciones_mob_validate_aplidescrips

  function do_ajax_form_aplicaciones_mob_validate_aplidescrips_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "aplidescrips";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aplicaciones_mob_validate_aplidescrips_cb

  // ---------- Validate usuacodigos
  function do_ajax_form_aplicaciones_mob_validate_usuacodigos()
  {
    var nomeCampo_usuacodigos = "usuacodigos";
    var var_usuacodigos = scAjaxGetFieldText(nomeCampo_usuacodigos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aplicaciones_mob_validate_usuacodigos(var_usuacodigos, var_script_case_init, do_ajax_form_aplicaciones_mob_validate_usuacodigos_cb);
  } // do_ajax_form_aplicaciones_mob_validate_usuacodigos

  function do_ajax_form_aplicaciones_mob_validate_usuacodigos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aplicaciones_mob_validate_usuacodigos_cb

  // ---------- Validate aplifecregd
  function do_ajax_form_aplicaciones_mob_validate_aplifecregd()
  {
    var nomeCampo_aplifecregd = "aplifecregd";
    var var_aplifecregd = scAjaxGetFieldText(nomeCampo_aplifecregd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aplicaciones_mob_validate_aplifecregd(var_aplifecregd, var_script_case_init, do_ajax_form_aplicaciones_mob_validate_aplifecregd_cb);
  } // do_ajax_form_aplicaciones_mob_validate_aplifecregd

  function do_ajax_form_aplicaciones_mob_validate_aplifecregd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "aplifecregd";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aplicaciones_mob_validate_aplifecregd_cb

  // ---------- Validate apliestados
  function do_ajax_form_aplicaciones_mob_validate_apliestados()
  {
    var nomeCampo_apliestados = "apliestados";
    var var_apliestados = scAjaxGetFieldSelect(nomeCampo_apliestados);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aplicaciones_mob_validate_apliestados(var_apliestados, var_script_case_init, do_ajax_form_aplicaciones_mob_validate_apliestados_cb);
  } // do_ajax_form_aplicaciones_mob_validate_apliestados

  function do_ajax_form_aplicaciones_mob_validate_apliestados_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "apliestados";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aplicaciones_mob_validate_apliestados_cb
  // ---------- Form
  function do_ajax_form_aplicaciones_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_aplicaciones_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_aplicodigon = scAjaxGetFieldText("aplicodigon");
    var var_aplinombres = scAjaxGetFieldText("aplinombres");
    var var_aplidescrips = scAjaxGetFieldText("aplidescrips");
    var var_usuacodigos = scAjaxGetFieldText("usuacodigos");
    var var_aplifecregd = scAjaxGetFieldText("aplifecregd");
    var var_apliestados = scAjaxGetFieldSelect("apliestados");
    ...
    scAjaxProcOn();
    x_ajax_form_aplicaciones_mob_submit_form(var_aplicodigon, var_aplinombres, var_aplidescrips, var_usuacodigos, var_aplifecregd, var_apliestados, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_aplicaciones_mob_submit_form_cb);
  } // do_ajax_form_aplicaciones_mob_submit_form

  function do_ajax_form_aplicaciones_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("aplinombres");
      scAjaxHideErrorDisplay("aplidescrips");
      scAjaxHideErrorDisplay("usuacodigos");
      scAjaxHideErrorDisplay("aplifecregd");
      scAjaxHideErrorDisplay("apliestados");
      scLigEditLookupCall();
<?php
...
?>
  ...
  } // do_ajax_form_aplicaciones_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_aplicaciones_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("aplifecregd");
    scAjaxHideErrorDisplay("apliestados");
    var var_aplicodigon = document.F2.aplicodigon.value;
    ...
    scAjaxProcOn();
    x_ajax_form_aplicaciones_mob_navigate_form(var_aplicodigon, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_aplicaciones_mob_navigate_form_cb);
  } // do_ajax_form_aplicaciones_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_aplicaciones_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_aplicaciones_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_aplicaciones_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.aplicodigon.value = scAjaxGetKeyValue("aplicodigon");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
{
?>
    do_ajax_form_aplicaciones_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_aplicaciones_mob_navigate_form_cb
  function sc_hide_form_aplicaciones_mob_form()
  {
  ...
  ajax_field_list[0] = "aplicodigon";
  ajax_field_list[1] = "aplinombres";
  ajax_field_list[2] = "aplidescrips";
  ajax_field_list[3] = "usuacodigos";
  ajax_field_list[4] = "aplifecregd";
  ajax_field_list[5] = "apliestados";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "aplicodigon": {"label": "<?php echo $this->Ini->Nm_lang['lang_aplicaciones_fld_aplicodigon'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "aplinombres": {"label": "<?php echo $this->Ini->Nm_lang['lang_aplicaciones_fld_aplinombres'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "aplidescrips": {"label": "<?php echo $this->Ini->Nm_lang['lang_aplicaciones_fld_aplidescrips'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "usuacodigos": {"label": "<?php echo $this->Ini->Nm_lang['lang_aplicaciones_fld_usuacodigos'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "aplifecregd": {"label": "<?php echo $this->Ini->Nm_lang['lang_aplicaciones_fld_aplifecregd'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "apliestados": {"label": "<?php echo $this->Ini->Nm_lang['lang_aplicaciones_fld_apliestados'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "aplinombres": new Array(),
    "aplidescrips": new Array(),
    "usuacodigos": new Array(),
    "aplifecregd": new Array(),
    "apliestados": new Array()
  };
  ajax_field_mult["aplicodigon"][1] = "aplicodigon";
  ajax_field_mult["aplinombres"][1] = "aplinombres";
  ajax_field_mult["aplidescrips"][1] = "aplidescrips";
  ajax_field_mult["usuacodigos"][1] = "usuacodigos";
  ajax_field_mult["aplifecregd"][1] = "aplifecregd";
  ajax_field_mult["apliestados"][1] = "apliestados";

  var ajax_field_id = {
    "aplicodigon": new Array("hidden_field_label_aplicodigon", "hidden_field_data_aplicodigon"),
    "aplinombres": new Array("hidden_field_label_aplinombres", "hidden_field_data_aplinombres"),
    "aplidescrips": new Array("hidden_field_label_aplidescrips", "hidden_field_data_aplidescrips"),
    "usuacodigos": new Array("hidden_field_label_usuacodigos", "hidden_field_data_usuacodigos"),
    "aplifecregd": new Array("hidden_field_label_aplifecregd", "hidden_field_data_aplifecregd"),
    "apliestados": new Array("hidden_field_label_apliestados", "hidden_field_data_apliestados")
  };
