...
<?php
   ...
   $Ord_Cmp = new grid_tiposclientes_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tiposclientes_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_def_campos['ticlcodigos'] = "ticlcodigos";
   $tab_converte["ticlcodigos"]   = "ticlcodigos";
   $tab_labels["ticlcodigos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tiposclientes']['labels']["ticlcodigos"])) ? $_SESSION['sc_session'][$sc_init]['grid_tiposclientes']['labels']["ticlcodigos"] : "" . $this->Nm_lang['lang_tiposclientes_fld_ticlcodigos'] . "";
   $tab_ger_campos['ticlnombres'] = "on";
   $tab_def_campos['ticlnombres'] = "ticlnombres";
   $tab_converte["ticlnombres"]   = "ticlnombres";
   $tab_labels["ticlnombres"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tiposclientes']['labels']["ticlnombres"])) ? $_SESSION['sc_session'][$sc_init]['grid_tiposclientes']['labels']["ticlnombres"] : "" . $this->Nm_lang['lang_tiposclientes_fld_ticlnombres'] . "";
   $tab_ger_campos['ticldescrips'] = "on";
   $tab_def_campos['ticldescrips'] = "ticldescrips";
   $tab_converte["ticldescrips"]   = "ticldescrips";
   $tab_labels["ticldescrips"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tiposclientes']['labels']["ticldescrips"])) ? $_SESSION['sc_session'][$sc_init]['grid_tiposclientes']['labels']["ticldescrips"] : "" . $this->Nm_lang['lang_tiposclientes_fld_ticldescrips'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tiposclientes']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tiposclientes']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tiposclientes']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tiposclientes']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tiposclientes']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tiposclientes']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tiposclientes']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tiposclientes']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tiposclientes']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tiposclientes_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_tiposclientes']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_tiposclientes']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
