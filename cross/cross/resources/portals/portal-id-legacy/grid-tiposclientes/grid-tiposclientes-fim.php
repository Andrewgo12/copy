...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Portal_ID_____grid_tiposclientes"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Portal_ID_____grid_tiposclientes"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tiposclientes'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tiposclientes']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tiposclientes']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tiposclientes']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tiposclientes']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tiposclientes']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tiposclientes</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tiposclientes']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tiposclientes']['embutida_filho'] as $ind => $sc_init)
          {
