...
function scFocusField(sField) {
  ...
  if ($oField.length > 0) {
    switch ($oField[0].name) {
      ...
      case 'cliefcharegd':
      case 'clieactivos':
        sc_exib_ocult_pag('form_clientes_mob_form0');
        break;
      case 'detalle_publicaciones':
        sc_exib_ocult_pag('form_clientes_mob_form1');
        break;
    }
  }
...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_cliefcharegd_hora' + iSeqRow).bind('blur', function() { sc_form_clientes_cliefcharegd_onblur(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_clientes_cliefcharegd_onfocus(this, iSeqRow) });
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_cliefcharegd" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_clientes_mob_validate_cliefcharegd(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
