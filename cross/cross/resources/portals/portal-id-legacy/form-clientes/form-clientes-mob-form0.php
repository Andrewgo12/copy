...
?>
<script type="text/javascript">
var pag_ativa = "form_clientes_mob_form0";
</script>
<ul class="scTabLine sc-ui-page-tab-line">
<?php
    $this->tabCssClass = array(
        'form_clientes_mob_form0' => array(
            'title' => "Información básica",
            'class' => $nmgp_num_form == "form_clientes_mob_form0" ? "scTabActive" : "scTabInactive",
        ),
        'form_clientes_mob_form1' => array(
            'title' => "Publicaciones",
            'class' => $nmgp_num_form == "form_clientes_mob_form1" ? "scTabActive" : "scTabInactive",
        ),
    );
        if (!empty($this->Ini->nm_hidden_pages)) {
                foreach ($this->Ini->nm_hidden_pages as $pageName => $pageStatus) {
                        if ('Información básica' == $pageName && 'off' == $pageStatus) {
                                $this->tabCssClass['form_clientes_mob_form0']['class'] = 'scTabInactive';
                        }
                        if ('Publicaciones' == $pageName && 'off' == $pageStatus) {
                                $this->tabCssClass['form_clientes_mob_form1']['class'] = 'scTabInactive';
                        }
                }
...
?>
<?php
    $css_celula = $this->tabCssClass["form_clientes_mob_form0"]['class'];
?>
   <li id="id_form_clientes_mob_form0" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('form_clientes_mob_form0')">
     <img src="<?php echo $this->Ini->path_icones ?>/scriptcase__NM__ico__NM__address_book_edit_24.png" align="absmiddle">
     Información básica
    </a>
   </li>
<?php
    $css_celula = $this->tabCssClass["form_clientes_mob_form1"]['class'];
?>
   <li id="id_form_clientes_mob_form1" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('form_clientes_mob_form1')">
...
<div id="form_clientes_mob_form0" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tiidcodigos_line" id="hidden_field_data_tiidcodigos" style="<?php echo $sStyleHidden_tiidcodigos; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tiidcodigos_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tiidcodigos_label"><span id="id_label_tiidcodigos"><?php echo $this->nm_new_label['tiidcodigos']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mob']['php_cmp_required']['tiidcodigos']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mob']['php_cmp_required']['tiidcodigos'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_clieidentifs_line" id="hidden_field_data_clieidentifs" style="<?php echo $sStyleHidden_clieidentifs; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_clieidentifs_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_clieidentifs_label"><span id="id_label_clieidentifs"><?php echo $this->nm_new_label['clieidentifs']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mob']['php_cmp_required']['clieidentifs']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mob']['php_cmp_required']['clieidentifs'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ticlcodigos_line" id="hidden_field_data_ticlcodigos" style="<?php echo $sStyleHidden_ticlcodigos; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ticlcodigos_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ticlcodigos_label"><span id="id_label_ticlcodigos"><?php echo $this->nm_new_label['ticlcodigos']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mob']['php_cmp_required']['ticlcodigos']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mob']['php_cmp_required']['ticlcodigos'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mob']['Lookup_clieactivos'][] = 'A'; ?>
 <option  value="I" <?php  if ($this->clieactivos == "I") { echo " selected" ;} ?>><?php echo $this->Ini->Nm_lang['lang_select_inactivo']; ?></option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mob']['Lookup_clieactivos'][] = 'I'; ?>
 </select></span>
</span><?php  }?>
