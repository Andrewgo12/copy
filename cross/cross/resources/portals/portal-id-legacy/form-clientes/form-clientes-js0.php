...
{
    document.getElementById('form_clientes_form0').style.width='1px';
    document.getElementById('form_clientes_form0').style.height='0px';
    document.getElementById('form_clientes_form0').style.display='none';
    document.getElementById('form_clientes_form0').style.overflow='scroll';
    document.getElementById('form_clientes_form1').style.width='1px';
    document.getElementById('form_clientes_form1').style.height='0px';
    document.getElementById('form_clientes_form1').style.display='none';
    document.getElementById('form_clientes_form1').style.overflow='scroll';
   ...
   if ("form_clientes_form1" == N_pagina) {
