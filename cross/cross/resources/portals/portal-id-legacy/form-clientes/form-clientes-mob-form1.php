<div id="form_clientes_mob_form1" style='<?php echo ($this->tabCssClass["form_clientes_mob_form1"]['class'] == 'scTabInactive' ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalle_publicaciones'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalle_publicaciones'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mob']['grid_publicaciones_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mob']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_detalle_publicaciones'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mob']['grid_publicaciones_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 if (isset($this->Ini->sc_lig_md5["grid_publicaciones"]) && $this->Ini->sc_lig_md5["grid_publicaciones"] == "S") {
     ...
     $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_clientes_mob@SC_par@" . md5($Parms_Lig);
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mob']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
 } else {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_clientes_mob_empty.htm' : $this->Ini->link_grid_publicaciones_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=600' . $parms_lig_cons;
...
if (isset($this->Ini->sc_lig_target['C_@scinf_detalle_publicaciones']) && 'nmsc_iframe_liga_grid_publicaciones' != $this->Ini->sc_lig_target['C_@scinf_detalle_publicaciones'])
{
    ...
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mob']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_detalle_publicaciones'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mob']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mob']['grid_publicaciones_script_case_init']);
    }
?>
...
<script> 
<?php
 $NM_pag_atual = "form_clientes_mob_form0";
 if (isset($this->nmgp_ancora) && $this->nmgp_ancora != "")
 {
     $NM_pag_atual = "form_clientes_mob_form" . $this->nmgp_ancora;
 }
?>
<?php
