...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_clientes_externo_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_clientes_externo_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['recarga'];
}
?>
...
<?php
 include_once("form_clientes_externo_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_clientes_externo'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_clientes_externo'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['run_iframe'] != "R")
{
?>
...
<?php 
    if (isset($this->NMSC_modal) && $this->NMSC_modal == "ok") {
        $sCondStyle = '';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bsair", "scBtnFn_sys_format_sai_modal()", "scBtnFn_sys_format_sai_modal()", "sc_b_sai_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + Q)", "sc-unique-btn-4", "", "");?>
...
?>
<script type="text/javascript">
var pag_ativa = "form_clientes_externo_form0";
</script>
<ul class="scTabLine sc-ui-page-tab-line">
<?php
    $this->tabCssClass = array(
        'form_clientes_externo_form0' => array(
            'title' => "Información básica",
            'class' => empty($nmgp_num_form) || $nmgp_num_form == "form_clientes_externo_form0" ? "scTabActive" : "scTabInactive",
        ),
        'form_clientes_externo_form1' => array(
            'title' => "Publicaciones",
            'class' => $nmgp_num_form == "form_clientes_externo_form1" ? "scTabActive" : "scTabInactive",
        ),
    );
        if (!empty($this->Ini->nm_hidden_pages)) {
                foreach ($this->Ini->nm_hidden_pages as $pageName => $pageStatus) {
                        if ('Información básica' == $pageName && 'off' == $pageStatus) {
                                $this->tabCssClass['form_clientes_externo_form0']['class'] = 'scTabInactive';
                        }
                        if ('Publicaciones' == $pageName && 'off' == $pageStatus) {
                                $this->tabCssClass['form_clientes_externo_form1']['class'] = 'scTabInactive';
                        }
                }
...
?>
<?php
    $css_celula = $this->tabCssClass["form_clientes_externo_form0"]['class'];
?>
   <li id="id_form_clientes_externo_form0" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('form_clientes_externo_form0')">
     <img src="<?php echo $this->Ini->path_icones ?>/scriptcase__NM__ico__NM__address_book_edit_24.png" align="absmiddle">
     Información básica
    </a>
   </li>
<?php
    $css_celula = $this->tabCssClass["form_clientes_externo_form1"]['class'];
?>
   <li id="id_form_clientes_externo_form1" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('form_clientes_externo_form1')">
...
<div id="form_clientes_externo_form0" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tiidcodigos_label" id="hidden_field_label_tiidcodigos" style="<?php echo $sStyleHidden_tiidcodigos; ?>"><span id="id_label_tiidcodigos"><?php echo $this->nm_new_label['tiidcodigos']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['php_cmp_required']['tiidcodigos']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['php_cmp_required']['tiidcodigos'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_clieidentifs_label" id="hidden_field_label_clieidentifs" style="<?php echo $sStyleHidden_clieidentifs; ?>"><span id="id_label_clieidentifs"><?php echo $this->nm_new_label['clieidentifs']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['php_cmp_required']['clieidentifs']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['php_cmp_required']['clieidentifs'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_clienombres_label" id="hidden_field_label_clienombres" style="<?php echo $sStyleHidden_clienombres; ?>"><span id="id_label_clienombres"><?php echo $this->nm_new_label['clienombres']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['php_cmp_required']['clienombres']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['php_cmp_required']['clienombres'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_paiscodigos_label" id="hidden_field_label_paiscodigos" style="<?php echo $sStyleHidden_paiscodigos; ?>"><span id="id_label_paiscodigos"><?php echo $this->nm_new_label['paiscodigos']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['php_cmp_required']['paiscodigos']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['php_cmp_required']['paiscodigos'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cliecontacts_label" id="hidden_field_label_cliecontacts" style="<?php echo $sStyleHidden_cliecontacts; ?>"><span id="id_label_cliecontacts"><?php echo $this->nm_new_label['cliecontacts']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['php_cmp_required']['cliecontacts']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['php_cmp_required']['cliecontacts'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cliemailcons_label" id="hidden_field_label_cliemailcons" style="<?php echo $sStyleHidden_cliemailcons; ?>"><span id="id_label_cliemailcons"><?php echo $this->nm_new_label['cliemailcons']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['php_cmp_required']['cliemailcons']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['php_cmp_required']['cliemailcons'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_esclcodigos_label" id="hidden_field_label_esclcodigos" style="<?php echo $sStyleHidden_esclcodigos; ?>"><span id="id_label_esclcodigos"><?php echo $this->nm_new_label['esclcodigos']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['php_cmp_required']['esclcodigos']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['php_cmp_required']['esclcodigos'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['Lookup_esclcodigos'][] = ''; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['Lookup_esclcodigos'][] = 'EC1'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ticlcodigos_label" id="hidden_field_label_ticlcodigos" style="<?php echo $sStyleHidden_ticlcodigos; ?>"><span id="id_label_ticlcodigos"><?php echo $this->nm_new_label['ticlcodigos']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['php_cmp_required']['ticlcodigos']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['php_cmp_required']['ticlcodigos'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['Lookup_clieactivos'][] = 'A'; ?>
 <option  value="I" <?php  if ($this->clieactivos == "I") { echo " selected" ;} ?>><?php echo $this->Ini->Nm_lang['lang_select_inactivo']; ?></option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['Lookup_clieactivos'][] = 'I'; ?>
 </select></span>
</span><?php  }?>
