...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_clientes_externo/form_clientes_externo_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_clientes_externo_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_clientes_externo_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['recarga'];
}
?>
<body class="scFormPage" style="<?php echo $str_iframe_body; ?>">
<?php

if (isset($_SESSION['scriptcase']['form_clientes_externo']['error_buffer']) && '' != $_SESSION['scriptcase']['form_clientes_externo']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_clientes_externo']['error_buffer'];
}
...
<?php
 include_once("form_clientes_externo_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_clientes_externo_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_clientes_externo_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_clientes_externo_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['fast_search'][2] : "";
?> 
...
<?php echo nmButtonOutput($this->arr_buttons, "bnovo", "scBtnFn_sys_format_inc()", "scBtnFn_sys_format_inc()", "sc_b_new_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + Enter)", "sc-unique-btn-5", "", "group_2_t");?>
  </div>
...
<?php echo nmButtonOutput($this->arr_buttons, "bincluir", "scBtnFn_sys_format_inc()", "scBtnFn_sys_format_inc()", "sc_b_ins_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + Enter)", "sc-unique-btn-6", "", "group_2_t");?>
  </div>
...
<?php echo nmButtonOutput($this->arr_buttons, "balterar", "scBtnFn_sys_format_alt()", "scBtnFn_sys_format_alt()", "sc_b_upd_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + S)", "sc-unique-btn-7", "", "group_2_t");?>
  </div>
...
<?php echo nmButtonOutput($this->arr_buttons, "bexcluir", "scBtnFn_sys_format_exc()", "scBtnFn_sys_format_exc()", "sc_b_del_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + Delete)", "sc-unique-btn-8", "", "group_2_t");?>
  </div>
...
<?php echo nmButtonOutput($this->arr_buttons, "bcopy", "scBtnFn_sys_format_copy()", "scBtnFn_sys_format_copy()", "sc_b_clone_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + Shift + C)", "sc-unique-btn-10", "", "group_2_t");?>
  </div>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
?>
<script type="text/javascript">
var pag_ativa = "form_clientes_externo_mob_form0";
</script>
<ul class="scTabLine sc-ui-page-tab-line">
<?php
    $this->tabCssClass = array(
        'form_clientes_externo_mob_form0' => array(
            'title' => "Información básica",
            'class' => $nmgp_num_form == "form_clientes_externo_mob_form0" ? "scTabActive" : "scTabInactive",
        ),
        'form_clientes_externo_mob_form1' => array(
            'title' => "Publicaciones",
            'class' => $nmgp_num_form == "form_clientes_externo_mob_form1" ? "scTabActive" : "scTabInactive",
        ),
    );
        if (!empty($this->Ini->nm_hidden_pages)) {
                foreach ($this->Ini->nm_hidden_pages as $pageName => $pageStatus) {
                        if ('Información básica' == $pageName && 'off' == $pageStatus) {
                                $this->tabCssClass['form_clientes_externo_mob_form0']['class'] = 'scTabInactive';
                        }
                        if ('Publicaciones' == $pageName && 'off' == $pageStatus) {
                                $this->tabCssClass['form_clientes_externo_mob_form1']['class'] = 'scTabInactive';
                        }
                }
...
?>
<?php
    $css_celula = $this->tabCssClass["form_clientes_externo_mob_form0"]['class'];
?>
   <li id="id_form_clientes_externo_mob_form0" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('form_clientes_externo_mob_form0')">
     <img src="<?php echo $this->Ini->path_icones ?>/scriptcase__NM__ico__NM__address_book_edit_24.png" align="absmiddle">
     Información básica
    </a>
   </li>
<?php
    $css_celula = $this->tabCssClass["form_clientes_externo_mob_form1"]['class'];
?>
   <li id="id_form_clientes_externo_mob_form1" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('form_clientes_externo_mob_form1')">
...
<div id="form_clientes_externo_mob_form0" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormDataOdd css_cliecodigon_line" id="hidden_field_data_cliecodigon" style="<?php echo $sStyleHidden_cliecodigon; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cliecodigon_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cliecodigon_label"><span id="id_label_cliecodigon"><?php echo $this->nm_new_label['cliecodigon']; ?></span></span><br><span id="id_read_on_cliecodigon" class="css_cliecodigon_line" style="<?php echo $sStyleReadLab_cliecodigon; ?>"><?php echo $this->form_encode_input($this->cliecodigon); ?></span><span id="id_read_off_cliecodigon" style="<?php echo $sStyleReadInp_cliecodigon; ?>"><input type="hidden" name="cliecodigon" value="<?php echo $this->form_encode_input($cliecodigon) . "\">"?><span id="id_ajax_label_cliecodigon"><?php echo nl2br($cliecodigon); ?></span>
</span></span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_cliecodigon_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_cliecodigon_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }
      else
      {
         $sc_hidden_no--;
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tiidcodigos_line" id="hidden_field_data_tiidcodigos" style="<?php echo $sStyleHidden_tiidcodigos; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tiidcodigos_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tiidcodigos_label"><span id="id_label_tiidcodigos"><?php echo $this->nm_new_label['tiidcodigos']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['php_cmp_required']['tiidcodigos']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['php_cmp_required']['tiidcodigos'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_clieidentifs_line" id="hidden_field_data_clieidentifs" style="<?php echo $sStyleHidden_clieidentifs; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_clieidentifs_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_clieidentifs_label"><span id="id_label_clieidentifs"><?php echo $this->nm_new_label['clieidentifs']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['php_cmp_required']['clieidentifs']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['php_cmp_required']['clieidentifs'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_clienombres_line" id="hidden_field_data_clienombres" style="<?php echo $sStyleHidden_clienombres; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_clienombres_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_clienombres_label"><span id="id_label_clienombres"><?php echo $this->nm_new_label['clienombres']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['php_cmp_required']['clienombres']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['php_cmp_required']['clienombres'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $sStyleHidden_clienombres_dumb = ('' == $sStyleHidden_clienombres) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_clienombres_dumb" style="<?php echo $sStyleHidden_clienombres_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_paiscodigos_line" id="hidden_field_data_paiscodigos" style="<?php echo $sStyleHidden_paiscodigos; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_paiscodigos_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_paiscodigos_label"><span id="id_label_paiscodigos"><?php echo $this->nm_new_label['paiscodigos']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['php_cmp_required']['paiscodigos']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['php_cmp_required']['paiscodigos'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cliedireccis_line" id="hidden_field_data_cliedireccis" style="<?php echo $sStyleHidden_cliedireccis; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cliedireccis_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cliedireccis_label"><span id="id_label_cliedireccis"><?php echo $this->nm_new_label['cliedireccis']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_clietelfijs_line" id="hidden_field_data_clietelfijs" style="<?php echo $sStyleHidden_clietelfijs; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_clietelfijs_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_clietelfijs_label"><span id="id_label_clietelfijs"><?php echo $this->nm_new_label['clietelfijs']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cliepagwebs_line" id="hidden_field_data_cliepagwebs" style="<?php echo $sStyleHidden_cliepagwebs; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cliepagwebs_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cliepagwebs_label"><span id="id_label_cliepagwebs"><?php echo $this->nm_new_label['cliepagwebs']; ?></span></span><br>
...
<?php $sStyleHidden_cliepagwebs_dumb = ('' == $sStyleHidden_cliepagwebs) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_cliepagwebs_dumb" style="<?php echo $sStyleHidden_cliepagwebs_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cliecontacts_line" id="hidden_field_data_cliecontacts" style="<?php echo $sStyleHidden_cliecontacts; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cliecontacts_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cliecontacts_label"><span id="id_label_cliecontacts"><?php echo $this->nm_new_label['cliecontacts']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['php_cmp_required']['cliecontacts']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['php_cmp_required']['cliecontacts'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cliecelconts_line" id="hidden_field_data_cliecelconts" style="<?php echo $sStyleHidden_cliecelconts; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cliecelconts_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cliecelconts_label"><span id="id_label_cliecelconts"><?php echo $this->nm_new_label['cliecelconts']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cliemailcons_line" id="hidden_field_data_cliemailcons" style="<?php echo $sStyleHidden_cliemailcons; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cliemailcons_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cliemailcons_label"><span id="id_label_cliemailcons"><?php echo $this->nm_new_label['cliemailcons']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['php_cmp_required']['cliemailcons']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['php_cmp_required']['cliemailcons'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $sStyleHidden_cliemailcons_dumb = ('' == $sStyleHidden_cliemailcons) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_cliemailcons_dumb" style="<?php echo $sStyleHidden_cliemailcons_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_esclcodigos_line" id="hidden_field_data_esclcodigos" style="<?php echo $sStyleHidden_esclcodigos; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_esclcodigos_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_esclcodigos_label"><span id="id_label_esclcodigos"><?php echo $this->nm_new_label['esclcodigos']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['php_cmp_required']['esclcodigos']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['php_cmp_required']['esclcodigos'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["esclcodigos"]) &&  $this->nmgp_cmp_readonly["esclcodigos"] == "on") { 

$esclcodigos_look = "";
 if ($this->esclcodigos == "EC1") { $esclcodigos_look .= "" . $this->Ini->Nm_lang['lang_select_activo'] . "" ;} 
 if (empty($esclcodigos_look)) { $esclcodigos_look = $this->esclcodigos; }
?>
...
$esclcodigos_look = "";
 ...
 if (empty($esclcodigos_look)) { $esclcodigos_look = $this->esclcodigos; }
?>
<span id="id_read_on_esclcodigos" class="css_esclcodigos_line"  style="<?php echo $sStyleReadLab_esclcodigos; ?>"><?php echo $this->form_encode_input($esclcodigos_look); ?></span><span id="id_read_off_esclcodigos" style="<?php echo $sStyleReadInp_esclcodigos; ?>">
 <span id="idAjaxSelect_esclcodigos"><select class="sc-js-input scFormObjectOdd css_esclcodigos_obj" style="" id="id_sc_field_esclcodigos" name="esclcodigos" size="1" alt="{type: 'select', enterTab: false}">
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['Lookup_esclcodigos'][] = ''; ?>
 <option value=""><?php echo $this->Ini->Nm_lang['lang_select_opcion'] ?></option>
 <option  value="EC1" <?php  if ($this->esclcodigos == "EC1") { echo " selected" ;} ?><?php  if (empty($this->esclcodigos)) { echo " selected" ;} ?>><?php echo $this->Ini->Nm_lang['lang_select_activo']; ?></option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['Lookup_esclcodigos'][] = 'EC1'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ticlcodigos_line" id="hidden_field_data_ticlcodigos" style="<?php echo $sStyleHidden_ticlcodigos; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ticlcodigos_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ticlcodigos_label"><span id="id_label_ticlcodigos"><?php echo $this->nm_new_label['ticlcodigos']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['php_cmp_required']['ticlcodigos']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['php_cmp_required']['ticlcodigos'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $sStyleHidden_ticlcodigos_dumb = ('' == $sStyleHidden_ticlcodigos) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_ticlcodigos_dumb" style="<?php echo $sStyleHidden_ticlcodigos_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cliefcharegd_line" id="hidden_field_data_cliefcharegd" style="<?php echo $sStyleHidden_cliefcharegd; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cliefcharegd_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cliefcharegd_label"><span id="id_label_cliefcharegd"><?php echo $this->nm_new_label['cliefcharegd']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_clieactivos_line" id="hidden_field_data_clieactivos" style="<?php echo $sStyleHidden_clieactivos; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_clieactivos_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_clieactivos_label"><span id="id_label_clieactivos"><?php echo $this->nm_new_label['clieactivos']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['Lookup_clieactivos'][] = 'A'; ?>
 <option  value="I" <?php  if ($this->clieactivos == "I") { echo " selected" ;} ?>><?php echo $this->Ini->Nm_lang['lang_select_inactivo']; ?></option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo_mob']['Lookup_clieactivos'][] = 'I'; ?>
 </select></span>
</span><?php  }?>
