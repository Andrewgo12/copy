<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="cliecodigon" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['cliecodigon']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_clientes_externo"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_externo']['where_detal']))
  {
?>  
...
{
    document.getElementById('form_clientes_externo_form0').style.width='1px';
    document.getElementById('form_clientes_externo_form0').style.height='0px';
    document.getElementById('form_clientes_externo_form0').style.display='none';
    document.getElementById('form_clientes_externo_form0').style.overflow='scroll';
    document.getElementById('form_clientes_externo_form1').style.width='1px';
    document.getElementById('form_clientes_externo_form1').style.height='0px';
    document.getElementById('form_clientes_externo_form1').style.display='none';
    document.getElementById('form_clientes_externo_form1').style.overflow='scroll';
   ...
   if ("form_clientes_externo_form1" == N_pagina) {
