...
<?php
   ...
   $Ord_Cmp = new grid_tiposidentifis_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tiposidentifis_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["tiidcodigos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tiposidentifis']['labels']["tiidcodigos"])) ? $_SESSION['sc_session'][$sc_init]['grid_tiposidentifis']['labels']["tiidcodigos"] : "" . $this->Nm_lang['lang_tiposidentifis_fld_tiidcodigos'] . "";
   $tab_ger_campos['tiidnombres'] = "on";
   $tab_def_campos['tiidnombres'] = "tiidnombres";
   $tab_converte["tiidnombres"]   = "tiidnombres";
   $tab_labels["tiidnombres"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tiposidentifis']['labels']["tiidnombres"])) ? $_SESSION['sc_session'][$sc_init]['grid_tiposidentifis']['labels']["tiidnombres"] : "" . $this->Nm_lang['lang_tiposidentifis_fld_tiidnombres'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tiposidentifis']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tiposidentifis']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tiposidentifis']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tiposidentifis']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tiposidentifis']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tiposidentifis']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tiposidentifis']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tiposidentifis']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tiposidentifis']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tiposidentifis_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_tiposidentifis']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_tiposidentifis']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
