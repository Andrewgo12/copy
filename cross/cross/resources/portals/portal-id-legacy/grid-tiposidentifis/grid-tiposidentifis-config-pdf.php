 ...
 */
    ...
    $SC_apl_proc = "grid_tiposidentifis";
/* sc_apl_default */
...
$isMultiSeriesChart = $is_chart_app && (!isset($_SESSION['sc_session'][$script_case_init]['grid_tiposidentifis']['summarizing_drill_down']) || !$_SESSION['sc_session'][$script_case_init]['grid_tiposidentifis']['summarizing_drill_down']);
$isAnalitic         = isset($_SESSION['sc_session'][$script_case_init]['grid_tiposidentifis']['graf_opc_atual']) && 2 == $_SESSION['sc_session'][$script_case_init]['grid_tiposidentifis']['graf_opc_atual'];

  $sDisplay = !isset($_SESSION['sc_session']['grid_tiposidentifis']['show_skip_charts_option']) ||
             !$_SESSION['sc_session']['grid_tiposidentifis']['show_skip_charts_option'] ||
             (isset($_SESSION['sc_session'][$script_case_init]['grid_tiposidentifis']['SC_Ind_Groupby']) && '_NM_SC_' == $_SESSION['sc_session'][$script_case_init]['grid_tiposidentifis']['SC_Ind_Groupby']) ||
             $isMultiSeriesChart ||
             $isAnalitic ||
             ($opc == 'pdf_det')
             ? ' style="display: none"' : '';
...
{
 $sDisplay =
            !isset($_SESSION['sc_session']['grid_tiposidentifis']['show_skip_charts_option']) ||
            !$_SESSION['sc_session']['grid_tiposidentifis']['show_skip_charts_option'] ||
            $isMultiSeriesChart ||
            $isAnalitic ||
             ($opc == 'pdf_det')
