...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["cliecodigon"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["cliecodigon"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["cliecodigon"] : "" . $this->Nm_lang['lang_clientes_fld_cliecodigon'] . "";
   $tab_ger_campos['tiidcodigos'] = "on";
   $tab_def_campos['tiidcodigos'] = "tiidcodigos";
   $tab_converte["tiidcodigos"]   = "tiidcodigos";
   $tab_labels["tiidcodigos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["tiidcodigos"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["tiidcodigos"] : "" . $this->Nm_lang['lang_clientes_fld_tiidcodigos'] . "";
   $tab_ger_campos['clieidentifs'] = "on";
   $tab_def_campos['clieidentifs'] = "clieidentifs";
   $tab_converte["clieidentifs"]   = "clieidentifs";
   $tab_labels["clieidentifs"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["clieidentifs"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["clieidentifs"] : "" . $this->Nm_lang['lang_clientes_fld_clieidentifs'] . "";
   $tab_ger_campos['clienombres'] = "on";
   $tab_def_campos['clienombres'] = "clienombres";
   $tab_converte["clienombres"]   = "clienombres";
   $tab_labels["clienombres"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["clienombres"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["clienombres"] : "" . $this->Nm_lang['lang_clientes_fld_clienombres'] . "";
   $tab_ger_campos['paiscodigos'] = "on";
   $tab_def_campos['paiscodigos'] = "paiscodigos";
   $tab_converte["paiscodigos"]   = "paiscodigos";
   $tab_labels["paiscodigos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["paiscodigos"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["paiscodigos"] : "" . $this->Nm_lang['lang_clientes_fld_paiscodigos'] . "";
   $tab_ger_campos['cliedireccis'] = "on";
   $tab_def_campos['cliedireccis'] = "cliedireccis";
   $tab_converte["cliedireccis"]   = "cliedireccis";
   $tab_labels["cliedireccis"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["cliedireccis"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes']['labels']["cliedireccis"] : "" . $this->Nm_lang['lang_clientes_fld_cliedireccis'] . "";
