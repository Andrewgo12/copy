...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_esclfcharegd_hora' + iSeqRow).bind('blur', function() { sc_form_estadosclientes_esclfcharegd_hora_onblur(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_estadosclientes_esclfcharegd_hora_onfocus(this, iSeqRow) });
...
function sc_form_estadosclientes_esclfcharegd_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_estadosclientes_validate_esclfcharegd();
  scCssBlur(oThis);
}
...
function sc_form_estadosclientes_esclfcharegd_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_estadosclientes_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_esclfcharegd" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_estadosclientes_validate_esclfcharegd(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
