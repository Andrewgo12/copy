  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_estadosclientes" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_estadosclientes_validate_esclcodigos()
  {
    var nomeCampo_esclcodigos = "esclcodigos";
    var var_esclcodigos = scAjaxGetFieldText(nomeCampo_esclcodigos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estadosclientes_validate_esclcodigos(var_esclcodigos, var_script_case_init, do_ajax_form_estadosclientes_validate_esclcodigos_cb);
  } // do_ajax_form_estadosclientes_validate_esclcodigos

  function do_ajax_form_estadosclientes_validate_esclcodigos_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estadosclientes_validate_esclcodigos_cb

  // ---------- Validate esclnombres
  function do_ajax_form_estadosclientes_validate_esclnombres()
  {
    var nomeCampo_esclnombres = "esclnombres";
    var var_esclnombres = scAjaxGetFieldText(nomeCampo_esclnombres);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estadosclientes_validate_esclnombres(var_esclnombres, var_script_case_init, do_ajax_form_estadosclientes_validate_esclnombres_cb);
  } // do_ajax_form_estadosclientes_validate_esclnombres

  function do_ajax_form_estadosclientes_validate_esclnombres_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "esclnombres";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estadosclientes_validate_esclnombres_cb

  // ---------- Validate escldescrips
  function do_ajax_form_estadosclientes_validate_escldescrips()
  {
    var nomeCampo_escldescrips = "escldescrips";
    var var_escldescrips = scAjaxGetFieldText(nomeCampo_escldescrips);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estadosclientes_validate_escldescrips(var_escldescrips, var_script_case_init, do_ajax_form_estadosclientes_validate_escldescrips_cb);
  } // do_ajax_form_estadosclientes_validate_escldescrips

  function do_ajax_form_estadosclientes_validate_escldescrips_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "escldescrips";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estadosclientes_validate_escldescrips_cb

  // ---------- Validate esclfcharegd
  function do_ajax_form_estadosclientes_validate_esclfcharegd()
  {
    var nomeCampo_esclfcharegd = "esclfcharegd";
    var var_esclfcharegd = scAjaxGetFieldText(nomeCampo_esclfcharegd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estadosclientes_validate_esclfcharegd(var_esclfcharegd, var_script_case_init, do_ajax_form_estadosclientes_validate_esclfcharegd_cb);
  } // do_ajax_form_estadosclientes_validate_esclfcharegd

  function do_ajax_form_estadosclientes_validate_esclfcharegd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "esclfcharegd";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estadosclientes_validate_esclfcharegd_cb

  // ---------- Validate esclactivos
  function do_ajax_form_estadosclientes_validate_esclactivos()
  {
    var nomeCampo_esclactivos = "esclactivos";
    var var_esclactivos = scAjaxGetFieldSelect(nomeCampo_esclactivos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estadosclientes_validate_esclactivos(var_esclactivos, var_script_case_init, do_ajax_form_estadosclientes_validate_esclactivos_cb);
  } // do_ajax_form_estadosclientes_validate_esclactivos

  function do_ajax_form_estadosclientes_validate_esclactivos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "esclactivos";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estadosclientes_validate_esclactivos_cb
  // ---------- Form
  function do_ajax_form_estadosclientes_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_estadosclientes_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_esclcodigos = scAjaxGetFieldText("esclcodigos");
    var var_esclnombres = scAjaxGetFieldText("esclnombres");
    var var_escldescrips = scAjaxGetFieldText("escldescrips");
    var var_esclfcharegd = scAjaxGetFieldText("esclfcharegd");
    var var_esclactivos = scAjaxGetFieldSelect("esclactivos");
    ...
    scAjaxProcOn();
    x_ajax_form_estadosclientes_submit_form(var_esclcodigos, var_esclnombres, var_escldescrips, var_esclfcharegd, var_esclactivos, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_estadosclientes_submit_form_cb);
  } // do_ajax_form_estadosclientes_submit_form

  function do_ajax_form_estadosclientes_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("esclnombres");
      scAjaxHideErrorDisplay("escldescrips");
      scAjaxHideErrorDisplay("esclfcharegd");
      scAjaxHideErrorDisplay("esclactivos");
      scLigEditLookupCall();
<?php
...
?>
  ...
  } // do_ajax_form_estadosclientes_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_estadosclientes_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("esclfcharegd");
    scAjaxHideErrorDisplay("esclactivos");
    var var_esclcodigos = document.F2.esclcodigos.value;
    ...
    scAjaxProcOn();
    x_ajax_form_estadosclientes_navigate_form(var_esclcodigos, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_estadosclientes_navigate_form_cb);
  } // do_ajax_form_estadosclientes_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_estadosclientes']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_estadosclientes_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_estadosclientes_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.esclcodigos.value = scAjaxGetKeyValue("esclcodigos");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
{
?>
    do_ajax_form_estadosclientes_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_estadosclientes_navigate_form_cb
  function sc_hide_form_estadosclientes_form()
  {
  ...
  ajax_field_list[0] = "esclcodigos";
  ajax_field_list[1] = "esclnombres";
  ajax_field_list[2] = "escldescrips";
  ajax_field_list[3] = "esclfcharegd";
  ajax_field_list[4] = "esclactivos";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "esclcodigos": {"label": "<?php echo $this->Ini->Nm_lang['lang_estadosclientes_fld_esclcodigos'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "esclnombres": {"label": "<?php echo $this->Ini->Nm_lang['lang_estadosclientes_fld_esclnombres'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "escldescrips": {"label": "<?php echo $this->Ini->Nm_lang['lang_estadosclientes_fld_escldescrips'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "esclfcharegd": {"label": "<?php echo $this->Ini->Nm_lang['lang_estadosclientes_fld_esclfcharegd'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "esclactivos": {"label": "<?php echo $this->Ini->Nm_lang['lang_estadosclientes_fld_esclactivos'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "esclnombres": new Array(),
    "escldescrips": new Array(),
    "esclfcharegd": new Array(),
    "esclactivos": new Array()
  };
  ajax_field_mult["esclcodigos"][1] = "esclcodigos";
  ajax_field_mult["esclnombres"][1] = "esclnombres";
  ajax_field_mult["escldescrips"][1] = "escldescrips";
  ajax_field_mult["esclfcharegd"][1] = "esclfcharegd";
  ajax_field_mult["esclactivos"][1] = "esclactivos";

  var ajax_field_id = {
    "esclcodigos": new Array("hidden_field_label_esclcodigos", "hidden_field_data_esclcodigos"),
    "esclnombres": new Array("hidden_field_label_esclnombres", "hidden_field_data_esclnombres"),
    "escldescrips": new Array("hidden_field_label_escldescrips", "hidden_field_data_escldescrips"),
    "esclfcharegd": new Array("hidden_field_label_esclfcharegd", "hidden_field_data_esclfcharegd"),
    "esclactivos": new Array("hidden_field_label_esclactivos", "hidden_field_data_esclactivos")
  };
