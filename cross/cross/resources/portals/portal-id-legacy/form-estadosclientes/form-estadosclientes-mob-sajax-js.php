  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_estadosclientes_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_estadosclientes_mob_validate_esclcodigos()
  {
    var nomeCampo_esclcodigos = "esclcodigos";
    var var_esclcodigos = scAjaxGetFieldText(nomeCampo_esclcodigos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estadosclientes_mob_validate_esclcodigos(var_esclcodigos, var_script_case_init, do_ajax_form_estadosclientes_mob_validate_esclcodigos_cb);
  } // do_ajax_form_estadosclientes_mob_validate_esclcodigos

  function do_ajax_form_estadosclientes_mob_validate_esclcodigos_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estadosclientes_mob_validate_esclcodigos_cb

  // ---------- Validate esclnombres
  function do_ajax_form_estadosclientes_mob_validate_esclnombres()
  {
    var nomeCampo_esclnombres = "esclnombres";
    var var_esclnombres = scAjaxGetFieldText(nomeCampo_esclnombres);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estadosclientes_mob_validate_esclnombres(var_esclnombres, var_script_case_init, do_ajax_form_estadosclientes_mob_validate_esclnombres_cb);
  } // do_ajax_form_estadosclientes_mob_validate_esclnombres

  function do_ajax_form_estadosclientes_mob_validate_esclnombres_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estadosclientes_mob_validate_esclnombres_cb

  // ---------- Validate escldescrips
  function do_ajax_form_estadosclientes_mob_validate_escldescrips()
  {
    var nomeCampo_escldescrips = "escldescrips";
    var var_escldescrips = scAjaxGetFieldText(nomeCampo_escldescrips);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estadosclientes_mob_validate_escldescrips(var_escldescrips, var_script_case_init, do_ajax_form_estadosclientes_mob_validate_escldescrips_cb);
  } // do_ajax_form_estadosclientes_mob_validate_escldescrips

  function do_ajax_form_estadosclientes_mob_validate_escldescrips_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estadosclientes_mob_validate_escldescrips_cb

  // ---------- Validate esclfcharegd
  function do_ajax_form_estadosclientes_mob_validate_esclfcharegd()
  {
    var nomeCampo_esclfcharegd = "esclfcharegd";
    var var_esclfcharegd = scAjaxGetFieldText(nomeCampo_esclfcharegd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estadosclientes_mob_validate_esclfcharegd(var_esclfcharegd, var_script_case_init, do_ajax_form_estadosclientes_mob_validate_esclfcharegd_cb);
  } // do_ajax_form_estadosclientes_mob_validate_esclfcharegd

  function do_ajax_form_estadosclientes_mob_validate_esclfcharegd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estadosclientes_mob_validate_esclfcharegd_cb

  // ---------- Validate esclactivos
  function do_ajax_form_estadosclientes_mob_validate_esclactivos()
  {
    var nomeCampo_esclactivos = "esclactivos";
    var var_esclactivos = scAjaxGetFieldSelect(nomeCampo_esclactivos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estadosclientes_mob_validate_esclactivos(var_esclactivos, var_script_case_init, do_ajax_form_estadosclientes_mob_validate_esclactivos_cb);
  } // do_ajax_form_estadosclientes_mob_validate_esclactivos

  function do_ajax_form_estadosclientes_mob_validate_esclactivos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estadosclientes_mob_validate_esclactivos_cb
  // ---------- Form
  function do_ajax_form_estadosclientes_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_estadosclientes_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_estadosclientes_mob_submit_form(var_esclcodigos, var_esclnombres, var_escldescrips, var_esclfcharegd, var_esclactivos, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_estadosclientes_mob_submit_form_cb);
  } // do_ajax_form_estadosclientes_mob_submit_form

  function do_ajax_form_estadosclientes_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_estadosclientes_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_estadosclientes_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_estadosclientes_mob_navigate_form(var_esclcodigos, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_estadosclientes_mob_navigate_form_cb);
  } // do_ajax_form_estadosclientes_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_estadosclientes_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_estadosclientes_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_estadosclientes_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
...
{
?>
    do_ajax_form_estadosclientes_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_estadosclientes_mob_navigate_form_cb
  function sc_hide_form_estadosclientes_mob_form()
  {
