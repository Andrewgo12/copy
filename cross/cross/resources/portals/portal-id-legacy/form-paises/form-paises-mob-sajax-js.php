  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_paises_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_paises_mob_validate_paiscodigos()
  {
    var nomeCampo_paiscodigos = "paiscodigos";
    var var_paiscodigos = scAjaxGetFieldText(nomeCampo_paiscodigos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_paises_mob_validate_paiscodigos(var_paiscodigos, var_script_case_init, do_ajax_form_paises_mob_validate_paiscodigos_cb);
  } // do_ajax_form_paises_mob_validate_paiscodigos

  function do_ajax_form_paises_mob_validate_paiscodigos_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_paises_mob_validate_paiscodigos_cb

  // ---------- Validate paisnombres
  function do_ajax_form_paises_mob_validate_paisnombres()
  {
    var nomeCampo_paisnombres = "paisnombres";
    var var_paisnombres = scAjaxGetFieldText(nomeCampo_paisnombres);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_paises_mob_validate_paisnombres(var_paisnombres, var_script_case_init, do_ajax_form_paises_mob_validate_paisnombres_cb);
  } // do_ajax_form_paises_mob_validate_paisnombres

  function do_ajax_form_paises_mob_validate_paisnombres_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "paisnombres";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_paises_mob_validate_paisnombres_cb

  // ---------- Validate paiscodalf2s
  function do_ajax_form_paises_mob_validate_paiscodalf2s()
  {
    var nomeCampo_paiscodalf2s = "paiscodalf2s";
    var var_paiscodalf2s = scAjaxGetFieldText(nomeCampo_paiscodalf2s);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_paises_mob_validate_paiscodalf2s(var_paiscodalf2s, var_script_case_init, do_ajax_form_paises_mob_validate_paiscodalf2s_cb);
  } // do_ajax_form_paises_mob_validate_paiscodalf2s

  function do_ajax_form_paises_mob_validate_paiscodalf2s_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "paiscodalf2s";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_paises_mob_validate_paiscodalf2s_cb

  // ---------- Validate paiscoddomis
  function do_ajax_form_paises_mob_validate_paiscoddomis()
  {
    var nomeCampo_paiscoddomis = "paiscoddomis";
    var var_paiscoddomis = scAjaxGetFieldText(nomeCampo_paiscoddomis);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_paises_mob_validate_paiscoddomis(var_paiscoddomis, var_script_case_init, do_ajax_form_paises_mob_validate_paiscoddomis_cb);
  } // do_ajax_form_paises_mob_validate_paiscoddomis

  function do_ajax_form_paises_mob_validate_paiscoddomis_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "paiscoddomis";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_paises_mob_validate_paiscoddomis_cb

  // ---------- Validate paisfcharegd
  function do_ajax_form_paises_mob_validate_paisfcharegd()
  {
    var nomeCampo_paisfcharegd = "paisfcharegd";
    var var_paisfcharegd = scAjaxGetFieldText(nomeCampo_paisfcharegd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_paises_mob_validate_paisfcharegd(var_paisfcharegd, var_script_case_init, do_ajax_form_paises_mob_validate_paisfcharegd_cb);
  } // do_ajax_form_paises_mob_validate_paisfcharegd

  function do_ajax_form_paises_mob_validate_paisfcharegd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "paisfcharegd";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_paises_mob_validate_paisfcharegd_cb

  // ---------- Validate paisactivos
  function do_ajax_form_paises_mob_validate_paisactivos()
  {
    var nomeCampo_paisactivos = "paisactivos";
    var var_paisactivos = scAjaxGetFieldSelect(nomeCampo_paisactivos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_paises_mob_validate_paisactivos(var_paisactivos, var_script_case_init, do_ajax_form_paises_mob_validate_paisactivos_cb);
  } // do_ajax_form_paises_mob_validate_paisactivos

  function do_ajax_form_paises_mob_validate_paisactivos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "paisactivos";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_paises_mob_validate_paisactivos_cb
  // ---------- Form
  function do_ajax_form_paises_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_paises_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_paiscodigos = scAjaxGetFieldText("paiscodigos");
    var var_paisnombres = scAjaxGetFieldText("paisnombres");
    var var_paiscodalf2s = scAjaxGetFieldText("paiscodalf2s");
    var var_paiscoddomis = scAjaxGetFieldText("paiscoddomis");
    var var_paisfcharegd = scAjaxGetFieldText("paisfcharegd");
    var var_paisactivos = scAjaxGetFieldSelect("paisactivos");
    ...
    scAjaxProcOn();
    x_ajax_form_paises_mob_submit_form(var_paiscodigos, var_paisnombres, var_paiscodalf2s, var_paiscoddomis, var_paisfcharegd, var_paisactivos, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_paises_mob_submit_form_cb);
  } // do_ajax_form_paises_mob_submit_form

  function do_ajax_form_paises_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("paisnombres");
      scAjaxHideErrorDisplay("paiscodalf2s");
      scAjaxHideErrorDisplay("paiscoddomis");
      scAjaxHideErrorDisplay("paisfcharegd");
      scAjaxHideErrorDisplay("paisactivos");
      scLigEditLookupCall();
<?php
...
?>
  ...
  } // do_ajax_form_paises_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_paises_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("paisfcharegd");
    scAjaxHideErrorDisplay("paisactivos");
    var var_paiscodigos = document.F2.paiscodigos.value;
    ...
    scAjaxProcOn();
    x_ajax_form_paises_mob_navigate_form(var_paiscodigos, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_paises_mob_navigate_form_cb);
  } // do_ajax_form_paises_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_paises_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_paises_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_paises_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.paiscodigos.value = scAjaxGetKeyValue("paiscodigos");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
{
?>
    do_ajax_form_paises_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_paises_mob_navigate_form_cb
  function sc_hide_form_paises_mob_form()
  {
  ...
  ajax_field_list[0] = "paiscodigos";
  ajax_field_list[1] = "paisnombres";
  ajax_field_list[2] = "paiscodalf2s";
  ajax_field_list[3] = "paiscoddomis";
  ajax_field_list[4] = "paisfcharegd";
  ajax_field_list[5] = "paisactivos";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "paiscodigos": {"label": "<?php echo $this->Ini->Nm_lang['lang_paises_fld_paiscodigos'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "paisnombres": {"label": "<?php echo $this->Ini->Nm_lang['lang_paises_fld_paisnombres'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "paiscodalf2s": {"label": "<?php echo $this->Ini->Nm_lang['lang_paises_fld_paiscodalf2s'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "paiscoddomis": {"label": "<?php echo $this->Ini->Nm_lang['lang_paises_fld_paiscoddomis'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "paisfcharegd": {"label": "<?php echo $this->Ini->Nm_lang['lang_paises_fld_paisfcharegd'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "paisactivos": {"label": "<?php echo $this->Ini->Nm_lang['lang_paises_fld_paisactivos'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "paisnombres": new Array(),
    "paiscodalf2s": new Array(),
    "paiscoddomis": new Array(),
    "paisfcharegd": new Array(),
    "paisactivos": new Array()
  };
  ajax_field_mult["paiscodigos"][1] = "paiscodigos";
  ajax_field_mult["paisnombres"][1] = "paisnombres";
  ajax_field_mult["paiscodalf2s"][1] = "paiscodalf2s";
  ajax_field_mult["paiscoddomis"][1] = "paiscoddomis";
  ajax_field_mult["paisfcharegd"][1] = "paisfcharegd";
  ajax_field_mult["paisactivos"][1] = "paisactivos";

  var ajax_field_id = {
    "paiscodigos": new Array("hidden_field_label_paiscodigos", "hidden_field_data_paiscodigos"),
    "paisnombres": new Array("hidden_field_label_paisnombres", "hidden_field_data_paisnombres"),
    "paiscodalf2s": new Array("hidden_field_label_paiscodalf2s", "hidden_field_data_paiscodalf2s"),
    "paiscoddomis": new Array("hidden_field_label_paiscoddomis", "hidden_field_data_paiscoddomis"),
    "paisfcharegd": new Array("hidden_field_label_paisfcharegd", "hidden_field_data_paisfcharegd"),
    "paisactivos": new Array("hidden_field_label_paisactivos", "hidden_field_data_paisactivos")
  };
