  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_paises" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_paises_validate_paiscodigos()
  {
    var nomeCampo_paiscodigos = "paiscodigos";
    var var_paiscodigos = scAjaxGetFieldText(nomeCampo_paiscodigos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_paises_validate_paiscodigos(var_paiscodigos, var_script_case_init, do_ajax_form_paises_validate_paiscodigos_cb);
  } // do_ajax_form_paises_validate_paiscodigos

  function do_ajax_form_paises_validate_paiscodigos_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_paises_validate_paiscodigos_cb

  // ---------- Validate paisnombres
  function do_ajax_form_paises_validate_paisnombres()
  {
    var nomeCampo_paisnombres = "paisnombres";
    var var_paisnombres = scAjaxGetFieldText(nomeCampo_paisnombres);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_paises_validate_paisnombres(var_paisnombres, var_script_case_init, do_ajax_form_paises_validate_paisnombres_cb);
  } // do_ajax_form_paises_validate_paisnombres

  function do_ajax_form_paises_validate_paisnombres_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_paises_validate_paisnombres_cb

  // ---------- Validate paiscodalf2s
  function do_ajax_form_paises_validate_paiscodalf2s()
  {
    var nomeCampo_paiscodalf2s = "paiscodalf2s";
    var var_paiscodalf2s = scAjaxGetFieldText(nomeCampo_paiscodalf2s);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_paises_validate_paiscodalf2s(var_paiscodalf2s, var_script_case_init, do_ajax_form_paises_validate_paiscodalf2s_cb);
  } // do_ajax_form_paises_validate_paiscodalf2s

  function do_ajax_form_paises_validate_paiscodalf2s_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_paises_validate_paiscodalf2s_cb

  // ---------- Validate paiscoddomis
  function do_ajax_form_paises_validate_paiscoddomis()
  {
    var nomeCampo_paiscoddomis = "paiscoddomis";
    var var_paiscoddomis = scAjaxGetFieldText(nomeCampo_paiscoddomis);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_paises_validate_paiscoddomis(var_paiscoddomis, var_script_case_init, do_ajax_form_paises_validate_paiscoddomis_cb);
  } // do_ajax_form_paises_validate_paiscoddomis

  function do_ajax_form_paises_validate_paiscoddomis_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_paises_validate_paiscoddomis_cb

  // ---------- Validate paisfcharegd
  function do_ajax_form_paises_validate_paisfcharegd()
  {
    var nomeCampo_paisfcharegd = "paisfcharegd";
    var var_paisfcharegd = scAjaxGetFieldText(nomeCampo_paisfcharegd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_paises_validate_paisfcharegd(var_paisfcharegd, var_script_case_init, do_ajax_form_paises_validate_paisfcharegd_cb);
  } // do_ajax_form_paises_validate_paisfcharegd

  function do_ajax_form_paises_validate_paisfcharegd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_paises_validate_paisfcharegd_cb

  // ---------- Validate paisactivos
  function do_ajax_form_paises_validate_paisactivos()
  {
    var nomeCampo_paisactivos = "paisactivos";
    var var_paisactivos = scAjaxGetFieldSelect(nomeCampo_paisactivos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_paises_validate_paisactivos(var_paisactivos, var_script_case_init, do_ajax_form_paises_validate_paisactivos_cb);
  } // do_ajax_form_paises_validate_paisactivos

  function do_ajax_form_paises_validate_paisactivos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_paises_validate_paisactivos_cb
  // ---------- Form
  function do_ajax_form_paises_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_paises_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_paises_submit_form(var_paiscodigos, var_paisnombres, var_paiscodalf2s, var_paiscoddomis, var_paisfcharegd, var_paisactivos, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_paises_submit_form_cb);
  } // do_ajax_form_paises_submit_form

  function do_ajax_form_paises_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_paises_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_paises_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_paises_navigate_form(var_paiscodigos, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_paises_navigate_form_cb);
  } // do_ajax_form_paises_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_paises']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_paises_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
...
{
?>
    do_ajax_form_paises_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_paises_navigate_form_cb
  function sc_hide_form_paises_form()
  {
