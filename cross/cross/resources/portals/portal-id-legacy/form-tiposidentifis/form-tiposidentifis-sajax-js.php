  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tiposidentifis" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_tiposidentifis_validate_tiidcodigos()
  {
    var nomeCampo_tiidcodigos = "tiidcodigos";
    var var_tiidcodigos = scAjaxGetFieldText(nomeCampo_tiidcodigos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tiposidentifis_validate_tiidcodigos(var_tiidcodigos, var_script_case_init, do_ajax_form_tiposidentifis_validate_tiidcodigos_cb);
  } // do_ajax_form_tiposidentifis_validate_tiidcodigos

  function do_ajax_form_tiposidentifis_validate_tiidcodigos_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tiposidentifis_validate_tiidcodigos_cb

  // ---------- Validate tiidnombres
  function do_ajax_form_tiposidentifis_validate_tiidnombres()
  {
    var nomeCampo_tiidnombres = "tiidnombres";
    var var_tiidnombres = scAjaxGetFieldText(nomeCampo_tiidnombres);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tiposidentifis_validate_tiidnombres(var_tiidnombres, var_script_case_init, do_ajax_form_tiposidentifis_validate_tiidnombres_cb);
  } // do_ajax_form_tiposidentifis_validate_tiidnombres

  function do_ajax_form_tiposidentifis_validate_tiidnombres_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tiposidentifis_validate_tiidnombres_cb

  // ---------- Validate tiidfcharegd
  function do_ajax_form_tiposidentifis_validate_tiidfcharegd()
  {
    var nomeCampo_tiidfcharegd = "tiidfcharegd";
    var var_tiidfcharegd = scAjaxGetFieldText(nomeCampo_tiidfcharegd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tiposidentifis_validate_tiidfcharegd(var_tiidfcharegd, var_script_case_init, do_ajax_form_tiposidentifis_validate_tiidfcharegd_cb);
  } // do_ajax_form_tiposidentifis_validate_tiidfcharegd

  function do_ajax_form_tiposidentifis_validate_tiidfcharegd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tiposidentifis_validate_tiidfcharegd_cb

  // ---------- Validate tiidactivos
  function do_ajax_form_tiposidentifis_validate_tiidactivos()
  {
    var nomeCampo_tiidactivos = "tiidactivos";
    var var_tiidactivos = scAjaxGetFieldSelect(nomeCampo_tiidactivos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tiposidentifis_validate_tiidactivos(var_tiidactivos, var_script_case_init, do_ajax_form_tiposidentifis_validate_tiidactivos_cb);
  } // do_ajax_form_tiposidentifis_validate_tiidactivos

  function do_ajax_form_tiposidentifis_validate_tiidactivos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tiposidentifis_validate_tiidactivos_cb
  // ---------- Form
  function do_ajax_form_tiposidentifis_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tiposidentifis_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tiposidentifis_submit_form(var_tiidcodigos, var_tiidnombres, var_tiidfcharegd, var_tiidactivos, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tiposidentifis_submit_form_cb);
  } // do_ajax_form_tiposidentifis_submit_form

  function do_ajax_form_tiposidentifis_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_tiposidentifis_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_tiposidentifis_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tiposidentifis_navigate_form(var_tiidcodigos, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tiposidentifis_navigate_form_cb);
  } // do_ajax_form_tiposidentifis_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tiposidentifis']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tiposidentifis_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_tiposidentifis_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
...
{
?>
    do_ajax_form_tiposidentifis_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tiposidentifis_navigate_form_cb
  function sc_hide_form_tiposidentifis_form()
  {
