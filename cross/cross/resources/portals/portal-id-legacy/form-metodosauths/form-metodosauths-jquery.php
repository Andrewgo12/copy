...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_meaufecregd_hora' + iSeqRow).bind('blur', function() { sc_form_metodosauths_meaufecregd_hora_onblur(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_metodosauths_meaufecregd_hora_onfocus(this, iSeqRow) });
...
function sc_form_metodosauths_meaufecregd_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_metodosauths_validate_meaufecregd();
  scCssBlur(oThis);
}
...
function sc_form_metodosauths_meaufecregd_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_metodosauths_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_meaufecregd" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_metodosauths_validate_meaufecregd(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
