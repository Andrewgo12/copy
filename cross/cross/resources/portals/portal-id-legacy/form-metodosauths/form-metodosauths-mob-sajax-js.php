  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_metodosauths_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_metodosauths_mob_validate_meaucodigon()
  {
    var nomeCampo_meaucodigon = "meaucodigon";
    var var_meaucodigon = scAjaxGetFieldText(nomeCampo_meaucodigon);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_metodosauths_mob_validate_meaucodigon(var_meaucodigon, var_script_case_init, do_ajax_form_metodosauths_mob_validate_meaucodigon_cb);
  } // do_ajax_form_metodosauths_mob_validate_meaucodigon

  function do_ajax_form_metodosauths_mob_validate_meaucodigon_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_metodosauths_mob_validate_meaucodigon_cb

  // ---------- Validate meaunombres
  function do_ajax_form_metodosauths_mob_validate_meaunombres()
  {
    var nomeCampo_meaunombres = "meaunombres";
    var var_meaunombres = scAjaxGetFieldText(nomeCampo_meaunombres);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_metodosauths_mob_validate_meaunombres(var_meaunombres, var_script_case_init, do_ajax_form_metodosauths_mob_validate_meaunombres_cb);
  } // do_ajax_form_metodosauths_mob_validate_meaunombres

  function do_ajax_form_metodosauths_mob_validate_meaunombres_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_metodosauths_mob_validate_meaunombres_cb

  // ---------- Validate meaudescrips
  function do_ajax_form_metodosauths_mob_validate_meaudescrips()
  {
    var nomeCampo_meaudescrips = "meaudescrips";
    var var_meaudescrips = scAjaxGetFieldText(nomeCampo_meaudescrips);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_metodosauths_mob_validate_meaudescrips(var_meaudescrips, var_script_case_init, do_ajax_form_metodosauths_mob_validate_meaudescrips_cb);
  } // do_ajax_form_metodosauths_mob_validate_meaudescrips

  function do_ajax_form_metodosauths_mob_validate_meaudescrips_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_metodosauths_mob_validate_meaudescrips_cb

  // ---------- Validate usuacodigos
  function do_ajax_form_metodosauths_mob_validate_usuacodigos()
  {
    var nomeCampo_usuacodigos = "usuacodigos";
    var var_usuacodigos = scAjaxGetFieldText(nomeCampo_usuacodigos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_metodosauths_mob_validate_usuacodigos(var_usuacodigos, var_script_case_init, do_ajax_form_metodosauths_mob_validate_usuacodigos_cb);
  } // do_ajax_form_metodosauths_mob_validate_usuacodigos

  function do_ajax_form_metodosauths_mob_validate_usuacodigos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_metodosauths_mob_validate_usuacodigos_cb

  // ---------- Validate meaufecregd
  function do_ajax_form_metodosauths_mob_validate_meaufecregd()
  {
    var nomeCampo_meaufecregd = "meaufecregd";
    var var_meaufecregd = scAjaxGetFieldText(nomeCampo_meaufecregd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_metodosauths_mob_validate_meaufecregd(var_meaufecregd, var_script_case_init, do_ajax_form_metodosauths_mob_validate_meaufecregd_cb);
  } // do_ajax_form_metodosauths_mob_validate_meaufecregd

  function do_ajax_form_metodosauths_mob_validate_meaufecregd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_metodosauths_mob_validate_meaufecregd_cb

  // ---------- Validate meauestados
  function do_ajax_form_metodosauths_mob_validate_meauestados()
  {
    var nomeCampo_meauestados = "meauestados";
    var var_meauestados = scAjaxGetFieldText(nomeCampo_meauestados);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_metodosauths_mob_validate_meauestados(var_meauestados, var_script_case_init, do_ajax_form_metodosauths_mob_validate_meauestados_cb);
  } // do_ajax_form_metodosauths_mob_validate_meauestados

  function do_ajax_form_metodosauths_mob_validate_meauestados_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_metodosauths_mob_validate_meauestados_cb
  // ---------- Form
  function do_ajax_form_metodosauths_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_metodosauths_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_metodosauths_mob_submit_form(var_meaucodigon, var_meaunombres, var_meaudescrips, var_usuacodigos, var_meaufecregd, var_meauestados, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_metodosauths_mob_submit_form_cb);
  } // do_ajax_form_metodosauths_mob_submit_form

  function do_ajax_form_metodosauths_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_metodosauths_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_metodosauths_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_metodosauths_mob_navigate_form(var_meaucodigon, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_metodosauths_mob_navigate_form_cb);
  } // do_ajax_form_metodosauths_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_metodosauths_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_metodosauths_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_metodosauths_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
...
{
?>
    do_ajax_form_metodosauths_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_metodosauths_mob_navigate_form_cb
  function sc_hide_form_metodosauths_mob_form()
  {
