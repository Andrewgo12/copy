  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_metodosauths" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_metodosauths_validate_meaucodigon()
  {
    var nomeCampo_meaucodigon = "meaucodigon";
    var var_meaucodigon = scAjaxGetFieldText(nomeCampo_meaucodigon);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_metodosauths_validate_meaucodigon(var_meaucodigon, var_script_case_init, do_ajax_form_metodosauths_validate_meaucodigon_cb);
  } // do_ajax_form_metodosauths_validate_meaucodigon

  function do_ajax_form_metodosauths_validate_meaucodigon_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_metodosauths_validate_meaucodigon_cb

  // ---------- Validate meaunombres
  function do_ajax_form_metodosauths_validate_meaunombres()
  {
    var nomeCampo_meaunombres = "meaunombres";
    var var_meaunombres = scAjaxGetFieldText(nomeCampo_meaunombres);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_metodosauths_validate_meaunombres(var_meaunombres, var_script_case_init, do_ajax_form_metodosauths_validate_meaunombres_cb);
  } // do_ajax_form_metodosauths_validate_meaunombres

  function do_ajax_form_metodosauths_validate_meaunombres_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "meaunombres";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_metodosauths_validate_meaunombres_cb

  // ---------- Validate meaudescrips
  function do_ajax_form_metodosauths_validate_meaudescrips()
  {
    var nomeCampo_meaudescrips = "meaudescrips";
    var var_meaudescrips = scAjaxGetFieldText(nomeCampo_meaudescrips);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_metodosauths_validate_meaudescrips(var_meaudescrips, var_script_case_init, do_ajax_form_metodosauths_validate_meaudescrips_cb);
  } // do_ajax_form_metodosauths_validate_meaudescrips

  function do_ajax_form_metodosauths_validate_meaudescrips_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "meaudescrips";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_metodosauths_validate_meaudescrips_cb

  // ---------- Validate usuacodigos
  function do_ajax_form_metodosauths_validate_usuacodigos()
  {
    var nomeCampo_usuacodigos = "usuacodigos";
    var var_usuacodigos = scAjaxGetFieldText(nomeCampo_usuacodigos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_metodosauths_validate_usuacodigos(var_usuacodigos, var_script_case_init, do_ajax_form_metodosauths_validate_usuacodigos_cb);
  } // do_ajax_form_metodosauths_validate_usuacodigos

  function do_ajax_form_metodosauths_validate_usuacodigos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_metodosauths_validate_usuacodigos_cb

  // ---------- Validate meaufecregd
  function do_ajax_form_metodosauths_validate_meaufecregd()
  {
    var nomeCampo_meaufecregd = "meaufecregd";
    var var_meaufecregd = scAjaxGetFieldText(nomeCampo_meaufecregd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_metodosauths_validate_meaufecregd(var_meaufecregd, var_script_case_init, do_ajax_form_metodosauths_validate_meaufecregd_cb);
  } // do_ajax_form_metodosauths_validate_meaufecregd

  function do_ajax_form_metodosauths_validate_meaufecregd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "meaufecregd";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_metodosauths_validate_meaufecregd_cb

  // ---------- Validate meauestados
  function do_ajax_form_metodosauths_validate_meauestados()
  {
    var nomeCampo_meauestados = "meauestados";
    var var_meauestados = scAjaxGetFieldText(nomeCampo_meauestados);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_metodosauths_validate_meauestados(var_meauestados, var_script_case_init, do_ajax_form_metodosauths_validate_meauestados_cb);
  } // do_ajax_form_metodosauths_validate_meauestados

  function do_ajax_form_metodosauths_validate_meauestados_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "meauestados";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_metodosauths_validate_meauestados_cb
  // ---------- Form
  function do_ajax_form_metodosauths_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_metodosauths_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_meaucodigon = scAjaxGetFieldText("meaucodigon");
    var var_meaunombres = scAjaxGetFieldText("meaunombres");
    var var_meaudescrips = scAjaxGetFieldText("meaudescrips");
    var var_usuacodigos = scAjaxGetFieldText("usuacodigos");
    var var_meaufecregd = scAjaxGetFieldText("meaufecregd");
    var var_meauestados = scAjaxGetFieldText("meauestados");
    ...
    scAjaxProcOn();
    x_ajax_form_metodosauths_submit_form(var_meaucodigon, var_meaunombres, var_meaudescrips, var_usuacodigos, var_meaufecregd, var_meauestados, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_metodosauths_submit_form_cb);
  } // do_ajax_form_metodosauths_submit_form

  function do_ajax_form_metodosauths_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("meaunombres");
      scAjaxHideErrorDisplay("meaudescrips");
      scAjaxHideErrorDisplay("usuacodigos");
      scAjaxHideErrorDisplay("meaufecregd");
      scAjaxHideErrorDisplay("meauestados");
      scLigEditLookupCall();
<?php
...
?>
  ...
  } // do_ajax_form_metodosauths_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_metodosauths_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("meaufecregd");
    scAjaxHideErrorDisplay("meauestados");
    var var_meaucodigon = document.F2.meaucodigon.value;
    ...
    scAjaxProcOn();
    x_ajax_form_metodosauths_navigate_form(var_meaucodigon, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_metodosauths_navigate_form_cb);
  } // do_ajax_form_metodosauths_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_metodosauths']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_metodosauths_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_metodosauths_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.meaucodigon.value = scAjaxGetKeyValue("meaucodigon");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
{
?>
    do_ajax_form_metodosauths_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_metodosauths_navigate_form_cb
  function sc_hide_form_metodosauths_form()
  {
  ...
  ajax_field_list[0] = "meaucodigon";
  ajax_field_list[1] = "meaunombres";
  ajax_field_list[2] = "meaudescrips";
  ajax_field_list[3] = "usuacodigos";
  ajax_field_list[4] = "meaufecregd";
  ajax_field_list[5] = "meauestados";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "meaucodigon": {"label": "<?php echo $this->Ini->Nm_lang['lang_metodosauths_fld_meaucodigon'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "meaunombres": {"label": "<?php echo $this->Ini->Nm_lang['lang_metodosauths_fld_meaunombres'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "meaudescrips": {"label": "<?php echo $this->Ini->Nm_lang['lang_metodosauths_fld_meaudescrips'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "usuacodigos": {"label": "<?php echo $this->Ini->Nm_lang['lang_metodosauths_fld_usuacodigos'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "meaufecregd": {"label": "<?php echo $this->Ini->Nm_lang['lang_metodosauths_fld_meaufecregd'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "meauestados": {"label": "<?php echo $this->Ini->Nm_lang['lang_metodosauths_fld_meauestados'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "meaunombres": new Array(),
    "meaudescrips": new Array(),
    "usuacodigos": new Array(),
    "meaufecregd": new Array(),
    "meauestados": new Array()
  };
  ajax_field_mult["meaucodigon"][1] = "meaucodigon";
  ajax_field_mult["meaunombres"][1] = "meaunombres";
  ajax_field_mult["meaudescrips"][1] = "meaudescrips";
  ajax_field_mult["usuacodigos"][1] = "usuacodigos";
  ajax_field_mult["meaufecregd"][1] = "meaufecregd";
  ajax_field_mult["meauestados"][1] = "meauestados";

  var ajax_field_id = {
    "meaucodigon": new Array("hidden_field_label_meaucodigon", "hidden_field_data_meaucodigon"),
    "meaunombres": new Array("hidden_field_label_meaunombres", "hidden_field_data_meaunombres"),
    "meaudescrips": new Array("hidden_field_label_meaudescrips", "hidden_field_data_meaudescrips"),
    "usuacodigos": new Array("hidden_field_label_usuacodigos", "hidden_field_data_usuacodigos"),
    "meaufecregd": new Array("hidden_field_label_meaufecregd", "hidden_field_data_meaufecregd"),
    "meauestados": new Array("hidden_field_label_meauestados", "hidden_field_data_meauestados")
  };
