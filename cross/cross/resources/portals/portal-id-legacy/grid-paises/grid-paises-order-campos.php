...
<?php
   ...
   $Ord_Cmp = new grid_paises_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_paises_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["paiscodigos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_paises']['labels']["paiscodigos"])) ? $_SESSION['sc_session'][$sc_init]['grid_paises']['labels']["paiscodigos"] : "" . $this->Nm_lang['lang_paises_fld_paiscodigos'] . "";
   $tab_ger_campos['paisnombres'] = "on";
   $tab_def_campos['paisnombres'] = "paisnombres";
   $tab_converte["paisnombres"]   = "paisnombres";
   $tab_labels["paisnombres"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_paises']['labels']["paisnombres"])) ? $_SESSION['sc_session'][$sc_init]['grid_paises']['labels']["paisnombres"] : "" . $this->Nm_lang['lang_paises_fld_paisnombres'] . "";
   $tab_ger_campos['paiscodalf2s'] = "on";
   $tab_def_campos['paiscodalf2s'] = "paiscodalf2s";
   $tab_converte["paiscodalf2s"]   = "paiscodalf2s";
   $tab_labels["paiscodalf2s"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_paises']['labels']["paiscodalf2s"])) ? $_SESSION['sc_session'][$sc_init]['grid_paises']['labels']["paiscodalf2s"] : "" . $this->Nm_lang['lang_paises_fld_paiscodalf2s'] . "";
   $tab_ger_campos['paiscoddomis'] = "on";
   $tab_def_campos['paiscoddomis'] = "paiscoddomis";
   $tab_converte["paiscoddomis"]   = "paiscoddomis";
   $tab_labels["paiscoddomis"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_paises']['labels']["paiscoddomis"])) ? $_SESSION['sc_session'][$sc_init]['grid_paises']['labels']["paiscoddomis"] : "" . $this->Nm_lang['lang_paises_fld_paiscoddomis'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_paises']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_paises']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_paises']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_paises']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_paises']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_paises']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_paises']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_paises']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_paises']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> <?php echo $this->Nm_lang['lang_tbl_paises'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_paises_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_paises']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_paises']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
