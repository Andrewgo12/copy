...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Portal_ID_____grid_paises"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Portal_ID_____grid_paises"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_paises'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_paises']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_paises']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_paises']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_paises']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_paises']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_paises']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_paises']['embutida_filho'] as $ind => $sc_init)
          {
