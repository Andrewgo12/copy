...
<?php
   ...
   $Ord_Cmp = new grid_aplicaciones_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_aplicaciones_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["aplicodigon"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aplicaciones']['labels']["aplicodigon"])) ? $_SESSION['sc_session'][$sc_init]['grid_aplicaciones']['labels']["aplicodigon"] : "" . $this->Nm_lang['lang_aplicaciones_fld_aplicodigon'] . "";
   $tab_ger_campos['aplinombres'] = "on";
   $tab_def_campos['aplinombres'] = "aplinombres";
   $tab_converte["aplinombres"]   = "aplinombres";
   $tab_labels["aplinombres"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aplicaciones']['labels']["aplinombres"])) ? $_SESSION['sc_session'][$sc_init]['grid_aplicaciones']['labels']["aplinombres"] : "" . $this->Nm_lang['lang_aplicaciones_fld_aplinombres'] . "";
   $tab_ger_campos['aplidescrips'] = "on";
   $tab_def_campos['aplidescrips'] = "aplidescrips";
   $tab_converte["aplidescrips"]   = "aplidescrips";
   $tab_labels["aplidescrips"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aplicaciones']['labels']["aplidescrips"])) ? $_SESSION['sc_session'][$sc_init]['grid_aplicaciones']['labels']["aplidescrips"] : "" . $this->Nm_lang['lang_aplicaciones_fld_aplidescrips'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_aplicaciones']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_aplicaciones']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_aplicaciones']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_aplicaciones']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_aplicaciones']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_aplicaciones']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_aplicaciones']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_aplicaciones']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_aplicaciones']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_aplicaciones_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_aplicaciones']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_aplicaciones']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
