<?php
include_once('menu_portal-id_session.php');
session_start();
...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['menu_portal-id']['glo_nm_path_prod']      = "";
    $_SESSION['scriptcase']['menu_portal-id']['glo_nm_perfil']         = "";
    $_SESSION['scriptcase']['menu_portal-id']['glo_nm_path_imag_temp'] = "";
    $_SESSION['scriptcase']['menu_portal-id']['glo_nm_usa_grupo']      = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['menu_portal-id']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['menu_portal-id']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['menu_portal-id']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['menu_portal-id']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //end check publication with the prod

ob_start();

class menu_portal_id_class
{
  var $Db;
 ...
 function menu_portal_id_menu()
 {
    global $menu_portal_id_menuData, $nm_data_fixa;
     ...
     { 
         $_SESSION['scriptcase']['str_schema_all'] = $_POST["nmgp_schema"] . "/" . $_POST["nmgp_schema"];
           ...
           $nm_versao_sc  = "" ; 
           $_SESSION['scriptcase']['menu_portal-id']['contr_erro'] = 'off';
           $Campos_Mens_erro = "";
...
$path_libs      = $str_root . $_SESSION['scriptcase']['menu_portal-id']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['menu_portal-id']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['menu_portal-id']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "menu_portal-id/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['menu_portal-id']['glo_nm_path_imag_temp'];
...
$this->sc_Include($path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
 if(function_exists('set_php_timezone')) set_php_timezone('menu_portal-id');
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/menu_portal-id_erro.php");
}
include_once(dirname(__FILE__) . "/menu_portal-id_erro.class.php"); 
$this->Erro = new menu_portal_id_erro();
$str_path = substr($_SESSION['scriptcase']['menu_portal-id']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['menu_portal-id']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['menu_portal-id']['glo_nm_conexao']);
}

/* Definiciones de las rutas */
$menu_portal_id_menuData         = array();
$menu_portal_id_menuData['path'] = array();
$menu_portal_id_menuData['url']  = array();
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $menu_portal_id_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $menu_portal_id_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $menu_portal_id_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $menu_portal_id_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$menu_portal_id_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$menu_portal_id_menuData['url']['web']   = str_replace("\\", '/', $menu_portal_id_menuData['url']['web']);
$menu_portal_id_menuData['path']['root'] = substr($menu_portal_id_menuData['path']['sys'],  0, -1 * strlen($menu_portal_id_menuData['url']['web']));
$menu_portal_id_menuData['path']['app']  = substr($menu_portal_id_menuData['path']['sys'],  0, strrpos($menu_portal_id_menuData['path']['sys'],  '/'));
$menu_portal_id_menuData['path']['link'] = substr($menu_portal_id_menuData['path']['app'],  0, strrpos($menu_portal_id_menuData['path']['app'],  '/'));
$menu_portal_id_menuData['path']['link'] = substr($menu_portal_id_menuData['path']['link'], 0, strrpos($menu_portal_id_menuData['path']['link'], '/')) . '/';
$menu_portal_id_menuData['path']['app'] .= '/';
$menu_portal_id_menuData['url']['app']   = substr($menu_portal_id_menuData['url']['web'],  0, strrpos($menu_portal_id_menuData['url']['web'],  '/'));
$menu_portal_id_menuData['url']['link']  = substr($menu_portal_id_menuData['url']['app'],  0, strrpos($menu_portal_id_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['menu_portal-id']['glo_nm_usa_grupo'] == "S")
{
    $menu_portal_id_menuData['url']['link']  = substr($menu_portal_id_menuData['url']['link'], 0, strrpos($menu_portal_id_menuData['url']['link'], '/'));
}
$menu_portal_id_menuData['url']['link']  .= '/';
$menu_portal_id_menuData['url']['app']   .= '/';
...
if (isset($_SESSION['scriptcase']['menu_portal-id']['session_timeout']['lang'])) {
    $this->str_lang = $_SESSION['scriptcase']['menu_portal-id']['session_timeout']['lang'];
}
elseif (!isset($_SESSION['scriptcase']['menu_portal-id']['actual_lang']) || $_SESSION['scriptcase']['menu_portal-id']['actual_lang'] != $this->str_lang) {
    $_SESSION['scriptcase']['menu_portal-id']['actual_lang'] = $this->str_lang;
...
include_once("menu_portal-id_toolbar.php");

$this->tab_grupo[0] = "Portal_ID/";
if ($_SESSION['scriptcase']['menu_portal-id']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
}

     $_SESSION['scriptcase']['menu_atual'] = "menu_portal-id";
     $_SESSION['scriptcase']['menu_apls']['menu_portal-id'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['menu_portal-id']['glo_nm_conexao']) && $_SESSION['scriptcase']['menu_portal-id']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menu_portal-id']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menu_portal-id']['glo_nm_perfil']) && $_SESSION['scriptcase']['menu_portal-id']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menu_portal-id']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menu_portal-id']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['menu_portal-id']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
if (isset($_SESSION['scriptcase']['menu_portal-id']['session_timeout']['redir'])) {
...
';
    ...
    if ($_SESSION['scriptcase']['menu_portal-id']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "  </HEAD>\r\n";
        $SS_cod_html .= "   <body>\r\n";
    }
    else {
        ...
        $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['menu_portal-id']['session_timeout']['redir'] . "');\">\r\n";
        $SS_cod_html .= "     </form>\r\n";
    ...
    if ($_SESSION['scriptcase']['menu_portal-id']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['menu_portal-id']['session_timeout']['redir'] . "');\r\n";
    }
    ...
    $SS_cod_html .= " </body>\r\n";
    $SS_cod_html .= "</HTML>\r\n";
    unset($_SESSION['scriptcase']['menu_portal-id']['session_timeout']);
...
{
    $_SESSION['sc_session'][1]['menu_portal-id']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['menu_portal-id']['init']))
{
    $_SESSION['sc_session'][1]['menu_portal-id']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['menu_portal-id']['init'];
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['menu_portal-id']['session_timeout']['redir']))
{
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_menu_portal-id'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_menu_portal-id'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_menu_portal-id'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
$this->sc_Include($path_libs . "/nm_ini_lib.php", "F", "nm_dir_normaliza") ; 
/* Dados do menu em sessao */
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['menu_portal-id']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['menu_portal-id']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'menu_portal-id'))
{
    $_SESSION['sc_session'][1]['menu_portal-id']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_menu_portal-id'] = "javascript:window.close()";
}
/* Menú de configuración de las variables */
$menu_portal_id_menuData['iframe'] = TRUE;

if (!isset($_SESSION['scriptcase']['sc_apl_seg']))
{
    $_SESSION['scriptcase']['sc_apl_seg'] = array();
}
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_aplicaciones") . "/grid_aplicaciones_ini.txt");
...
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_aplicaciones']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_aplicaciones'] = "on";
    }
}
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_metodosauths") . "/grid_metodosauths_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_metodosauths']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_metodosauths'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_paises") . "/grid_paises_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_paises']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_paises'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_tiposclientes") . "/grid_tiposclientes_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tiposclientes']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_tiposclientes'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_tiposidentifis") . "/grid_tiposidentifis_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tiposidentifis']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_tiposidentifis'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_estadosclientes") . "/grid_estadosclientes_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_estadosclientes']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_estadosclientes'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_onegatelogs") . "/grid_onegatelogs_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_onegatelogs']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_onegatelogs'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[2]))
{
 ...
 $nm_var_lab[3] = "Métodos de autenticación";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[5]))
{
 ...
 $nm_var_lab[6] = "Tipos de identificación";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[7]))
{
 ...
 $nm_var_lab[8] = "Estados de los clientes";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[8]))
{
 ...
 $nm_var_lab[9] = "Registrar cliente";
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_menu_portal-id'];
$menu_portal_id_menuData['data'] .= "item_1|.|" . $nm_var_lab[0] . "||" . $nm_var_hint[0] . "||_self|\n";
$menu_portal_id_menuData['data'] .= "item_7|.|" . $nm_var_lab[1] . "||" . $nm_var_hint[1] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_aplicaciones']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_aplicaciones']) == "on")
{
    $menu_portal_id_menuData['data'] .= "item_14|..|" . $nm_var_lab[2] . "|menu_portal-id_form_php.php?sc_item_menu=item_14&sc_apl_menu=grid_aplicaciones&sc_apl_link=" . urlencode($menu_portal_id_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_portal-id']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[2] . "||" . $this->menu_portal_id_target('_self') . "|" . "\n";
}
else
{
    $menu_portal_id_menuData['data'] .= "item_14|..|" . $nm_var_lab[2] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_metodosauths']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_metodosauths']) == "on")
{
    $menu_portal_id_menuData['data'] .= "item_11|..|" . $nm_var_lab[3] . "|menu_portal-id_form_php.php?sc_item_menu=item_11&sc_apl_menu=grid_metodosauths&sc_apl_link=" . urlencode($menu_portal_id_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_portal-id']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[3] . "||" . $this->menu_portal_id_target('_self') . "|" . "\n";
}
else
{
    $menu_portal_id_menuData['data'] .= "item_11|..|" . $nm_var_lab[3] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_paises']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_paises']) == "on")
{
    $menu_portal_id_menuData['data'] .= "item_10|..|" . $nm_var_lab[4] . "|menu_portal-id_form_php.php?sc_item_menu=item_10&sc_apl_menu=grid_paises&sc_apl_link=" . urlencode($menu_portal_id_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_portal-id']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[4] . "||" . $this->menu_portal_id_target('_self') . "|" . "\n";
}
else
{
    $menu_portal_id_menuData['data'] .= "item_10|..|" . $nm_var_lab[4] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tiposclientes']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tiposclientes']) == "on")
{
    $menu_portal_id_menuData['data'] .= "item_9|..|" . $nm_var_lab[5] . "|menu_portal-id_form_php.php?sc_item_menu=item_9&sc_apl_menu=grid_tiposclientes&sc_apl_link=" . urlencode($menu_portal_id_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_portal-id']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[5] . "||" . $this->menu_portal_id_target('_self') . "|" . "\n";
}
else
{
    $menu_portal_id_menuData['data'] .= "item_9|..|" . $nm_var_lab[5] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tiposidentifis']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tiposidentifis']) == "on")
{
    $menu_portal_id_menuData['data'] .= "item_8|..|" . $nm_var_lab[6] . "|menu_portal-id_form_php.php?sc_item_menu=item_8&sc_apl_menu=grid_tiposidentifis&sc_apl_link=" . urlencode($menu_portal_id_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_portal-id']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[6] . "||" . $this->menu_portal_id_target('_self') . "|" . "\n";
}
else
{
    $menu_portal_id_menuData['data'] .= "item_8|..|" . $nm_var_lab[6] . "||||_self|disabled\n";
}
$menu_portal_id_menuData['data'] .= "item_2|.|" . $nm_var_lab[7] . "||" . $nm_var_hint[7] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_estadosclientes']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_estadosclientes']) == "on")
{
    $menu_portal_id_menuData['data'] .= "item_12|..|" . $nm_var_lab[8] . "|menu_portal-id_form_php.php?sc_item_menu=item_12&sc_apl_menu=grid_estadosclientes&sc_apl_link=" . urlencode($menu_portal_id_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_portal-id']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[8] . "||" . $this->menu_portal_id_target('_self') . "|" . "\n";
}
else
{
    $menu_portal_id_menuData['data'] .= "item_12|..|" . $nm_var_lab[8] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_clientes']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_clientes']) == "on")
{
    $menu_portal_id_menuData['data'] .= "item_6|..|" . $nm_var_lab[9] . "|menu_portal-id_form_php.php?sc_item_menu=item_6&sc_apl_menu=grid_clientes&sc_apl_link=" . urlencode($menu_portal_id_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_portal-id']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[9] . "||" . $this->menu_portal_id_target('_self') . "|" . "\n";
}
else
{
    $menu_portal_id_menuData['data'] .= "item_6|..|" . $nm_var_lab[9] . "||||_self|disabled\n";
}
$menu_portal_id_menuData['data'] .= "item_3|.|" . $nm_var_lab[10] . "||" . $nm_var_hint[10] . "||_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_onegatelogs']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_onegatelogs']) == "on")
{
    $menu_portal_id_menuData['data'] .= "item_5|..|" . $nm_var_lab[11] . "|menu_portal-id_form_php.php?sc_item_menu=item_5&sc_apl_menu=grid_onegatelogs&sc_apl_link=" . urlencode($menu_portal_id_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_portal-id']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[11] . "||" . $this->menu_portal_id_target('_self') . "|" . "\n";
}
else
{
    $menu_portal_id_menuData['data'] .= "item_5|..|" . $nm_var_lab[11] . "||||_self|disabled\n";
}
$saida_apl = $_SESSION['scriptcase']['sc_saida_menu_portal-id'];
$menu_portal_id_menuData['data'] .= "item_4|.|" . $nm_var_lab[12] . "|$saida_apl|" . $nm_var_hint[12] . "||_parent|\n";

$menu_portal_id_menuData['data'] = array();
$str_disabled = "N";
$str_link = "#";
$str_icon = "";
$icon_aba = "";
...
$str_disabled = "N";
$str_link = "menu_portal-id_form_php.php?sc_item_menu=item_14&sc_apl_menu=grid_aplicaciones&sc_apl_link=" . urlencode($menu_portal_id_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_portal-id']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_aplicaciones']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_aplicaciones']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_portal_id_menuData['data'][] = array(
        ...
        'icon_aba' => $icon_aba,
        'icon_aba_inactive' => $icon_aba_inactive,
        'target'   => " item-target=\"" . $this->menu_portal_id_target('_self') . "\"",
        'sc_id'    => "item_14",
        'disabled' => $str_disabled,
    );
$str_disabled = "N";
$str_link = "menu_portal-id_form_php.php?sc_item_menu=item_11&sc_apl_menu=grid_metodosauths&sc_apl_link=" . urlencode($menu_portal_id_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_portal-id']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_metodosauths']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_metodosauths']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_portal-id_form_php.php?sc_item_menu=item_10&sc_apl_menu=grid_paises&sc_apl_link=" . urlencode($menu_portal_id_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_portal-id']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_paises']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_paises']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_portal-id_form_php.php?sc_item_menu=item_9&sc_apl_menu=grid_tiposclientes&sc_apl_link=" . urlencode($menu_portal_id_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_portal-id']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tiposclientes']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tiposclientes']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_portal-id_form_php.php?sc_item_menu=item_8&sc_apl_menu=grid_tiposidentifis&sc_apl_link=" . urlencode($menu_portal_id_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_portal-id']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tiposidentifis']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tiposidentifis']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_portal-id_form_php.php?sc_item_menu=item_12&sc_apl_menu=grid_estadosclientes&sc_apl_link=" . urlencode($menu_portal_id_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_portal-id']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_estadosclientes']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_estadosclientes']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_portal-id_form_php.php?sc_item_menu=item_6&sc_apl_menu=grid_clientes&sc_apl_link=" . urlencode($menu_portal_id_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_portal-id']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_clientes']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_clientes']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_portal-id_form_php.php?sc_item_menu=item_5&sc_apl_menu=grid_onegatelogs&sc_apl_link=" . urlencode($menu_portal_id_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_portal-id']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_onegatelogs']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_onegatelogs']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$menu_portal_id_menuData['data'][] = array(
    ...
    'icon_aba' => $icon_aba,
    'icon_aba_inactive' => $icon_aba_inactive,
    'target'   => " item-target=\"" . $this->menu_portal_id_target('_parent') . "\"",
    'sc_id'    => "item_4",
    'disabled' => $str_disabled,
);

if (isset($_SESSION['scriptcase']['sc_def_menu']['menu_portal-id']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['menu_portal-id']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'menu_portal-id');
    $menu_portal_id_menuData['data'] = $str_menu_usu;
}
if (is_file("menu_portal-id_help.txt"))
{
    $Arq_WebHelp = file("menu_portal-id_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $menu_portal_id_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->menu_portal_id_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                );
            }
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['menu_portal-id']) && !empty($_SESSION['scriptcase']['sc_menu_del']['menu_portal-id']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($menu_portal_id_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['menu_portal-id']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($menu_portal_id_menuData['data'][$i_menu]);
       }
    ...
    $menu_portal_id_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['menu_portal-id']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['menu_portal-id']))
{
    $disable_menu = false;
    foreach ($menu_portal_id_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['menu_portal-id']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $menu_portal_id_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
/* Cabecera HTML */
if ($menu_portal_id_menuData['iframe'])
{
    $menu_portal_id_menuData['height'] = '100%';
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">

<html<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?> style="height: 100%">
<head>
 <title>menu_portal-id</title>
...
{
    $menu_portal_id_menuData['height'] = '30px';
}

/* Archivos JS */
?>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_portal-id']['glo_nm_path_prod']; ?>/third/jquery/js/jquery.js"></script>
<script  type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_portal-id']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/jquery.contextmenu.js"></script>
 <link rel="stylesheet" type="text/css" href="<?php echo $_SESSION['scriptcase']['menu_portal-id']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/contextmenu.css" /> 
...
Iframe_atual = "menu_portal-id_iframe";
...
<?php
 $seq = 0;
 foreach ($menu_portal_id_menuData['data'] as $ind => $dados_menu)
 {
     if ($dados_menu['link'] != "#")
     {
...
function createIframe(str_id, str_label, str_hint, str_img_on, str_img_off, str_link, tp_apl)
{
    ...
    iframe.name = 'menu_portal-id_' + str_id + '_iframe';
    iframe.src = str_link;
...
function createAba(str_id)
{
    ...
    tmp += "</div>";
    var home_style="";
    if(str_id === 'menu_portal-id'){ home_style=";padding-left:4px;min-height:14px;"; }
...
function mudaIframe(str_id)
{
    ...
    for (i = 0; i < Tab_iframes.length; i++) 
    {
        if (Tab_iframes[i] == str_id) 
        {
            ...
            Iframe_atual = "menu_portal-id_" + Tab_iframes[i] + '_iframe';
...
{
    str_target_sv = "";
    if (str_id != "iframe_menu_portal-id")
    {
        str_target_sv = str_id + "_iframe";
        str_id        = str_id.replace("menu_portal-id_","");
    }
    str_link   = $('#' + str_id).attr('item-href');
    str_target = $('#' + str_id).attr('item-target');
    if (str_target == "menu_portal-id_iframe" && str_link != '' && str_link != '#' && str_link != 'javascript:')
    {
        str_target = (str_target_sv != "") ? str_target_sv : str_target;
        mudaIframe(str_id);
        if (str_id != "menu_portal-id")
        {
            $('#links_abas').css('display','');
        }
        if (str_id != "menu_portal-id" && Tab_abas[str_id] != 'show')
        {
            createAba(str_id);
      scToggleOverflow();
        }
    ...
    $('#iframe_menu_portal-id')[0].contentWindow.focus();
}
</script>
...
<div class="scMenuHHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scMenuHHeaderFont" style="float: left; text-transform: uppercase;"><?php echo "PORTAL ID - MÓDULO ADMINISTRATIVO" ?></div>
    <div class="scMenuHHeaderFont" style="float: right;">   <IMG SRC="<?php echo $path_imag_cab ?>/grp__NM__menu_img__NM__suntic-96_28.png" BORDER="0"/></div>
</div>    </td>
  </tr>
...
echo $this->menu_portal_id_escreveMenu($menu_portal_id_menuData['data'], $path_imag_cab, $strAlign);
?></tr></table>
</div>
<?php
/* Control de iframe */
...
<?php echo $this->nm_show_toolbarmenu('', $saida_apl, $menu_portal_id_menuData, $path_imag_cab); ?><?php echo $this->nm_gera_degrade(1, $bg_line_degrade, $path_imag_cab); ?>  <tr>
    ...
    <td id="Iframe_control" style="border-width: 1px; height: 100%; padding: 0px;vertical-align:top;text-align:center;">
      <iframe id="iframe_menu_portal-id" name="menu_portal-id_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo ($NM_scr_iframe != "" ? $NM_scr_iframe : "menu_portal-id_pag_ini.php"); ?>"></iframe>
<?php
 foreach ($menu_portal_id_menuData['data'] as $ind => $dados_menu)
 {
     if ($dados_menu['link'] != "#")
     {
         echo "      <iframe id=\"iframe_" . $dados_menu['id'] . "\" name= \"menu_portal-id_" . $dados_menu['id'] . "_iframe\" frameborder=\"0\" class=\"scMenuIframe\" style=\"display: none;width: 100%; height: 100%;\" src=\"\"></iframe>
";
     }
 }
}
...
<table style="width: 100%; height:20px;" cellpadding="0px" cellspacing="0px" class="scMenuHFooter">
    <tr>
        ...
        <td>
            <span class="scMenuHFooterFont" id="rod_col2"><?php echo "© 2020 All rights reserved" ?></span>
        </td>
    </tr>
</table>    </td>
  </tr>
...
/* Control de Target */
function menu_portal_id_escreveMenu($arr_menu, $path_imag_cab = '', $strAlign = '')
{
    global $nm_data_fixa;
    $last      = '';
    $itemClass = ' topfirst';
...
function menu_portal_id_target($str_target)
{
    global $menu_portal_id_menuData;
    ...
    elseif ($menu_portal_id_menuData['iframe'])
    {
        return 'menu_portal-id_iframe';
    }
    else
    {
        return $str_target;
...
function nm_show_toolbarmenu($col_span, $saida_apl, $menu_portal_id_menuData, $path_imag_cab)
{
}
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "menu_portal-id_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_portal_id_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_portal-id']['glo_nm_usa_grupo'] . ""; 
               }
               else
               {
                    $str_line['link'] = "menu_portal-id_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_portal_id_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_portal-id']['glo_nm_usa_grupo'] . ""; 
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->menu_portal_id_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        $_SESSION['scriptcase']['menu_portal-id']['sc_init'][$apl_menu] = rand(2, 10000);
        $_SESSION['sc_session'][$_SESSION['scriptcase']['menu_portal-id']['sc_init'][$apl_menu]] = array();
        return  $_SESSION['scriptcase']['menu_portal-id']['sc_init'][$apl_menu];
   }
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    if (is_file($root . $_SESSION['scriptcase']['menu_portal-id']['glo_nm_path_imag_temp'] . "/sc_apl_default_Portal_ID.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['menu_portal-id']['glo_nm_path_imag_temp'] . "/sc_apl_default_Portal_ID.txt"));
        if (isset($apl_def[0]) && $apl_def[0] != "menu_portal-id") {
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['menu_portal-id']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['menu_portal-id']['session_timeout']['redir'] = $path_aplicacao . "/" . $apl_def[0] . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? strtoupper($apl_def[1]) : "";
            $_SESSION['scriptcase']['menu_portal-id']['session_timeout']['redir_tp'] = $Redir_tp;
        }
    }
    if (is_file($root . $_SESSION['scriptcase']['menu_portal-id']['glo_nm_path_imag_temp'] . "/sc_actual_lang_" . $_SERVER['SERVER_NAME'] . ".txt")) {
        $lang_atu = file_get_contents($root . $_SESSION['scriptcase']['menu_portal-id']['glo_nm_path_imag_temp'] . "/sc_actual_lang_" . $_SERVER['SERVER_NAME'] . ".txt");
        $_SESSION['scriptcase']['menu_portal-id']['session_timeout']['lang'] = $lang_atu;
    }
}
...
$contr_menu_portal_id = new menu_portal_id_class;
$contr_menu_portal_id->menu_portal_id_menu();
