...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Portal_ID_____grid_publicaciones"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Portal_ID_____grid_publicaciones"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_publicaciones'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_publicaciones']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_publicaciones']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_publicaciones']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_publicaciones']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_publicaciones']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_publicaciones</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_publicaciones']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_publicaciones']['embutida_filho'] as $ind => $sc_init)
          {
