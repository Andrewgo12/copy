...
class grid_publicaciones_res_rtf
{
   var $Erro;
   var $Ini;
   var $Res;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_publicaciones.rtf";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_publicaciones']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_publicaciones']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_publicaciones']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_publicaciones']['rtf_name']);
      }
   ...
   function gera_texto_tag()
   {
      ...
      $this->comp_field   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_publicaciones']['pivot_group_by'];
      $this->comp_y_axys  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_publicaciones']['pivot_y_axys'];
      $this->comp_tabular = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_publicaciones']['pivot_tabular'];
      $this->build_labels = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_publicaciones']['arr_export']['label'];
      $this->build_data   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_publicaciones']['arr_export']['data'];
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_publicaciones']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_publicaciones']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> <?php echo $this->Ini->Nm_lang['lang_tbl_publicaciones'] ?> :: RTF</TITLE>
