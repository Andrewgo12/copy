...
<?php
   ...
   $Ord_Cmp = new grid_publicaciones_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_publicaciones_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['publcodigon'] = "on";
   $tab_def_campos['publcodigon'] = "publcodigon";
   $tab_converte["publcodigon"]   = "publcodigon";
   $tab_labels["publcodigon"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_publicaciones']['labels']["publcodigon"])) ? $_SESSION['sc_session'][$sc_init]['grid_publicaciones']['labels']["publcodigon"] : "" . $this->Nm_lang['lang_publicaciones_fld_publcodigon'] . "";
   $tab_ger_campos['publgrupusrs'] = "on";
   $tab_def_campos['publgrupusrs'] = "publgrupusrs";
   $tab_converte["publgrupusrs"]   = "publgrupusrs";
   $tab_labels["publgrupusrs"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_publicaciones']['labels']["publgrupusrs"])) ? $_SESSION['sc_session'][$sc_init]['grid_publicaciones']['labels']["publgrupusrs"] : "" . $this->Nm_lang['lang_publicaciones_fld_publgrupusrs'] . "";
   $tab_ger_campos['aplicodigon'] = "on";
   $tab_def_campos['aplicodigon'] = "aplicodigon";
   $tab_converte["aplicodigon"]   = "aplicodigon";
   $tab_labels["aplicodigon"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_publicaciones']['labels']["aplicodigon"])) ? $_SESSION['sc_session'][$sc_init]['grid_publicaciones']['labels']["aplicodigon"] : "" . $this->Nm_lang['lang_publicaciones_fld_aplicodigon'] . "";
   $tab_ger_campos['publpuerton'] = "on";
   $tab_def_campos['publpuerton'] = "publpuerton";
   $tab_converte["publpuerton"]   = "publpuerton";
   $tab_labels["publpuerton"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_publicaciones']['labels']["publpuerton"])) ? $_SESSION['sc_session'][$sc_init]['grid_publicaciones']['labels']["publpuerton"] : "" . $this->Nm_lang['lang_publicaciones_fld_publpuerton'] . "";
   $tab_ger_campos['meaucodigon'] = "on";
   $tab_def_campos['meaucodigon'] = "meaucodigon";
   $tab_converte["meaucodigon"]   = "meaucodigon";
   $tab_labels["meaucodigon"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_publicaciones']['labels']["meaucodigon"])) ? $_SESSION['sc_session'][$sc_init]['grid_publicaciones']['labels']["meaucodigon"] : "" . $this->Nm_lang['lang_publicaciones_fld_meaucodigon'] . "";
   $tab_ger_campos['publurls'] = "on";
   $tab_def_campos['publurls'] = "publurls";
   $tab_converte["publurls"]   = "publurls";
   $tab_labels["publurls"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_publicaciones']['labels']["publurls"])) ? $_SESSION['sc_session'][$sc_init]['grid_publicaciones']['labels']["publurls"] : "" . $this->Nm_lang['lang_publicaciones_fld_publurls'] . "";
   $tab_ger_campos['publestados'] = "on";
   $tab_def_campos['publestados'] = "publestados";
   $tab_converte["publestados"]   = "publestados";
   $tab_labels["publestados"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_publicaciones']['labels']["publestados"])) ? $_SESSION['sc_session'][$sc_init]['grid_publicaciones']['labels']["publestados"] : "" . $this->Nm_lang['lang_publicaciones_fld_publestados'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_publicaciones']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_publicaciones']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_publicaciones']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_publicaciones']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_publicaciones']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_publicaciones']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_publicaciones']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_publicaciones']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_publicaciones']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> <?php echo $this->Nm_lang['lang_tbl_publicaciones'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_publicaciones_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_publicaciones']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_publicaciones']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
