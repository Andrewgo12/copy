...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Portal_ID_____grid_clientes_back"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Portal_ID_____grid_clientes_back"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_clientes_back']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_clientes_back']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_clientes_back']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_clientes_back']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_clientes_back']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_clientes_back</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_clientes_back']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_clientes_back']['embutida_filho'] as $ind => $sc_init)
          {
