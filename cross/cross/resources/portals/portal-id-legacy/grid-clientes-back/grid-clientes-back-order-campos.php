...
<?php
   ...
   $Ord_Cmp = new grid_clientes_back_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_clientes_back_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['cliecodigon'] = "on";
   $tab_def_campos['cliecodigon'] = "cliecodigon";
   $tab_converte["cliecodigon"]   = "cliecodigon";
   $tab_labels["cliecodigon"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes_back']['labels']["cliecodigon"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes_back']['labels']["cliecodigon"] : "" . $this->Nm_lang['lang_clientes_fld_cliecodigon'] . "";
   $tab_ger_campos['tiidcodigos'] = "on";
   $tab_def_campos['tiidcodigos'] = "tiidcodigos";
   $tab_converte["tiidcodigos"]   = "tiidcodigos";
   $tab_labels["tiidcodigos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes_back']['labels']["tiidcodigos"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes_back']['labels']["tiidcodigos"] : "" . $this->Nm_lang['lang_clientes_fld_tiidcodigos'] . "";
   $tab_ger_campos['clieidentifs'] = "on";
   $tab_def_campos['clieidentifs'] = "clieidentifs";
   $tab_converte["clieidentifs"]   = "clieidentifs";
   $tab_labels["clieidentifs"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes_back']['labels']["clieidentifs"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes_back']['labels']["clieidentifs"] : "" . $this->Nm_lang['lang_clientes_fld_clieidentifs'] . "";
   $tab_ger_campos['clienombres'] = "on";
   $tab_def_campos['clienombres'] = "clienombres";
   $tab_converte["clienombres"]   = "clienombres";
   $tab_labels["clienombres"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes_back']['labels']["clienombres"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes_back']['labels']["clienombres"] : "" . $this->Nm_lang['lang_clientes_fld_clienombres'] . "";
   $tab_ger_campos['paiscodigos'] = "on";
   $tab_def_campos['paiscodigos'] = "paiscodigos";
   $tab_converte["paiscodigos"]   = "paiscodigos";
   $tab_labels["paiscodigos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes_back']['labels']["paiscodigos"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes_back']['labels']["paiscodigos"] : "" . $this->Nm_lang['lang_clientes_fld_paiscodigos'] . "";
   $tab_ger_campos['cliedireccis'] = "on";
   $tab_def_campos['cliedireccis'] = "cliedireccis";
   $tab_converte["cliedireccis"]   = "cliedireccis";
   $tab_labels["cliedireccis"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_clientes_back']['labels']["cliedireccis"])) ? $_SESSION['sc_session'][$sc_init]['grid_clientes_back']['labels']["cliedireccis"] : "" . $this->Nm_lang['lang_clientes_fld_cliedireccis'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_clientes_back']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_clientes_back']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_clientes_back']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_clientes_back']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_clientes_back']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_clientes_back']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_clientes_back']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_clientes_back']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_clientes_back']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_clientes_back_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_clientes_back']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_clientes_back']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
