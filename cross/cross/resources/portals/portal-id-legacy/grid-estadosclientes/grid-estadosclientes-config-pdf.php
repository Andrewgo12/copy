 ...
 */
    ...
    $SC_cod_proj = "Portal_ID";
    $SC_apl_proc = "grid_estadosclientes";
/* sc_apl_default */
...
$isMultiSeriesChart = $is_chart_app && (!isset($_SESSION['sc_session'][$script_case_init]['grid_estadosclientes']['summarizing_drill_down']) || !$_SESSION['sc_session'][$script_case_init]['grid_estadosclientes']['summarizing_drill_down']);
$isAnalitic         = isset($_SESSION['sc_session'][$script_case_init]['grid_estadosclientes']['graf_opc_atual']) && 2 == $_SESSION['sc_session'][$script_case_init]['grid_estadosclientes']['graf_opc_atual'];

  $sDisplay = !isset($_SESSION['sc_session']['grid_estadosclientes']['show_skip_charts_option']) ||
             !$_SESSION['sc_session']['grid_estadosclientes']['show_skip_charts_option'] ||
             (isset($_SESSION['sc_session'][$script_case_init]['grid_estadosclientes']['SC_Ind_Groupby']) && '_NM_SC_' == $_SESSION['sc_session'][$script_case_init]['grid_estadosclientes']['SC_Ind_Groupby']) ||
             $isMultiSeriesChart ||
             $isAnalitic ||
             ($opc == 'pdf_det')
             ? ' style="display: none"' : '';
...
{
 $sDisplay =
            !isset($_SESSION['sc_session']['grid_estadosclientes']['show_skip_charts_option']) ||
            !$_SESSION['sc_session']['grid_estadosclientes']['show_skip_charts_option'] ||
            $isMultiSeriesChart ||
            $isAnalitic ||
             ($opc == 'pdf_det')
