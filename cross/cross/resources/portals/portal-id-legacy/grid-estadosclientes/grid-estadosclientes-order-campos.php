...
<?php
   ...
   $Ord_Cmp = new grid_estadosclientes_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_estadosclientes_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_def_campos['esclcodigos'] = "esclcodigos";
   $tab_converte["esclcodigos"]   = "esclcodigos";
   $tab_labels["esclcodigos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estadosclientes']['labels']["esclcodigos"])) ? $_SESSION['sc_session'][$sc_init]['grid_estadosclientes']['labels']["esclcodigos"] : "" . $this->Nm_lang['lang_estadosclientes_fld_esclcodigos'] . "";
   $tab_ger_campos['esclnombres'] = "on";
   $tab_def_campos['esclnombres'] = "esclnombres";
   $tab_converte["esclnombres"]   = "esclnombres";
   $tab_labels["esclnombres"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estadosclientes']['labels']["esclnombres"])) ? $_SESSION['sc_session'][$sc_init]['grid_estadosclientes']['labels']["esclnombres"] : "" . $this->Nm_lang['lang_estadosclientes_fld_esclnombres'] . "";
   $tab_ger_campos['escldescrips'] = "on";
   $tab_def_campos['escldescrips'] = "escldescrips";
   $tab_converte["escldescrips"]   = "escldescrips";
   $tab_labels["escldescrips"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estadosclientes']['labels']["escldescrips"])) ? $_SESSION['sc_session'][$sc_init]['grid_estadosclientes']['labels']["escldescrips"] : "" . $this->Nm_lang['lang_estadosclientes_fld_escldescrips'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_estadosclientes']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_estadosclientes']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_estadosclientes']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_estadosclientes']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_estadosclientes']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_estadosclientes']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_estadosclientes']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_estadosclientes']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_estadosclientes']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_estadosclientes_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_estadosclientes']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_estadosclientes']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
