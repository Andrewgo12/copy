  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tiposclientes_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_tiposclientes_mob_validate_ticlcodigos()
  {
    var nomeCampo_ticlcodigos = "ticlcodigos";
    var var_ticlcodigos = scAjaxGetFieldText(nomeCampo_ticlcodigos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tiposclientes_mob_validate_ticlcodigos(var_ticlcodigos, var_script_case_init, do_ajax_form_tiposclientes_mob_validate_ticlcodigos_cb);
  } // do_ajax_form_tiposclientes_mob_validate_ticlcodigos

  function do_ajax_form_tiposclientes_mob_validate_ticlcodigos_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tiposclientes_mob_validate_ticlcodigos_cb

  // ---------- Validate ticlnombres
  function do_ajax_form_tiposclientes_mob_validate_ticlnombres()
  {
    var nomeCampo_ticlnombres = "ticlnombres";
    var var_ticlnombres = scAjaxGetFieldText(nomeCampo_ticlnombres);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tiposclientes_mob_validate_ticlnombres(var_ticlnombres, var_script_case_init, do_ajax_form_tiposclientes_mob_validate_ticlnombres_cb);
  } // do_ajax_form_tiposclientes_mob_validate_ticlnombres

  function do_ajax_form_tiposclientes_mob_validate_ticlnombres_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ticlnombres";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tiposclientes_mob_validate_ticlnombres_cb

  // ---------- Validate ticldescrips
  function do_ajax_form_tiposclientes_mob_validate_ticldescrips()
  {
    var nomeCampo_ticldescrips = "ticldescrips";
    var var_ticldescrips = scAjaxGetFieldText(nomeCampo_ticldescrips);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tiposclientes_mob_validate_ticldescrips(var_ticldescrips, var_script_case_init, do_ajax_form_tiposclientes_mob_validate_ticldescrips_cb);
  } // do_ajax_form_tiposclientes_mob_validate_ticldescrips

  function do_ajax_form_tiposclientes_mob_validate_ticldescrips_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ticldescrips";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tiposclientes_mob_validate_ticldescrips_cb

  // ---------- Validate ticlfcharegd
  function do_ajax_form_tiposclientes_mob_validate_ticlfcharegd()
  {
    var nomeCampo_ticlfcharegd = "ticlfcharegd";
    var var_ticlfcharegd = scAjaxGetFieldText(nomeCampo_ticlfcharegd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tiposclientes_mob_validate_ticlfcharegd(var_ticlfcharegd, var_script_case_init, do_ajax_form_tiposclientes_mob_validate_ticlfcharegd_cb);
  } // do_ajax_form_tiposclientes_mob_validate_ticlfcharegd

  function do_ajax_form_tiposclientes_mob_validate_ticlfcharegd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ticlfcharegd";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tiposclientes_mob_validate_ticlfcharegd_cb

  // ---------- Validate ticlestados
  function do_ajax_form_tiposclientes_mob_validate_ticlestados()
  {
    var nomeCampo_ticlestados = "ticlestados";
    var var_ticlestados = scAjaxGetFieldSelect(nomeCampo_ticlestados);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tiposclientes_mob_validate_ticlestados(var_ticlestados, var_script_case_init, do_ajax_form_tiposclientes_mob_validate_ticlestados_cb);
  } // do_ajax_form_tiposclientes_mob_validate_ticlestados

  function do_ajax_form_tiposclientes_mob_validate_ticlestados_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ticlestados";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tiposclientes_mob_validate_ticlestados_cb
  // ---------- Form
  function do_ajax_form_tiposclientes_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tiposclientes_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_ticlcodigos = scAjaxGetFieldText("ticlcodigos");
    var var_ticlnombres = scAjaxGetFieldText("ticlnombres");
    var var_ticldescrips = scAjaxGetFieldText("ticldescrips");
    var var_ticlfcharegd = scAjaxGetFieldText("ticlfcharegd");
    var var_ticlestados = scAjaxGetFieldSelect("ticlestados");
    ...
    scAjaxProcOn();
    x_ajax_form_tiposclientes_mob_submit_form(var_ticlcodigos, var_ticlnombres, var_ticldescrips, var_ticlfcharegd, var_ticlestados, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tiposclientes_mob_submit_form_cb);
  } // do_ajax_form_tiposclientes_mob_submit_form

  function do_ajax_form_tiposclientes_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("ticlnombres");
      scAjaxHideErrorDisplay("ticldescrips");
      scAjaxHideErrorDisplay("ticlfcharegd");
      scAjaxHideErrorDisplay("ticlestados");
      scLigEditLookupCall();
<?php
...
?>
  ...
  } // do_ajax_form_tiposclientes_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_tiposclientes_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("ticlfcharegd");
    scAjaxHideErrorDisplay("ticlestados");
    var var_ticlcodigos = document.F2.ticlcodigos.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tiposclientes_mob_navigate_form(var_ticlcodigos, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tiposclientes_mob_navigate_form_cb);
  } // do_ajax_form_tiposclientes_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tiposclientes_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tiposclientes_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_tiposclientes_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.ticlcodigos.value = scAjaxGetKeyValue("ticlcodigos");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
{
?>
    do_ajax_form_tiposclientes_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tiposclientes_mob_navigate_form_cb
  function sc_hide_form_tiposclientes_mob_form()
  {
  ...
  ajax_field_list[0] = "ticlcodigos";
  ajax_field_list[1] = "ticlnombres";
  ajax_field_list[2] = "ticldescrips";
  ajax_field_list[3] = "ticlfcharegd";
  ajax_field_list[4] = "ticlestados";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "ticlcodigos": {"label": "<?php echo $this->Ini->Nm_lang['lang_tiposclientes_fld_ticlcodigos'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ticlnombres": {"label": "<?php echo $this->Ini->Nm_lang['lang_tiposclientes_fld_ticlnombres'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ticldescrips": {"label": "<?php echo $this->Ini->Nm_lang['lang_tiposclientes_fld_ticldescrips'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ticlfcharegd": {"label": "<?php echo $this->Ini->Nm_lang['lang_tiposclientes_fld_ticlfcharegd'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ticlestados": {"label": "<?php echo $this->Ini->Nm_lang['lang_tiposclientes_fld_ticlestados'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "ticlnombres": new Array(),
    "ticldescrips": new Array(),
    "ticlfcharegd": new Array(),
    "ticlestados": new Array()
  };
  ajax_field_mult["ticlcodigos"][1] = "ticlcodigos";
  ajax_field_mult["ticlnombres"][1] = "ticlnombres";
  ajax_field_mult["ticldescrips"][1] = "ticldescrips";
  ajax_field_mult["ticlfcharegd"][1] = "ticlfcharegd";
  ajax_field_mult["ticlestados"][1] = "ticlestados";

  var ajax_field_id = {
    "ticlcodigos": new Array("hidden_field_label_ticlcodigos", "hidden_field_data_ticlcodigos"),
    "ticlnombres": new Array("hidden_field_label_ticlnombres", "hidden_field_data_ticlnombres"),
    "ticldescrips": new Array("hidden_field_label_ticldescrips", "hidden_field_data_ticldescrips"),
    "ticlfcharegd": new Array("hidden_field_label_ticlfcharegd", "hidden_field_data_ticlfcharegd"),
    "ticlestados": new Array("hidden_field_label_ticlestados", "hidden_field_data_ticlestados")
  };
