  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tiposclientes" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_tiposclientes_validate_ticlcodigos()
  {
    var nomeCampo_ticlcodigos = "ticlcodigos";
    var var_ticlcodigos = scAjaxGetFieldText(nomeCampo_ticlcodigos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tiposclientes_validate_ticlcodigos(var_ticlcodigos, var_script_case_init, do_ajax_form_tiposclientes_validate_ticlcodigos_cb);
  } // do_ajax_form_tiposclientes_validate_ticlcodigos

  function do_ajax_form_tiposclientes_validate_ticlcodigos_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tiposclientes_validate_ticlcodigos_cb

  // ---------- Validate ticlnombres
  function do_ajax_form_tiposclientes_validate_ticlnombres()
  {
    var nomeCampo_ticlnombres = "ticlnombres";
    var var_ticlnombres = scAjaxGetFieldText(nomeCampo_ticlnombres);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tiposclientes_validate_ticlnombres(var_ticlnombres, var_script_case_init, do_ajax_form_tiposclientes_validate_ticlnombres_cb);
  } // do_ajax_form_tiposclientes_validate_ticlnombres

  function do_ajax_form_tiposclientes_validate_ticlnombres_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tiposclientes_validate_ticlnombres_cb

  // ---------- Validate ticldescrips
  function do_ajax_form_tiposclientes_validate_ticldescrips()
  {
    var nomeCampo_ticldescrips = "ticldescrips";
    var var_ticldescrips = scAjaxGetFieldText(nomeCampo_ticldescrips);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tiposclientes_validate_ticldescrips(var_ticldescrips, var_script_case_init, do_ajax_form_tiposclientes_validate_ticldescrips_cb);
  } // do_ajax_form_tiposclientes_validate_ticldescrips

  function do_ajax_form_tiposclientes_validate_ticldescrips_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tiposclientes_validate_ticldescrips_cb

  // ---------- Validate ticlfcharegd
  function do_ajax_form_tiposclientes_validate_ticlfcharegd()
  {
    var nomeCampo_ticlfcharegd = "ticlfcharegd";
    var var_ticlfcharegd = scAjaxGetFieldText(nomeCampo_ticlfcharegd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tiposclientes_validate_ticlfcharegd(var_ticlfcharegd, var_script_case_init, do_ajax_form_tiposclientes_validate_ticlfcharegd_cb);
  } // do_ajax_form_tiposclientes_validate_ticlfcharegd

  function do_ajax_form_tiposclientes_validate_ticlfcharegd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tiposclientes_validate_ticlfcharegd_cb

  // ---------- Validate ticlestados
  function do_ajax_form_tiposclientes_validate_ticlestados()
  {
    var nomeCampo_ticlestados = "ticlestados";
    var var_ticlestados = scAjaxGetFieldSelect(nomeCampo_ticlestados);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tiposclientes_validate_ticlestados(var_ticlestados, var_script_case_init, do_ajax_form_tiposclientes_validate_ticlestados_cb);
  } // do_ajax_form_tiposclientes_validate_ticlestados

  function do_ajax_form_tiposclientes_validate_ticlestados_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tiposclientes_validate_ticlestados_cb
  // ---------- Form
  function do_ajax_form_tiposclientes_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tiposclientes_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tiposclientes_submit_form(var_ticlcodigos, var_ticlnombres, var_ticldescrips, var_ticlfcharegd, var_ticlestados, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tiposclientes_submit_form_cb);
  } // do_ajax_form_tiposclientes_submit_form

  function do_ajax_form_tiposclientes_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_tiposclientes_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_tiposclientes_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tiposclientes_navigate_form(var_ticlcodigos, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tiposclientes_navigate_form_cb);
  } // do_ajax_form_tiposclientes_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tiposclientes']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tiposclientes_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_tiposclientes_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
...
{
?>
    do_ajax_form_tiposclientes_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tiposclientes_navigate_form_cb
  function sc_hide_form_tiposclientes_form()
  {
