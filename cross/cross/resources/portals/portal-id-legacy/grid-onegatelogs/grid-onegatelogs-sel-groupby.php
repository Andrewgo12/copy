...
<?php
   ...
   $Sel_Groupby = new grid_onegatelogs_sel_Groupby(); 
   $Sel_Groupby->Sel_Groupby_init();
   
class grid_onegatelogs_sel_Groupby
{
function Sel_Groupby_init()
{
   ...
   $groupby_atual = $_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['SC_Ind_Groupby'];
...
function Sel_processa_out($sel_groupby)
{
   ...
   {
       if (count($campos_sel) != count($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['SC_Gb_Free_cmp']))
       {
       ...
       {
          $Arr_temp = array();
           foreach ($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['SC_Gb_Free_cmp'] as $Cada_cmp => $Resto)
           {
               $Arr_temp[] = $Cada_cmp;
           }
   ...
   {
       $_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['SC_Ind_Groupby']     = $sel_groupby;
       $_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['contr_array_resumo'] = "NAO";
       $_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['contr_total_geral']  = "NAO";
       unset($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['ordem_quebra']);
       unset($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['ordem_select']);
       unset($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['tot_geral']);
       unset($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['Page_break_PDF']);
       unset($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['arr_total']);
       unset($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['pivot_group_by']);
       unset($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['pivot_x_axys']);
       unset($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['pivot_y_axys']);
       unset($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['pivot_fill']);
       unset($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['pivot_order']);
       unset($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['pivot_order_col']);
       unset($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['pivot_order_level']);
       unset($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['pivot_order_sort']);
       unset($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['pivot_tabular']);
       if ($sel_groupby == "sc_free_group_by")
       {
           $tab_arr_groubby_cmp = array();
           $tab_arr_groubby_sql = array();
           $tab_arr_groubby_cmp['ongafechas'] = array('cmp' => "ongafechas", 'ind' => 0, 'format' => "YYYYMMDD2");
           $tab_arr_groubby_cmp['onganodos'] = array('cmp' => "onganodos", 'ind' => 1, 'format' => "");
           $tab_arr_groubby_cmp['ongaidonegas'] = array('cmp' => "ongaidonegas", 'ind' => 2, 'format' => "");
           $tab_arr_groubby_cmp['ongavirhosts'] = array('cmp' => "ongavirhosts", 'ind' => 3, 'format' => "");
           $tab_arr_groubby_sql[0] = array('cmp' => "ongafechas", 'ord' => 'asc');
           $tab_arr_groubby_sql[1] = array('cmp' => "onganodos", 'ord' => 'asc');
           $tab_arr_groubby_sql[2] = array('cmp' => "ongaidonegas", 'ord' => 'asc');
           $tab_arr_groubby_sql[3] = array('cmp' => "ongavirhosts", 'ord' => 'asc');
           $_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['SC_Gb_Free_cmp']  = array();
           $_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['SC_Gb_Free_sql']  = array();
           $_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['SC_Gb_date_format']['sc_free_group_by'] = array();
           $_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['SC_Gb_Free_orig'] = array();
           foreach ($campos_sel as $cada_cmp)
           {
               if (!empty($cada_cmp))
               {
                   $ind = $tab_arr_groubby_cmp[$cada_cmp]['ind'];
                   $_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['SC_Gb_Free_cmp'][$cada_cmp] = $tab_arr_groubby_cmp[$cada_cmp]['cmp'];
                   $_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['SC_Gb_Free_sql'][$cada_cmp][$tab_arr_groubby_sql[$ind]['cmp']] = $tab_arr_groubby_sql[$ind]['ord'];
                   $_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['SC_Gb_date_format']['sc_free_group_by'][$cada_cmp] = $tab_arr_groubby_cmp[$cada_cmp]['format'];
               }
           }
       }
   }
   if ($sel_groupby == "sc_free_group_by")
   {
       ...
       $_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['pivot_x_axys'] = $xaxys_list;
       $_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['pivot_y_axys'] = $yaxys_list;
   }
   if ($opc_ret == "resumo" && !empty($this->summ_fields))
   {
       $summ_fields = explode("@?@", $this->summ_fields);
       if(isset($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['summarizing_fields_display'][ $sel_groupby ]))
       {
           foreach ($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['summarizing_fields_display'][ $sel_groupby ] as $i_sum => $d_sum)
           {
               $_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['summarizing_fields_display'][ $sel_groupby ][$i_sum]['display'] = in_array($i_sum, $summ_fields);
           }
       }
       $_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['summarizing_fields_order'][ $sel_groupby ] = $summ_fields;
       $_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['summarizing_drill_down'] = $this->drill_down;
   }
?>
    <script language="javascript"> 
<?php
...
function Sel_processa_form()
{
   ...
   $arr_campos_free['ongafechas'] = "" . sprintf("" . $this->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "", "" . $this->Nm_lang['lang_onegatelogs_fld_ongafechas'] . "") . "";
   $arr_campos_free['onganodos'] = "" . $this->Nm_lang['lang_onegatelogs_fld_onganodos'] . "";
   $arr_campos_free['ongaidonegas'] = "" . $this->Nm_lang['lang_onegatelogs_fld_ongaidonegas'] . "";
   $arr_campos_free['ongavirhosts'] = "" . $this->Nm_lang['lang_onegatelogs_fld_ongavirhosts'] . "";
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> <?php echo $this->Nm_lang['lang_tbl_onegatelogs'] ?></TITLE>
...
?>
 <script language="javascript" type="text/javascript">
  function scSubmitGroupBy(sPos) {
   $.ajax({
    type: "POST",
    url: "grid_onegatelogs_sel_groupby.php",
    data: {
...
?>
 <script language="javascript" type="text/javascript">
<?php
if ($bSummaryPage && isset($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['summarizing_fields_control']))
{
    $aOptions = array();
    foreach ($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['summarizing_fields_control'] as $quebra_nome => $_arr_fields)
    {
...
{
  $max_height = 1;
  if (isset($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['summarizing_fields_display']))
  {
    foreach ($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['summarizing_fields_display'] as $_quebra_nome => $_i_sum)
    {
...
$(function() {
 ...
 <tr id="sc_id_free_groupby">
  <td>
<?php
     if (!in_array("sc_free_group_by", $_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['SC_Groupby_hide']))
     {
...
<?php
        ...
        foreach ($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['SC_Gb_Free_cmp'] as $NM_cada_field => $resto)
        {
...
<?php
        ...
        {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['SC_Gb_Free_cmp'][$NM_cada_field]))
           {
?>
...
<?php
        if ($bSummaryPage)
        {
            $xAxysGroupCount = count($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['pivot_x_axys']);
        }
...
<?php
        if ($bSummaryPage)
        {
            ...
            {
                foreach ($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['pivot_x_axys'] as $temp)
                {
                    reset($aTmpGroupBy);
...
<?php
   ...
   if ($bSummaryPage)
   {
    ...
    if (isset($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['summarizing_fields_control']))
    {
?>
 <tr id="sc_id_summary" class="SummaryBox" style='display:<?php echo ($has_total_dynamic)?'':'none';?>'>
  <td>
    ...
    <?php
    foreach ($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['summarizing_fields_control'] as $nome_quebra => $_arr_fields_totals)
    {
    ?>
...
<?php
          if(isset($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['summarizing_fields_order'][ $nome_quebra ]) && is_array($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['summarizing_fields_order'][ $nome_quebra ]) && !empty($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['summarizing_fields_order'][ $nome_quebra ]))
          {
           foreach ($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['summarizing_fields_order'][ $nome_quebra ] as $i_sum)
           {
            if ('' != $i_sum && isset($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['summarizing_fields_display'][ $nome_quebra ][$i_sum]))
            {
                $d_sum = $_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['summarizing_fields_display'][ $nome_quebra ][$i_sum];
                if ($d_sum['display'])
                {
                    $sLabel = $d_sum['label'];
                    $sId    = '';
                    $bFound = false;
                    $iKey   = $key_total;
                    if(isset($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['summarizing_fields_control'][$nome_quebra]))
                    {
                        foreach ($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['summarizing_fields_control'][$nome_quebra] as $_key_total => $d_field)
                        {
                            if(is_array($d_field))
                            {
                                    $l_field = $d_field['cmp_res'];
