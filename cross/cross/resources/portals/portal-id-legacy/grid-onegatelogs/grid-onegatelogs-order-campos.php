...
<?php
   ...
   $Ord_Cmp = new grid_onegatelogs_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_onegatelogs_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['ongacodigon'] = "on";
   $tab_def_campos['ongacodigon'] = "ongacodigon";
   $tab_converte["ongacodigon"]   = "ongacodigon";
   $tab_labels["ongacodigon"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['labels']["ongacodigon"])) ? $_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['labels']["ongacodigon"] : "" . $this->Nm_lang['lang_onegatelogs_fld_ongacodigon'] . "";
   $tab_ger_campos['ongafechas'] = "on";
   $tab_def_campos['ongafechas'] = "ongafechas";
   $tab_converte["ongafechas"]   = "ongafechas";
   $tab_labels["ongafechas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['labels']["ongafechas"])) ? $_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['labels']["ongafechas"] : "" . $this->Nm_lang['lang_onegatelogs_fld_ongafechas'] . "";
   $tab_ger_campos['ongahorad'] = "on";
   $tab_def_campos['ongahorad'] = "ongahorad";
   $tab_converte["ongahorad"]   = "ongahorad";
   $tab_labels["ongahorad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['labels']["ongahorad"])) ? $_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['labels']["ongahorad"] : "" . $this->Nm_lang['lang_onegatelogs_fld_ongahorad'] . "";
   $tab_ger_campos['onganodos'] = "on";
   $tab_def_campos['onganodos'] = "onganodos";
   $tab_converte["onganodos"]   = "onganodos";
   $tab_labels["onganodos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['labels']["onganodos"])) ? $_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['labels']["onganodos"] : "" . $this->Nm_lang['lang_onegatelogs_fld_onganodos'] . "";
   $tab_ger_campos['ongaidonegas'] = "on";
   $tab_def_campos['ongaidonegas'] = "ongaidonegas";
   $tab_converte["ongaidonegas"]   = "ongaidonegas";
   $tab_labels["ongaidonegas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['labels']["ongaidonegas"])) ? $_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['labels']["ongaidonegas"] : "" . $this->Nm_lang['lang_onegatelogs_fld_ongaidonegas'] . "";
   $tab_ger_campos['ongavirhosts'] = "on";
   $tab_def_campos['ongavirhosts'] = "ongavirhosts";
   $tab_converte["ongavirhosts"]   = "ongavirhosts";
   $tab_labels["ongavirhosts"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['labels']["ongavirhosts"])) ? $_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['labels']["ongavirhosts"] : "" . $this->Nm_lang['lang_onegatelogs_fld_ongavirhosts'] . "";
   $tab_ger_campos['ongacadenas'] = "on";
   $tab_def_campos['ongacadenas'] = "ongacadenas";
   $tab_converte["ongacadenas"]   = "ongacadenas";
   $tab_labels["ongacadenas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['labels']["ongacadenas"])) ? $_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['labels']["ongacadenas"] : "" . $this->Nm_lang['lang_onegatelogs_fld_ongacadenas'] . "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_onegatelogs_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_onegatelogs']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
