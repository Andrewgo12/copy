...
class grid_onegatelogs_resumo
{
   ...
   var $link_graph_tot; 
   var $Tot_ger; 
   var $array_total_ongafechas;
   var $array_total_onganodos;
   var $array_total_ongaidonegas;
   var $array_total_ongavirhosts;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_ongafechas   = array();
      $this->array_total_onganodos    = array();
      $this->array_total_ongaidonegas = array();
      $this->array_total_ongavirhosts = array();
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['phantomjs_export_process'] = false;
	...
	function zipChartImages() {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList) {
		...
		$tempDir = $this->Ini->root . $_SESSION['scriptcase']['grid_onegatelogs']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_onegatelogs']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              ...
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['tot_geral'][1];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['tot_geral'][1] == 0)
      {
      ...
      $this->drawMatrix();
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['arr_total']['ongafechas'] = $this->array_total_ongafechas;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['arr_total']['onganodos'] = $this->array_total_onganodos;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['arr_total']['ongaidonegas'] = $this->array_total_ongaidonegas;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['arr_total']['ongavirhosts'] = $this->array_total_ongavirhosts;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       $Lab_ongafechas = "" . $this->Ini->Nm_lang['lang_onegatelogs_fld_ongafechas'] . "";
       $Lab_ongafechas =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "", $Lab_ongafechas);
       $Lab_onganodos = "" . $this->Ini->Nm_lang['lang_onegatelogs_fld_onganodos'] . "";
       $Lab_ongaidonegas = "" . $this->Ini->Nm_lang['lang_onegatelogs_fld_ongaidonegas'] . "";
       $Lab_ongavirhosts = "" . $this->Ini->Nm_lang['lang_onegatelogs_fld_ongavirhosts'] . "";
       $prep_field = array();
       $prep_field['ongafechas'] = $Lab_ongafechas;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['labels']['ongafechas'] = $Lab_ongafechas; 
       $prep_field['onganodos'] = $Lab_onganodos;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['labels']['onganodos'] = $Lab_onganodos; 
       $prep_field['ongaidonegas'] = $Lab_ongaidonegas;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['labels']['ongaidonegas'] = $Lab_ongaidonegas; 
       $prep_field['ongavirhosts'] = $Lab_ongavirhosts;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['labels']['ongavirhosts'] = $Lab_ongavirhosts; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       //-----
       $this->comp_sum = array(
           2 => "" .  $this->Ini->Nm_lang['lang_othr_rows'] . "",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['ongafechas']['alin'] = "''";
       $Arr_parms['ongafechas']['link'] = "S";
       $Arr_parms['onganodos']['alin'] = "''";
       $Arr_parms['onganodos']['link'] = "S";
       $Arr_parms['ongaidonegas']['alin'] = "''";
       $Arr_parms['ongaidonegas']['link'] = "S";
       $Arr_parms['ongavirhosts']['alin'] = "''";
       $Arr_parms['ongavirhosts']['link'] = "S";
       $Arr_parms['ongafechas']['fill'] = "true";
       $Arr_parms['ongafechas']['order'] = "value";
       $Arr_parms['ongafechas']['order_start'] = 'asc';
       $Arr_parms['ongafechas']['order_invert'] = 'false';
       $Arr_parms['ongafechas']['order_enabled'] = 'true';
       $Arr_parms['onganodos']['fill'] = "true";
       $Arr_parms['onganodos']['order'] = "label";
       $Arr_parms['onganodos']['order_start'] = 'asc';
       $Arr_parms['onganodos']['order_invert'] = 'false';
       $Arr_parms['onganodos']['order_enabled'] = 'true';
       $Arr_parms['ongaidonegas']['fill'] = "true";
       $Arr_parms['ongaidonegas']['order'] = "label";
       $Arr_parms['ongaidonegas']['order_start'] = 'asc';
       $Arr_parms['ongaidonegas']['order_invert'] = 'false';
       $Arr_parms['ongaidonegas']['order_enabled'] = 'true';
       $Arr_parms['ongavirhosts']['fill'] = "true";
       $Arr_parms['ongavirhosts']['order'] = "label";
       $Arr_parms['ongavirhosts']['order_start'] = 'asc';
       $Arr_parms['ongavirhosts']['order_invert'] = 'false';
       $Arr_parms['ongavirhosts']['order_enabled'] = 'true';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['ongafechas'] = array(0 => 'ongafechas', 1 => '@aspass@');
       $prep_links_fl['onganodos'] = array(0 => 'onganodos', 1 => '@aspass@');
       $prep_links_fl['ongaidonegas'] = array(0 => 'ongaidonegas', 1 => '@aspass@');
       $prep_links_fl['ongavirhosts'] = array(0 => 'ongavirhosts', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_onegatelogs@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           ...
           '1' => array(
               ...
               'label_x'  => $this->getChartText(strip_tags($Lab_ongafechas)),
           ...
           '1' => array(
               ...
               'field_x'  => 'onganodos',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_onganodos)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_othr_rows'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
           ...
           '1' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'ongaidonegas',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_ongaidonegas)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_othr_rows'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
           ...
           '1' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'ongavirhosts',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_ongavirhosts)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_othr_rows'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_charts'];
	}
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_onegatelogs_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_onegatelogs_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['pivot_order_start'][$iYAxysIndex])
                       {
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['opcao'] == "pdf" || $this->Print_All)
      {
          $this->monta_cabecalho();
      }
   }
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_onegatelogs_total.class.php"); 
      }
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['opcao'] = "print";
      ...
      $this->Total   = new grid_onegatelogs_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['responsive_chart']['active']) {
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_onegatelogs_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_onegatelogs_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_onegatelogs_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_onegatelogs/grid_onegatelogs_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['ajax_nav'] && !$this->Ini->sc_export_ajax)
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_onegatelogs/grid_onegatelogs_config_word.php?nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_onegatelogs/grid_onegatelogs_config_print.php?nm_opc=resumo&nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_onegatelogs/grid_onegatelogs_config_graf_flash.php?nome_apl=grid_onegatelogs&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_onegatelogs_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_onegatelogs_config_pivot.php?nome_apl=grid_onegatelogs&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("</form> \r\n");
      ...
      $nm_saida->saida("           $('#TB_window').remove();\r\n");
      $nm_saida->saida("           $('body').append(\"<div id='TB_window'></div>\");\r\n");
      $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_onegatelogs/grid_onegatelogs_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__cor_print=\" + cor + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
      $nm_saida->saida("       }\r\n");
      $nm_saida->saida("       else\r\n");
      $nm_saida->saida("       {\r\n");
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_onegatelogs/grid_onegatelogs_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=pdf_res&sAdd=__E__nmgp_tipo_pdf=\" + z + \"__E__sc_parms_pdf=\" + p + \"__E__sc_create_charts=\" + crt + \"__E__sc_graf_pdf=\" + g + \"__E__chart_level=\" + chart_level + \"&nm_opc=pdf&KeepThis=true&TB_iframe=true&modal=true\", '');\r\n");
      ...
      $nm_saida->saida("      else\r\n");
      $nm_saida->saida("      {\r\n");
      $nm_saida->saida("          window.location = \"" . $this->Ini->path_link . "grid_onegatelogs/grid_onegatelogs_iframe.php?nmgp_parms=" . $Md5_pdf . "&sc_tp_pdf=\" + z + \"&sc_parms_pdf=\" + p + \"&sc_create_charts=\" + crt + \"&sc_graf_pdf=\" + g + '&chart_level=' + chart_level;\r\n");
      $nm_saida->saida("      }\r\n");
      $nm_saida->saida("  }\r\n");
      $nm_saida->saida("  else\r\n");
      $nm_saida->saida("  {\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_onegatelogs_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_onegatelogs/grid_onegatelogs_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $ongafechas = $Busca_temp['ongafechas']; 
          $tmp_pos = strpos($ongafechas, "##@@");
          if ($tmp_pos !== false && !is_array($ongafechas))
          {
              $ongafechas = substr($ongafechas, 0, $tmp_pos);
          }
          $ongafechas_2 = $Busca_temp['ongafechas_input_2']; 
          $ongahorad = $Busca_temp['ongahorad']; 
          $tmp_pos = strpos($ongahorad, "##@@");
          if ($tmp_pos !== false && !is_array($ongahorad))
          {
              $ongahorad = substr($ongahorad, 0, $tmp_pos);
          }
          $onganodos = $Busca_temp['onganodos']; 
          $tmp_pos = strpos($onganodos, "##@@");
          if ($tmp_pos !== false && !is_array($onganodos))
          {
              $onganodos = substr($onganodos, 0, $tmp_pos);
          }
          $ongaidonegas = $Busca_temp['ongaidonegas']; 
          $tmp_pos = strpos($ongaidonegas, "##@@");
          if ($tmp_pos !== false && !is_array($ongaidonegas))
          {
              $ongaidonegas = substr($ongaidonegas, 0, $tmp_pos);
          }
          $ongavirhosts = $Busca_temp['ongavirhosts']; 
          $tmp_pos = strpos($ongavirhosts, "##@@");
          if ($tmp_pos !== false && !is_array($ongavirhosts))
          {
              $ongavirhosts = substr($ongavirhosts, 0, $tmp_pos);
          }
          $ongacadenas = $Busca_temp['ongacadenas']; 
          $tmp_pos = strpos($ongacadenas, "##@@");
          if ($tmp_pos !== false && !is_array($ongacadenas))
          {
              $ongacadenas = substr($ongacadenas, 0, $tmp_pos);
          }
          $ongaarchivs = $Busca_temp['ongaarchivs']; 
          $tmp_pos = strpos($ongaarchivs, "##@@");
          if ($tmp_pos !== false && !is_array($ongaarchivs))
          {
              $ongaarchivs = substr($ongaarchivs, 0, $tmp_pos);
          }
          $ongafechains = $Busca_temp['ongafechains']; 
          $tmp_pos = strpos($ongafechains, "##@@");
          if ($tmp_pos !== false && !is_array($ongafechains))
          {
   ...
   //---- 
   function adiciona_registro($quebra_ongafechas, $quebra_onganodos, $quebra_ongaidonegas, $quebra_ongavirhosts, $quebra_ongafechas_orig, $quebra_onganodos_orig, $quebra_ongaidonegas_orig, $quebra_ongavirhosts_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->ongacodigon = $rs_res->fields[0] ;  
            $this->ongafechas = $rs_res->fields[1] ;  
            $this->ongahorad = $rs_res->fields[2] ;  
            $this->onganodos = $rs_res->fields[3] ;  
            $this->ongaidonegas = $rs_res->fields[4] ;  
            $this->ongavirhosts = $rs_res->fields[5] ;  
            $this->ongacadenas = $rs_res->fields[6] ;  
            $this->ongafechas_orig = $this->ongafechas;
            $this->onganodos_orig = $this->onganodos;
            $this->ongaidonegas_orig = $this->ongaidonegas;
            $this->ongavirhosts_orig = $this->ongavirhosts;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->ongafechas, $this->onganodos, $this->ongaidonegas, $this->ongavirhosts, $this->ongafechas_orig,  $this->onganodos_orig,  $this->ongaidonegas_orig,  $this->ongavirhosts_orig);
            }
   }
//
