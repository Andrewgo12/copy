...
class grid_onegatelogs_total
{
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_onegatelogs']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_onegatelogs']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang ;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['where_pesq']; 
      } 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['contr_total_geral'] = "OK";
   } 
   ...
   //-----  ongafechas
   function quebra_ongafechas_sc_free_group_by($ongafechas, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb;
      $tot_ongafechas = array() ;  
      $tot_ongafechas[0] = $ongafechas ; 
   }
   //-----  onganodos
   function quebra_onganodos_sc_free_group_by($onganodos, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb;
      $tot_onganodos = array() ;  
      $tot_onganodos[0] = $onganodos ; 
   }
   //-----  ongaidonegas
   function quebra_ongaidonegas_sc_free_group_by($ongaidonegas, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb;
      $tot_ongaidonegas = array() ;  
      $tot_ongaidonegas[0] = $ongaidonegas ; 
   }
   //-----  ongavirhosts
   function quebra_ongavirhosts_sc_free_group_by($ongavirhosts, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb;
      $tot_ongavirhosts = array() ;  
      $tot_ongavirhosts[0] = $ongavirhosts ; 
   }
   ...
   function Calc_resumo_sc_free_group_by($destino_resumo)
   {
      global $nm_lang;
      $this->nm_data = new nm_data("es");
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['sql_tot_res']);
      ...
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('ongafechas' => "ongafechas",'onganodos' => "onganodos",'ongaidonegas' => "ongaidonegas",'ongavirhosts' => "ongavirhosts");
      $cmps_quebra_atual = array();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['SC_Gb_Free_cmp'] as $cmp => $resto)
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['arr_total'] = array();
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['arr_total'][$cmp_gb] = $this->$Arr_tot_name;
      }
   }
   ...
   function Res_Totaliza_sc_free_group_by($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def)
   {
      ...
      $cmp_sql_tp_num = array('ongacodigon' => 'N');
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['sql_tot_res']))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['sql_tot_res'] = str_replace("#@#cmps_quebras#@#", "", $comando);
      }
      $comando  = str_replace("#@#cmps_quebras#@#", "," . $cmps_quebras, $comando);
      $comando .= " group by " . $cmps_quebras . " order by " .  $cmps_quebras;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['Res_search_metric_use']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_onegatelogs']['Res_search_metric_use']))
      {
          $comando = $cmd_simp;
          $cmps_S  = "";
      ...
      $format_dimensions['ongafechas']['reg'] = "S";
      $format_dimensions['ongafechas']['msk'] = "";
      $format_dimensions['onganodos']['reg'] = "S";
      $format_dimensions['onganodos']['msk'] = "";
      $format_dimensions['ongaidonegas']['reg'] = "S";
      $format_dimensions['ongaidonegas']['msk'] = "";
      $format_dimensions['ongavirhosts']['reg'] = "S";
      $format_dimensions['ongavirhosts']['msk'] = "";
      while (!$rt->EOF)
      {
          $sql_where = "";
          foreach ($Cmp_dim as $Cada_dim => $Ind_sql)
          {
              ...
              if ($Cada_dim == "onganodos") {
              }
              if ($Cada_dim == "ongaidonegas") {
              }
              if ($Cada_dim == "ongavirhosts") {
              }
              if (null === $$Cada_dim)
              {
                  $$Cada_dim = '';
