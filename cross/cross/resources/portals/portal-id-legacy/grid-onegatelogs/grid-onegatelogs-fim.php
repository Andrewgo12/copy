...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Portal_ID_____grid_onegatelogs"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Portal_ID_____grid_onegatelogs"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_onegatelogs']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_onegatelogs']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_onegatelogs']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_onegatelogs']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_onegatelogs']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_onegatelogs']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_onegatelogs']['embutida_filho'] as $ind => $sc_init)
          {
