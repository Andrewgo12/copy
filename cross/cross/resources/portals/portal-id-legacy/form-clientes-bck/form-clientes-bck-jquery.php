...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_cliecodigon' + iSeqRow).bind('blur', function() { sc_form_clientes_bck_cliecodigon_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_clientes_bck_cliecodigon_onfocus(this, iSeqRow) });
  $('#id_sc_field_tiidcodigos' + iSeqRow).bind('blur', function() { sc_form_clientes_bck_tiidcodigos_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_clientes_bck_tiidcodigos_onfocus(this, iSeqRow) });
  $('#id_sc_field_clieidentifs' + iSeqRow).bind('blur', function() { sc_form_clientes_bck_clieidentifs_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_clientes_bck_clieidentifs_onfocus(this, iSeqRow) });
  $('#id_sc_field_clienombres' + iSeqRow).bind('blur', function() { sc_form_clientes_bck_clienombres_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_clientes_bck_clienombres_onfocus(this, iSeqRow) });
  $('#id_sc_field_paiscodigos' + iSeqRow).bind('blur', function() { sc_form_clientes_bck_paiscodigos_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_clientes_bck_paiscodigos_onfocus(this, iSeqRow) });
  $('#id_sc_field_cliedireccis' + iSeqRow).bind('blur', function() { sc_form_clientes_bck_cliedireccis_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_clientes_bck_cliedireccis_onfocus(this, iSeqRow) });
  $('#id_sc_field_clietelfijs' + iSeqRow).bind('blur', function() { sc_form_clientes_bck_clietelfijs_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_clientes_bck_clietelfijs_onfocus(this, iSeqRow) });
  $('#id_sc_field_cliepagwebs' + iSeqRow).bind('blur', function() { sc_form_clientes_bck_cliepagwebs_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_clientes_bck_cliepagwebs_onfocus(this, iSeqRow) });
  $('#id_sc_field_cliecontacts' + iSeqRow).bind('blur', function() { sc_form_clientes_bck_cliecontacts_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_clientes_bck_cliecontacts_onfocus(this, iSeqRow) });
  $('#id_sc_field_cliecelconts' + iSeqRow).bind('blur', function() { sc_form_clientes_bck_cliecelconts_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_clientes_bck_cliecelconts_onfocus(this, iSeqRow) });
  $('#id_sc_field_cliemailcons' + iSeqRow).bind('blur', function() { sc_form_clientes_bck_cliemailcons_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_clientes_bck_cliemailcons_onfocus(this, iSeqRow) });
  $('#id_sc_field_esclcodigos' + iSeqRow).bind('blur', function() { sc_form_clientes_bck_esclcodigos_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_clientes_bck_esclcodigos_onfocus(this, iSeqRow) });
  $('#id_sc_field_ticlcodigos' + iSeqRow).bind('blur', function() { sc_form_clientes_bck_ticlcodigos_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_clientes_bck_ticlcodigos_onfocus(this, iSeqRow) });
  $('#id_sc_field_cliefcharegd' + iSeqRow).bind('blur', function() { sc_form_clientes_bck_cliefcharegd_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_clientes_bck_cliefcharegd_onfocus(this, iSeqRow) });
  $('#id_sc_field_cliefcharegd_hora' + iSeqRow).bind('blur', function() { sc_form_clientes_bck_cliefcharegd_hora_onblur(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_clientes_bck_cliefcharegd_hora_onfocus(this, iSeqRow) });
  $('#id_sc_field_clieactivos' + iSeqRow).bind('blur', function() { sc_form_clientes_bck_clieactivos_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_clientes_bck_clieactivos_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_clientes_bck_cliecodigon_onblur(oThis, iSeqRow) {
  do_ajax_form_clientes_bck_validate_cliecodigon();
  scCssBlur(oThis);
}

function sc_form_clientes_bck_cliecodigon_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_clientes_bck_tiidcodigos_onblur(oThis, iSeqRow) {
  do_ajax_form_clientes_bck_validate_tiidcodigos();
  scCssBlur(oThis);
}

function sc_form_clientes_bck_tiidcodigos_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_clientes_bck_clieidentifs_onblur(oThis, iSeqRow) {
  do_ajax_form_clientes_bck_validate_clieidentifs();
  scCssBlur(oThis);
}

function sc_form_clientes_bck_clieidentifs_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_clientes_bck_clienombres_onblur(oThis, iSeqRow) {
  do_ajax_form_clientes_bck_validate_clienombres();
  scCssBlur(oThis);
}

function sc_form_clientes_bck_clienombres_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_clientes_bck_paiscodigos_onblur(oThis, iSeqRow) {
  do_ajax_form_clientes_bck_validate_paiscodigos();
  scCssBlur(oThis);
}

function sc_form_clientes_bck_paiscodigos_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_clientes_bck_cliedireccis_onblur(oThis, iSeqRow) {
  do_ajax_form_clientes_bck_validate_cliedireccis();
  scCssBlur(oThis);
}

function sc_form_clientes_bck_cliedireccis_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_clientes_bck_clietelfijs_onblur(oThis, iSeqRow) {
  do_ajax_form_clientes_bck_validate_clietelfijs();
  scCssBlur(oThis);
}

function sc_form_clientes_bck_clietelfijs_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_clientes_bck_cliepagwebs_onblur(oThis, iSeqRow) {
  do_ajax_form_clientes_bck_validate_cliepagwebs();
  scCssBlur(oThis);
}

function sc_form_clientes_bck_cliepagwebs_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_clientes_bck_cliecontacts_onblur(oThis, iSeqRow) {
  do_ajax_form_clientes_bck_validate_cliecontacts();
  scCssBlur(oThis);
}

function sc_form_clientes_bck_cliecontacts_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_clientes_bck_cliecelconts_onblur(oThis, iSeqRow) {
  do_ajax_form_clientes_bck_validate_cliecelconts();
  scCssBlur(oThis);
}

function sc_form_clientes_bck_cliecelconts_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_clientes_bck_cliemailcons_onblur(oThis, iSeqRow) {
  do_ajax_form_clientes_bck_validate_cliemailcons();
  scCssBlur(oThis);
}

function sc_form_clientes_bck_cliemailcons_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_clientes_bck_esclcodigos_onblur(oThis, iSeqRow) {
  do_ajax_form_clientes_bck_validate_esclcodigos();
  scCssBlur(oThis);
}

function sc_form_clientes_bck_esclcodigos_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_clientes_bck_ticlcodigos_onblur(oThis, iSeqRow) {
  do_ajax_form_clientes_bck_validate_ticlcodigos();
  scCssBlur(oThis);
}

function sc_form_clientes_bck_ticlcodigos_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_clientes_bck_cliefcharegd_onblur(oThis, iSeqRow) {
  do_ajax_form_clientes_bck_validate_cliefcharegd();
  scCssBlur(oThis);
}

function sc_form_clientes_bck_cliefcharegd_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_clientes_bck_validate_cliefcharegd();
  scCssBlur(oThis);
}

function sc_form_clientes_bck_cliefcharegd_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_clientes_bck_cliefcharegd_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_clientes_bck_clieactivos_onblur(oThis, iSeqRow) {
  do_ajax_form_clientes_bck_validate_clieactivos();
  scCssBlur(oThis);
}

function sc_form_clientes_bck_clieactivos_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_clientes_bck_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_cliefcharegd" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_clientes_bck_validate_cliefcharegd(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
