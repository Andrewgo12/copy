...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_cliefcharegd_hora' + iSeqRow).bind('blur', function() { sc_form_clientes_bck_cliefcharegd_onblur(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_clientes_bck_cliefcharegd_onfocus(this, iSeqRow) });
...
function scHidePage(pageNo) {
	$("#id_form_clientes_bck_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_cliefcharegd" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_clientes_bck_mob_validate_cliefcharegd(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
