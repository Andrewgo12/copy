...
//
   ...
   $_SESSION['scriptcase']['form_publicaciones']['error_buffer'] = '';

   $_SESSION['scriptcase']['form_publicaciones_mob']['glo_nm_perfil']          = "conn_postgres";
...
// 
      ...
      if (isset($_SESSION['scriptcase']['form_publicaciones_mob']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['form_publicaciones_mob']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['form_publicaciones_mob']['actual_lang']) || $_SESSION['scriptcase']['form_publicaciones_mob']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['form_publicaciones_mob']['actual_lang'] = $this->str_lang;
      ...
      if (isset($_SESSION['scriptcase']['user_logout']))
      {
          foreach ($_SESSION['scriptcase']['user_logout'] as $ind => $parms)
          {
              if (isset($_SESSION[$parms['V']]) && $_SESSION[$parms['V']] == $parms['U'])
              {
                  ...
                  {
                      $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['redir']['action']  = $nm_apl_dest;
...
<?php
      ...
      if (isset($_SESSION['scriptcase']['form_publicaciones_mob']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['form_publicaciones_mob']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['form_publicaciones_mob']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['form_publicaciones_mob']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['form_publicaciones_mob']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['form_publicaciones_mob']['session_timeout']);
      ...
      {
          $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['redir']['action']  = "form_publicaciones_mob.php";
          $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['redir']['target']  = "_self";
          $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['redir']['metodo']  = "post";
          $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['redir']['script_case_init']  = $this->sc_page;
          $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['redir']['script_case_session']  = session_id();
          form_publicaciones_mob_pack_ajax_response();
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['form_publicaciones_mob']['session_timeout']['redir']))
      {
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['form_publicaciones_mob']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['form_publicaciones_mob']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['form_publicaciones_mob']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['form_publicaciones_mob']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['form_publicaciones_mob']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['form_publicaciones_mob']['dashboard_info']['compact_mode']    = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['form_publicaciones_mob']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['form_publicaciones_mob']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['form_publicaciones_mob']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['form_publicaciones_mob']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['form_publicaciones_mob']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['form_publicaciones_mob']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['form_publicaciones_mob']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['form_publicaciones_mob']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['form_publicaciones_mob']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['form_publicaciones_mob']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['form_publicaciones_mob']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['form_publicaciones_mob']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['form_publicaciones_mob']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['form_publicaciones_mob']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['form_publicaciones_mob']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["form_publicaciones_mob"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["form_publicaciones_mob"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
...
// 
      ...
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['form_publicaciones']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['form_publicaciones']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
          {
              $_SESSION['sc_session'][$this->sc_page]['form_publicaciones']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['form_publicaciones']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['form_publicaciones']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['form_publicaciones']['SC_sep_date1'];
      }
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['form_publicaciones_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'Portal_ID'); 
      } 
      else 
      { 
      ...
      if (in_array(strtolower($this->nm_tpbanco), $this->nm_bases_oracle))
      {
          ...
          $_SESSION['sc_session'][$this->sc_page]['form_publicaciones_mob']['decimal_db'] = "."; 
      } 
  }
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['form_publicaciones_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['form_publicaciones_mob']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['form_publicaciones_mob']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['form_publicaciones_mob']['SC_sep_date1'];
           }
...
//
    ...
    if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
        ...
        if (is_file($root . $_SESSION['scriptcase']['form_publicaciones_mob']['glo_nm_path_imag_temp'] . "/sc_apl_default_Portal_ID.txt")) {
            $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['form_publicaciones_mob']['glo_nm_path_imag_temp'] . "/sc_apl_default_Portal_ID.txt"));
            if (isset($apl_def[0]) && $apl_def[0] != "form_publicaciones_mob") {
                if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                    $_SESSION['scriptcase']['form_publicaciones_mob']['session_timeout']['redir'] = $apl_def[0];
                }
                else {
                    $_SESSION['scriptcase']['form_publicaciones_mob']['session_timeout']['redir'] = $path_aplicacao . "/" . $apl_def[0] . "/index.php";
                }
                $Redir_tp = (isset($apl_def[1])) ? strtoupper($apl_def[1]) : "";
                $_SESSION['scriptcase']['form_publicaciones_mob']['session_timeout']['redir_tp'] = $Redir_tp;
            }
        }
        if (is_file($root . $_SESSION['scriptcase']['form_publicaciones_mob']['glo_nm_path_imag_temp'] . "/sc_actual_lang_" . $_SERVER['SERVER_NAME'] . ".txt")) {
            $lang_atu = file_get_contents($root . $_SESSION['scriptcase']['form_publicaciones_mob']['glo_nm_path_imag_temp'] . "/sc_actual_lang_" . $_SERVER['SERVER_NAME'] . ".txt");
            $_SESSION['scriptcase']['form_publicaciones_mob']['session_timeout']['lang'] = $lang_atu;
        }
    }
    ...
    if (isset($_POST['rs']) && !is_array($_POST['rs']) && 'ajax_' == substr($_POST['rs'], 0, 5) && isset($_POST['rsargs']) && !empty($_POST['rsargs']) && !isset($_SESSION['scriptcase']['form_publicaciones_mob']['session_timeout']['redir']))
    {
        if ('ajax_form_publicaciones_mob_validate_publcodigon' == $_POST['rs'])
        {
            $publcodigon = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_publicaciones_mob_validate_cliecodigon' == $_POST['rs'])
        {
            $cliecodigon = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_publicaciones_mob_validate_publgrupusrs' == $_POST['rs'])
        {
            $publgrupusrs = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_publicaciones_mob_validate_aplicodigon' == $_POST['rs'])
        {
            $aplicodigon = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_publicaciones_mob_validate_publpuerton' == $_POST['rs'])
        {
            $publpuerton = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_publicaciones_mob_validate_meaucodigon' == $_POST['rs'])
        {
            $meaucodigon = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_publicaciones_mob_validate_publurls' == $_POST['rs'])
        {
            $publurls = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_publicaciones_mob_validate_publipss' == $_POST['rs'])
        {
            $publipss = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_publicaciones_mob_validate_publhorarios' == $_POST['rs'])
        {
            $publhorarios = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_publicaciones_mob_validate_usuacodigos' == $_POST['rs'])
        {
            $usuacodigos = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_publicaciones_mob_validate_publfecregd' == $_POST['rs'])
        {
            $publfecregd = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_publicaciones_mob_validate_publestados' == $_POST['rs'])
        {
            $publestados = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_publicaciones_mob_submit_form' == $_POST['rs'])
        {
            $publcodigon = NM_utf8_urldecode($_POST['rsargs'][0]);
            $cliecodigon = NM_utf8_urldecode($_POST['rsargs'][1]);
            $publgrupusrs = NM_utf8_urldecode($_POST['rsargs'][2]);
            $aplicodigon = NM_utf8_urldecode($_POST['rsargs'][3]);
            $publpuerton = NM_utf8_urldecode($_POST['rsargs'][4]);
            $meaucodigon = NM_utf8_urldecode($_POST['rsargs'][5]);
            $publurls = NM_utf8_urldecode($_POST['rsargs'][6]);
            $publipss = NM_utf8_urldecode($_POST['rsargs'][7]);
            $publhorarios = NM_utf8_urldecode($_POST['rsargs'][8]);
            $usuacodigos = NM_utf8_urldecode($_POST['rsargs'][9]);
            $publfecregd = NM_utf8_urldecode($_POST['rsargs'][10]);
            $publestados = NM_utf8_urldecode($_POST['rsargs'][11]);
    ...
    $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['select_html']['cliecodigon'] = "class=\"sc-js-input scFormObjectOdd css_cliecodigon_obj\" style=\"\" id=\"id_sc_field_cliecodigon\" name=\"cliecodigon\" size=\"1\" alt=\"{type: 'select', enterTab: false}\"";
    $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['select_html']['aplicodigon'] = "class=\"sc-js-input scFormObjectOdd css_aplicodigon_obj\" style=\"\" id=\"id_sc_field_aplicodigon\" name=\"aplicodigon\" size=\"1\" alt=\"{type: 'select', enterTab: false}\"";
    $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['select_html']['meaucodigon'] = "class=\"sc-js-input scFormObjectOdd css_meaucodigon_obj\" style=\"\" id=\"id_sc_field_meaucodigon\" name=\"meaucodigon\" size=\"1\" alt=\"{type: 'select', enterTab: false}\"";
    $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['select_html']['publestados'] = "class=\"sc-js-input scFormObjectOdd css_publestados_obj\" style=\"\" id=\"id_sc_field_publestados\" name=\"publestados\" size=\"1\" alt=\"{type: \'select\', enterTab: false}\"";
    ...
    sajax_init();
    //$sajax_debug_mode = 1;
    sajax_export("ajax_form_publicaciones_mob_validate_publcodigon");
    sajax_export("ajax_form_publicaciones_mob_validate_cliecodigon");
    sajax_export("ajax_form_publicaciones_mob_validate_publgrupusrs");
    sajax_export("ajax_form_publicaciones_mob_validate_aplicodigon");
    sajax_export("ajax_form_publicaciones_mob_validate_publpuerton");
    sajax_export("ajax_form_publicaciones_mob_validate_meaucodigon");
    sajax_export("ajax_form_publicaciones_mob_validate_publurls");
    sajax_export("ajax_form_publicaciones_mob_validate_publipss");
    sajax_export("ajax_form_publicaciones_mob_validate_publhorarios");
    sajax_export("ajax_form_publicaciones_mob_validate_usuacodigos");
    sajax_export("ajax_form_publicaciones_mob_validate_publfecregd");
    sajax_export("ajax_form_publicaciones_mob_validate_publestados");
...
//
    ...
    function ajax_form_publicaciones_mob_validate_publcodigon($publcodigon, $script_case_init)
    {
        global $inicial_form_publicaciones_mob;
        ...
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_opcao         = 'validate_publcodigon';
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['param'] = array(
                  'publcodigon' => NM_utf8_urldecode($publcodigon),
        ...
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->controle();
        exit;
    } // ajax_validate_publcodigon

    function ajax_form_publicaciones_mob_validate_cliecodigon($cliecodigon, $script_case_init)
    {
        global $inicial_form_publicaciones_mob;
        //register_shutdown_function("form_publicaciones_mob_pack_ajax_response");
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_flag          = true;
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_opcao         = 'validate_cliecodigon';
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_publicaciones_mob_validate_publgrupusrs($publgrupusrs, $script_case_init)
    {
        global $inicial_form_publicaciones_mob;
        //register_shutdown_function("form_publicaciones_mob_pack_ajax_response");
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_flag          = true;
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_opcao         = 'validate_publgrupusrs';
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['param'] = array(
                  'publgrupusrs' => NM_utf8_urldecode($publgrupusrs),
                  'script_case_init' => NM_utf8_urldecode($script_case_init),
                  'buffer_output' => true,
                 );
        if ($inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['param']['buffer_output'])
        ...
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->controle();
        exit;
    } // ajax_validate_publgrupusrs

    function ajax_form_publicaciones_mob_validate_aplicodigon($aplicodigon, $script_case_init)
    {
        global $inicial_form_publicaciones_mob;
        //register_shutdown_function("form_publicaciones_mob_pack_ajax_response");
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_flag          = true;
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_opcao         = 'validate_aplicodigon';
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_publicaciones_mob_validate_publpuerton($publpuerton, $script_case_init)
    {
        global $inicial_form_publicaciones_mob;
        //register_shutdown_function("form_publicaciones_mob_pack_ajax_response");
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_flag          = true;
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_opcao         = 'validate_publpuerton';
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['param'] = array(
                  'publpuerton' => NM_utf8_urldecode($publpuerton),
                  'script_case_init' => NM_utf8_urldecode($script_case_init),
                  'buffer_output' => true,
                 );
        if ($inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['param']['buffer_output'])
        ...
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->controle();
        exit;
    } // ajax_validate_publpuerton

    function ajax_form_publicaciones_mob_validate_meaucodigon($meaucodigon, $script_case_init)
    {
        global $inicial_form_publicaciones_mob;
        //register_shutdown_function("form_publicaciones_mob_pack_ajax_response");
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_flag          = true;
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_opcao         = 'validate_meaucodigon';
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_publicaciones_mob_validate_publurls($publurls, $script_case_init)
    {
        global $inicial_form_publicaciones_mob;
        //register_shutdown_function("form_publicaciones_mob_pack_ajax_response");
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_flag          = true;
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_opcao         = 'validate_publurls';
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['param'] = array(
                  'publurls' => NM_utf8_urldecode($publurls),
                  'script_case_init' => NM_utf8_urldecode($script_case_init),
                  'buffer_output' => true,
                 );
        if ($inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['param']['buffer_output'])
        ...
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->controle();
        exit;
    } // ajax_validate_publurls

    function ajax_form_publicaciones_mob_validate_publipss($publipss, $script_case_init)
    {
        global $inicial_form_publicaciones_mob;
        //register_shutdown_function("form_publicaciones_mob_pack_ajax_response");
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_flag          = true;
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_opcao         = 'validate_publipss';
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['param'] = array(
                  'publipss' => NM_utf8_urldecode($publipss),
                  'script_case_init' => NM_utf8_urldecode($script_case_init),
                  'buffer_output' => true,
                 );
        if ($inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['param']['buffer_output'])
        ...
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->controle();
        exit;
    } // ajax_validate_publipss

    function ajax_form_publicaciones_mob_validate_publhorarios($publhorarios, $script_case_init)
    {
        global $inicial_form_publicaciones_mob;
        //register_shutdown_function("form_publicaciones_mob_pack_ajax_response");
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_flag          = true;
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_opcao         = 'validate_publhorarios';
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['param'] = array(
                  'publhorarios' => NM_utf8_urldecode($publhorarios),
                  'script_case_init' => NM_utf8_urldecode($script_case_init),
                  'buffer_output' => true,
                 );
        if ($inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['param']['buffer_output'])
        ...
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->controle();
        exit;
    } // ajax_validate_publhorarios

    function ajax_form_publicaciones_mob_validate_usuacodigos($usuacodigos, $script_case_init)
    {
        global $inicial_form_publicaciones_mob;
        //register_shutdown_function("form_publicaciones_mob_pack_ajax_response");
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_flag          = true;
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_opcao         = 'validate_usuacodigos';
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_publicaciones_mob_validate_publfecregd($publfecregd, $script_case_init)
    {
        global $inicial_form_publicaciones_mob;
        //register_shutdown_function("form_publicaciones_mob_pack_ajax_response");
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_flag          = true;
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_opcao         = 'validate_publfecregd';
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['param'] = array(
                  'publfecregd' => NM_utf8_urldecode($publfecregd),
                  'script_case_init' => NM_utf8_urldecode($script_case_init),
                  'buffer_output' => true,
                 );
        if ($inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['param']['buffer_output'])
        ...
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->controle();
        exit;
    } // ajax_validate_publfecregd

    function ajax_form_publicaciones_mob_validate_publestados($publestados, $script_case_init)
    {
        global $inicial_form_publicaciones_mob;
        //register_shutdown_function("form_publicaciones_mob_pack_ajax_response");
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_flag          = true;
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_opcao         = 'validate_publestados';
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['param'] = array(
                  'publestados' => NM_utf8_urldecode($publestados),
                  'script_case_init' => NM_utf8_urldecode($script_case_init),
                  'buffer_output' => true,
                 );
        if ($inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['param']['buffer_output'])
        ...
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->controle();
        exit;
    } // ajax_validate_publestados

    function ajax_form_publicaciones_mob_submit_form($publcodigon, $cliecodigon, $publgrupusrs, $aplicodigon, $publpuerton, $meaucodigon, $publurls, $publipss, $publhorarios, $usuacodigos, $publfecregd, $publestados, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $csrf_token)
    {
        global $inicial_form_publicaciones_mob;
        //register_shutdown_function("form_publicaciones_mob_pack_ajax_response");
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_flag          = true;
    ...
    function ajax_form_publicaciones_mob_navigate_form($publcodigon, $nm_form_submit, $nmgp_opcao, $nmgp_ordem, $nmgp_fast_search, $nmgp_cond_fast_search, $nmgp_arg_fast_search, $nmgp_arg_dyn_search, $script_case_init)
    {
        global $inicial_form_publicaciones_mob;
        //register_shutdown_function("form_publicaciones_mob_pack_ajax_response");
        $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_flag          = true;
...
//-----
      {
         ...
         if (isset($inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['varList']) && !empty($inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['varList']))
         {
            form_publicaciones_mob_pack_var_list($aResp);
         }
         ...
         if (isset($inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['buttonDisplayVert']) && !empty($inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['buttonDisplayVert']))
         {
            form_publicaciones_mob_pack_ajax_button_display_vert($aResp);
         }
         ...
         if (isset($inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['event_field']) && '' != $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['event_field'])
         {
            $aResp['eventField'] = $inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['event_field'];
         }
         else
         {
   ...
   function form_publicaciones_mob_pack_var_list(&$aResp)
   {
      global $inicial_form_publicaciones_mob;
      foreach ($inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['varList'] as $varData)
      {
         $aResp['varList'][] = array('index' => key($varData),
                                      'value' => current($varData));
      }
   } // form_publicaciones_mob_pack_var_list
   ...
   function form_publicaciones_mob_pack_ajax_button_display_vert(&$aResp)
   {
      global $inicial_form_publicaciones_mob;
      $aResp['buttonDisplayVert'] = array();
      foreach ($inicial_form_publicaciones_mob->contr_form_publicaciones_mob->NM_ajax_info['buttonDisplayVert'] as $aButtonData)
      {
