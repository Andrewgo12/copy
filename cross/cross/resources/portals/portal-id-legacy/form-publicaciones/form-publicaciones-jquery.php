...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_publfecregd_hora' + iSeqRow).bind('blur', function() { sc_form_publicaciones_publfecregd_hora_onblur(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_publicaciones_publfecregd_hora_onfocus(this, iSeqRow) });
...
function sc_form_publicaciones_publfecregd_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_publicaciones_validate_publfecregd();
  scCssBlur(oThis);
}
...
function sc_form_publicaciones_publfecregd_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_publicaciones_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_publfecregd" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_publicaciones_validate_publfecregd(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
